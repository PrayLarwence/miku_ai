import { _ as _export_sfc, c as createElementBlock, b as createVNode, w as withCtx, ab as VRow, ad as VCol, s as VCard, a as createBaseVNode, l as VIcon, d as createTextVNode, x as VDivider, k as VAlert, af as VList, ag as VListItem, e as VBtn, ao as VContainer, ap as pushScopeId, aq as popScopeId, o as openBlock } from "./index-BXuR6cgv.js";
const _sfc_main = {};
const _withScopeId = (n) => (pushScopeId("data-v-c3c946f3"), n = n(), popScopeId(), n);
const _hoisted_1 = { class: "help-page" };
const _hoisted_2 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("h1", { class: "text-h3 font-weight-bold mb-2" }, "云笈 帮助文档", -1));
const _hoisted_3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("p", { class: "text-body-1 text-medium-emphasis mb-6" }, " 欢迎使用 云笈，本文档将帮助您快速上手所有功能。 ", -1));
...
const _hoisted_13 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "help-content" }, [
  /* @__PURE__ */ createBaseVNode("p", { class: "text-body-1 mb-3" }, "云笈 需要配置大语言模型才能正常对话。支持所有兼容 OpenAI API 格式的模型服务商。"),
...
const _hoisted_33 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("p", { class: "text-body-1 mb-4" }, [
  ...
  /* @__PURE__ */ createBaseVNode("br"),
  /* @__PURE__ */ createTextVNode(" 3. 保存文件后重新启动 云笈。"),
  /* @__PURE__ */ createBaseVNode("br"),
...
const _hoisted_45 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("p", { class: "text-body-1 mb-3" }, [
  /* @__PURE__ */ createBaseVNode("strong", null, "云笈"),
...
const HelpPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-c3c946f3"]]);
export {
  HelpPage as default
};
