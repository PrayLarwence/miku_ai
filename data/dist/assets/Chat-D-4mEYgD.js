...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function toggleTheme() {
      ...
      const target = isDark.value ? lightVariants[current] : darkVariants[current];
      if (target) {
...
const Chat = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-365f9c13"]]);
export {
  Chat as C
};
