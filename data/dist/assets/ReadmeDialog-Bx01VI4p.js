...
import { _ as _export_sfc, a5 as useI18n, aF as useTheme, L as ref, H as computed, I as onUnmounted, J as watch, o as openBlock, h as createBlock, w as withCtx, b as createVNode, s as VCard, a6 as VCardTitle, a as createBaseVNode, t as toDisplayString, e as VBtn, l as VIcon, d as createTextVNode, v as VCardText, c as createElementBlock, $ as unref, i as createCommentVNode, aj as VProgressCircular, a9 as VCardActions, V as VSpacer, ai as VDialog, B as axios } from "./index-BXuR6cgv.js";
import { c as copyToClipboard } from "./clipboard-rcHxKLZ_.js";
import { n as normalizeShikiLanguage, e as ensureShikiLanguages, a as escapeHtml, r as renderShikiCode } from "./shiki-CAKhLbLY.js";
...
const _hoisted_1 = { class: "text-h2 pa-2" };
const _hoisted_2 = {
  key: 0,
...
const _hoisted_4 = { class: "text-body-1 text-center" };
...
const _hoisted_7 = { class: "text-body-1 text-center mb-2" };
const _hoisted_8 = { class: "text-body-2 text-center text-medium-emphasis" };
const _hoisted_9 = {
  key: 4,
  class: "d-flex flex-column align-center justify-center",
  style: { "height": "100%" }
};
const _hoisted_10 = { class: "text-body-1 text-center mb-2" };
const _hoisted_11 = { class: "text-body-2 text-center text-medium-emphasis" };
const _sfc_main = {
  __name: "ReadmeDialog",
  props: {
  ...
  setup(__props, { emit }) {
    ...
    function slugifyHeading(text2, slugCounts) {
      const base = (text2 || "").trim().toLowerCase().normalize("NFKD").replace(/[\u0300-\u036f]/g, "").replace(/[^\p{Letter}\p{Number}\s-]/gu, "").replace(/\s+/g, "-").replace(/-+/g, "-");
      if (!base) return "";
    ...
    function sanitizeHighlightedBlock(html2) {
      return purify.sanitize(html2, CODE_BLOCK_SANITIZE_OPTIONS);
    }
    async function updateRenderedHtml() {
      const source = content.value;
      const renderId = ++lastRenderId.value;
      void (locale == null ? void 0 : locale.value);
      if (!source) {
        renderedHtml.value = "";
        return;
      }
      ...
      try {
        const languages = tokens.filter((token) => token.type === "fence").map((token) => normalizeShikiLanguage(token.info));
      ...
      md.renderer.rules.fence = (tokens2, idx) => {
        ...
        const escapedLangLabel = lang !== "text" ? escapeHtml(lang) : "";
        const highlighted = highlighter ? renderShikiCode(highlighter, code, lang, isDark.value ? "dark" : "light") : `<pre class="shiki shiki-fallback"><code>${escapeHtml(code)}</code></pre>`;
        const html2 = sanitizeHighlightedBlock(`<div class="code-block-wrapper">
      ...
      ${highlighted}
        ...
        const placeholderIndex = highlightedBlocks.push(html2) - 1;
        return `<div data-code-block-index="${placeholderIndex}"></div>`;
      };
      const rawHtml = md.renderer.render(tokens, md.options, env);
      const cleanHtml = purify.sanitize(rawHtml, MARKDOWN_SANITIZE_OPTIONS);
    ...
    async function handleContainerClick(event) {
      ...
      if (btn) {
        const code = (_a = btn.closest(".code-block-wrapper")) == null ? void 0 : _a.querySelector("code");
        if (code) {
      ...
      if (!targetId) return;
      const target = (_b = scrollContainer.value) == null ? void 0 : _b.querySelector(
        `#${CSS.escape(targetId)}`
      );
      if (!target) return;
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(VDialog, {
        ...
        "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => _show.value = $event),
        width: "800"
      }, {
        default: withCtx(() => [
          createVNode(VCard, null, {
            default: withCtx(() => [
              createVNode(VCardTitle, { class: "d-flex justify-space-between align-center" }, {
                default: withCtx(() => [
                  createBaseVNode("span", _hoisted_1, toDisplayString(modeConfig.value.title), 1),
                  createVNode(VBtn, {
                    icon: "",
                    onClick: _cache[0] || (_cache[0] = ($event) => _show.value = false),
                    variant: "text"
                  }, {
                    default: withCtx(() => [
              ...
              createVNode(VCardText, {
                ...
                default: withCtx(() => [
                  showActionArea.value ? (openBlock(), createElementBlock("div", _hoisted_2, [
                    modeConfig.value.showGithubButton && __props.repoUrl ? (openBlock(), createBlock(VBtn, {
                      key: 0,
                      color: "primary",
                      "prepend-icon": "mdi-github",
                      onClick: _cache[1] || (_cache[1] = ($event) => openExternalLink(__props.repoUrl))
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(t)("core.common.readme.buttons.viewOnGithub")), 1)
                      ]),
                      _: 1
                    })) : createCommentVNode("", true),
                    modeConfig.value.showRefreshButton ? (openBlock(), createBlock(VBtn, {
                      key: 1,
                      color: "secondary",
                      ...
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(modeConfig.value.refreshLabel), 1)
                      ]),
                      _: 1
                    })) : createCommentVNode("", true)
                  ])) : createCommentVNode("", true),
                  loading.value ? (openBlock(), createElementBlock("div", _hoisted_3, [
                    ...
                    createBaseVNode("p", _hoisted_4, toDisplayString(modeConfig.value.loading), 1)
                  ])) : renderedHtml.value ? (openBlock(), createElementBlock("div", {
                    key: 2,
                    class: "markdown-body",
                    innerHTML: renderedHtml.value,
                    onClick: handleContainerClick
                  }, null, 8, _hoisted_5)) : error.value ? (openBlock(), createElementBlock("div", _hoisted_6, [
                    createVNode(VIcon, {
                      size: "64",
                      color: "error",
                      class: "mb-4"
                    ...
                    createBaseVNode("p", _hoisted_7, toDisplayString(unref(t)("core.common.error")), 1),
                    createBaseVNode("p", _hoisted_8, toDisplayString(error.value), 1)
                  ])) : isEmpty.value ? (openBlock(), createElementBlock("div", _hoisted_9, [
                    createVNode(VIcon, {
                      size: "64",
                      color: "warning",
                      class: "mb-4"
                      ...
                      default: withCtx(() => [
                        createTextVNode("mdi-file-question-outline")
                      ]),
                      _: 1
                    }),
                    createBaseVNode("p", _hoisted_10, toDisplayString(modeConfig.value.emptyTitle), 1),
                    createBaseVNode("p", _hoisted_11, toDisplayString(modeConfig.value.emptySubtitle), 1)
                  ])) : createCommentVNode("", true)
                ]),
                _: 1
              }, 512),
              createVNode(VCardActions, null, {
                default: withCtx(() => [
                  ...
                  createVNode(VBtn, {
                    color: "primary",
                    variant: "tonal",
                    onClick: _cache[2] || (_cache[2] = ($event) => _show.value = false)
                  }, {
                    default: withCtx(() => [
...
const ReadmeDialog = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c9342017"]]);
export {
  ReadmeDialog as R
};
