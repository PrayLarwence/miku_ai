...
const _sfc_main = {
  ...
  computed: {
    ...
    /** ApexCharts 配置 */
    chartOptions() {
      const isDark = useCustomizerStore().uiTheme === "NormalTheme";
      const fg = isDark ? "#cfd6dd" : "#37474f";
      const gridColor = isDark ? "rgba(255,255,255,0.08)" : "#e8e8e8";
      const lineColor = isDark ? "#90a4ae" : "#607d8b";
      return {
        chart: {
          type: "line",
        ...
        markers: {
          size: 4,
          colors: [lineColor],
          strokeColors: isDark ? "#1a1c23" : "#fff",
          strokeWidth: 2,
          hover: { size: 6 }
        },
        xaxis: {
          ...
          labels: {
            rotate: -45,
            style: { fontSize: "11px", colors: fg }
          },
          title: { text: "日期", style: { fontSize: "13px", color: fg } },
          axisBorder: { color: gridColor },
          axisTicks: { color: gridColor }
        },
        yaxis: {
          title: { text: "对话条数", style: { fontSize: "13px", color: fg } },
          min: 0,
          labels: {
            style: { colors: fg },
