import { aT as commonjsGlobal, D as defineComponent, u as useModuleI18n, L as ref, bd as reactive, H as computed, c as createElementBlock, b as createVNode, aj as VProgressCircular, F as Fragment, r as renderList, w as withCtx, be as VOverlay, T as normalizeClass, h as createBlock, b7 as VAvatar, i as createCommentVNode, a as createBaseVNode, t as toDisplayString, $ as unref, d as createTextVNode, l as VIcon, e as VBtn, s as VCard, a2 as mergeProps, ae as VMenu, a0 as withModifiers, N as nextTick, B as axios, o as openBlock, _ as _export_sfc, a6 as VCardTitle, g as VChip, ab as VRow, ad as VCol, bf as VCombobox, f as VSelect, j as VTextField, x as VDivider, v as VCardText, aP as VDataTable, z as VBtnToggle, aQ as VPagination, ao as VContainer, V as VSpacer, a9 as VCardActions, ai as VDialog, aK as VForm, k as VAlert, am as VSnackbar, as as useCommonStore, a5 as useI18n, C as resolveComponent } from "./index-sVuaKD1b.js";
import { V as VueMonacoEditor } from "./index-B1y4uE9w.js";
import { u as useCustomizerStore } from "./customizer-Cwj1g2HR.js";
import { h as he, _ as _sfc_main$2, R as RefNode, c as ReasoningBlock, d as _sfc_main$3, I as IPythonToolBlock, T as ToolCallItem, e as ToolCallCard, g as messageBlocks, i as displayParts } from "./useMessages-tbPz2ujk.js";
import { R as RefsSidebar, A as ActionRef } from "./ActionRef-HZtvlUkH.js";
import { c as copyToClipboard } from "./clipboard-rcHxKLZ_.js";
import { a as askForConfirmation, u as useConfirmDialog } from "./confirmDialog-ByM573Zf.js";
...
const _hoisted_4$1 = { class: "message-stack" };
const _hoisted_5$1 = {
  key: 0,
...
const _hoisted_14$1 = { class: "tool-call-inline-status" };
const _hoisted_15$1 = {
  key: 8,
  class: "unknown-part"
};
...
const _hoisted_19$1 = { class: "stats-row" };
const _hoisted_20$1 = { class: "stats-row" };
const _hoisted_21$1 = {
  key: 1,
  class: "stats-row"
};
const _hoisted_22$1 = { class: "stats-row" };
const _hoisted_23$1 = {
  key: 3,
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function isMessageStreaming(messageIndex) {
    ...
    function scrollToMessage(messageId) {
      ...
      nextTick(() => {
        var _a, _b;
        const rows = (_a = messageListRoot.value) == null ? void 0 : _a.querySelectorAll(".message-row");
        (_b = rows == null ? void 0 : rows[index]) == null ? void 0 : _b.scrollIntoView({ behavior: "smooth", block: "center" });
      });
    }
    function showMessageMeta(message, msgIndex) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ref_key: "messageListRoot",
        ref: messageListRoot,
        class: normalizeClass(["message-list-root", { "is-dark": _ctx.isDark }])
      }, [
        _ctx.isLoadingMessages ? (openBlock(), createElementBlock("div", _hoisted_1$1, [
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(messages.value, (msg, msgIndex) => {
            return openBlock(), createElementBlock("div", {
              ...
              !isUserMessage(msg) ? (openBlock(), createBlock(VAvatar, {
                ...
                default: withCtx(() => [
                  isMessageStreaming(msgIndex) ? (openBlock(), createBlock(VProgressCircular, {
                    key: 0,
                    indeterminate: "",
                    size: "22",
                    width: "2"
              ...
              createBaseVNode("div", _hoisted_4$1, [
                createBaseVNode("div", {
                  ...
                  messageContent(msg).isLoading ? (openBlock(), createElementBlock("div", _hoisted_5$1, [
                    createBaseVNode("span", null, toDisplayString(unref(tm)("message.loading")), 1)
                  ])) : (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList(renderBlocks(msg), (block, blockIndex) => {
                    return openBlock(), createElementBlock(Fragment, {
                      ...
                      block.kind === "thinking" ? (openBlock(), createBlock(ReasoningBlock, {
                        ...
                        return openBlock(), createElementBlock(Fragment, {
                          ...
                          ], 8, _hoisted_6$1)) : part.type === "plain" && isUserMessage(msg) ? (openBlock(), createElementBlock("div", _hoisted_7$1, toDisplayString(part.text || ""), 1)) : part.type === "plain" ? (openBlock(), createBlock(_sfc_main$3, {
                            key: 2,
                            content: part.text || "",
                          ...
                          ], 8, _hoisted_8$1)) : part.type === "record" ? (openBlock(), createElementBlock("audio", {
                            key: 4,
                            class: "audio-part",
                            controls: "",
                            src: partUrl(part)
                          }, null, 8, _hoisted_10$1)) : part.type === "video" ? (openBlock(), createElementBlock("video", {
                            key: 5,
                            class: "video-part",
                            controls: "",
                            src: partUrl(part)
                          }, null, 8, _hoisted_11$1)) : part.type === "file" ? (openBlock(), createElementBlock("div", _hoisted_12$1, [
                          ...
                          ])) : part.type === "tool_call" ? (openBlock(), createElementBlock("div", _hoisted_13$1, [
                              ...
                              return openBlock(), createElementBlock(Fragment, {
                                ...
                                isIPythonToolCall(tool) ? (openBlock(), createBlock(ToolCallItem, {
                                  ...
                                  label: withCtx(() => [
                                    ...
                                    createBaseVNode("span", _hoisted_14$1, toDisplayString(toolCallStatusText(tool)), 1)
                                  ]),
                                  details: withCtx(() => [
                          ...
                          ])) : (openBlock(), createElementBlock("div", _hoisted_15$1, toDisplayString(formatJson(part)), 1))
                        ], 64);
                      }), 128))
                    ], 64);
                  }), 128))
                ], 2),
                showMessageMeta(msg, msgIndex) ? (openBlock(), createElementBlock("div", _hoisted_16$1, [
                  msg.created_at ? (openBlock(), createElementBlock("span", _hoisted_17$1, toDisplayString(formatTime(msg.created_at)), 1)) : createCommentVNode("", true),
                  !isUserMessage(msg) ? (openBlock(), createBlock(VBtn, {
                    key: 1,
                  ...
                  messageContent(msg).agentStats ? (openBlock(), createBlock(VMenu, {
                    ...
                    default: withCtx(() => [
                      createVNode(VCard, {
                        ...
                        default: withCtx(() => [
                          cachedInputTokens(messageContent(msg).agentStats) > 0 ? (openBlock(), createElementBlock("div", _hoisted_18$1, [
                          ...
                          agentTtft(messageContent(msg).agentStats) ? (openBlock(), createElementBlock("div", _hoisted_21$1, [
                  ...
                  messageRefs(msg).length ? (openBlock(), createElementBlock("div", _hoisted_23$1, [
        ...
        createVNode(RefsSidebar, {
          ...
          "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => refsSidebarOpen.value = $event),
...
const MessageList = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-427f8679"]]);
const _sfc_main = {
  ...
  created() {
    this.debouncedApplyFilters = lodashExports.debounce(() => {
  ...
  computed: {
    ...
    // 当前的筛选条件对象
    currentFilters() {
      const platforms = this.platformFilter.map(
    ...
    // 检测是否为暗色模式
    isDark() {
      return this.customizerStore.uiTheme === "NormalTheme";
    },
  ...
  methods: {
    ...
    formatUmoSource(item) {
      if (!(item == null ? void 0 : item.sessionInfo)) {
        return (item == null ? void 0 : item.user_id) || this.tm("status.unknown");
      }
    ...
    fetchConversations: (() => {
      ...
      return async function() {
        ...
        try {
          ...
          this.showErrorMessage(((_b = (_a = error.response) == null ? void 0 : _a.data) == null ? void 0 : _b.message) || error.message || this.tm("messages.fetchError"));
        } finally {
          this.loading = false;
        }
      };
    ...
    async viewConversation(item) {
      ...
      try {
        ...
        this.showErrorMessage(((_b = (_a = error.response) == null ? void 0 : _a.data) == null ? void 0 : _b.message) || error.message || this.tm("messages.historyError"));
      } finally {
        this.loading = false;
      }
    },
    ...
    async saveHistoryChanges() {
      ...
      try {
        ...
        this.showErrorMessage(((_b = (_a = error.response) == null ? void 0 : _a.data) == null ? void 0 : _b.message) || error.message || this.tm("messages.historySaveError"));
      } finally {
    ...
    async closeHistoryDialog() {
      if (this.isEditingHistory) {
        if (await askForConfirmation(this.tm("dialogs.view.confirmClose"), this.confirmDialog)) {
    ...
    async saveConversation() {
      ...
      try {
        ...
        this.showErrorMessage(((_b = (_a = error.response) == null ? void 0 : _a.data) == null ? void 0 : _b.message) || error.message || this.tm("messages.saveError"));
      } finally {
        this.loading = false;
      }
    },
    ...
    async deleteConversation() {
      ...
      try {
        ...
        if (response.data.status === "ok") {
          const index = this.conversations.findIndex(
            (item) => item.user_id === this.selectedConversation.user_id && item.cid === this.selectedConversation.cid
          );
          if (index !== -1) {
        ...
        this.showErrorMessage(((_b = (_a = error.response) == null ? void 0 : _a.data) == null ? void 0 : _b.message) || error.message || this.tm("messages.deleteError"));
      } finally {
        this.loading = false;
    ...
    async batchDeleteConversations() {
      ...
      try {
        ...
        this.showErrorMessage(((_b = (_a = error.response) == null ? void 0 : _a.data) == null ? void 0 : _b.message) || error.message || this.tm("messages.batchDeleteError"));
      } finally {
        this.loading = false;
      }
    },
    ...
    async exportConversations() {
      ...
      try {
        ...
        this.showErrorMessage(((_b = (_a = error.response) == null ? void 0 : _a.data) == null ? void 0 : _b.message) || error.message || this.tm("messages.exportError"));
      } finally {
        this.loading = false;
      }
    },
    ...
    convertContentToMessageParts(content) {
      ...
      if (typeof content === "string") {
        ...
        content.forEach((item) => {
          ...
          } else if (item.type === "image_url" && ((_a = item.image_url) == null ? void 0 : _a.url)) {
            parts.push({
              type: "image",
    ...
    extractImagesFromContent(content) {
      if (Array.isArray(content)) {
        return content.filter((item) => item.type === "image_url").map((item) => {
          var _a;
          return (_a = item.image_url) == null ? void 0 : _a.url;
        }).filter((url) => url);
      }
      return [];
    }
...
const _hoisted_1 = { class: "conversation-page" };
const _hoisted_2 = { class: "text-h4" };
const _hoisted_3 = { class: "umo-header-cell" };
const _hoisted_4 = { class: "conversation-title-cell" };
const _hoisted_5 = { class: "conversation-title-row" };
const _hoisted_6 = { class: "conversation-title-text" };
const _hoisted_7 = { class: "conversation-title-meta" };
const _hoisted_8 = { class: "umo-source-cell" };
const _hoisted_9 = { class: "umo-source-content" };
const _hoisted_10 = /* @__PURE__ */ createBaseVNode("span", { class: "umo-separator" }, ":", -1);
const _hoisted_11 = /* @__PURE__ */ createBaseVNode("span", { class: "umo-separator" }, ":", -1);
const _hoisted_12 = { class: "umo-session-id" };
const _hoisted_13 = {
  key: 1,
  class: "umo-raw-text"
};
const _hoisted_14 = { class: "actions-wrapper" };
const _hoisted_15 = { class: "d-flex flex-column align-center py-6" };
const _hoisted_16 = { class: "text-subtitle-1 text-disabled mt-3" };
const _hoisted_17 = { class: "d-flex justify-center py-3" };
const _hoisted_18 = { class: "d-flex justify-between align-center px-4 py-2 bg-grey-lighten-5" };
const _hoisted_19 = { class: "d-flex align-center" };
const _hoisted_20 = { class: "text-caption mr-2" };
const _hoisted_21 = { class: "text-caption ml-4" };
const _hoisted_22 = { class: "text-truncate" };
const _hoisted_23 = {
  key: 0,
  class: "d-flex align-center"
};
const _hoisted_24 = { class: "mb-4 d-flex align-center" };
const _hoisted_25 = {
  key: 0,
...
const _hoisted_27 = { class: "text-disabled mt-2" };
const _hoisted_28 = { class: "mb-3" };
const _hoisted_29 = {
  key: 0,
  class: "mb-3"
};
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createVNode(VCard, { flat: "" }, {
          default: withCtx(() => [
            createVNode(VCardTitle, { class: "d-flex align-center py-3 px-4" }, {
              default: withCtx(() => [
                createBaseVNode("span", _hoisted_2, toDisplayString($setup.tm("history.title")), 1),
                createVNode(VChip, {
                  size: "small",
                  class: "ml-2"
                }, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString($data.pagination.total || 0), 1)
                  ]),
                  _: 1
                }),
                createVNode(VRow, {
                  ...
                  default: withCtx(() => [
                    createVNode(VCol, {
                      ...
                      default: withCtx(() => [
                        createVNode(VCombobox, {
                          modelValue: $data.platformFilter,
                          "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $data.platformFilter = $event),
                          label: $setup.tm("filters.platform"),
                          items: $options.availablePlatforms,
                          chips: "",
                          multiple: "",
                          clearable: "",
                          variant: "solo-filled",
                    ...
                    createVNode(VCol, {
                      ...
                      default: withCtx(() => [
                        createVNode(VSelect, {
                          modelValue: $data.messageTypeFilter,
                          "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => $data.messageTypeFilter = $event),
                          label: $setup.tm("filters.type"),
                          items: $options.messageTypeItems,
                          chips: "",
                          multiple: "",
                          clearable: "",
                          variant: "solo-filled",
                ...
                createVNode(VBtn, {
                  ...
                  variant: "tonal",
                  onClick: $options.fetchConversations,
                  loading: $data.loading,
                  size: "small",
                  class: "mr-2"
                }, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString($setup.tm("history.refresh")), 1)
                  ]),
                  _: 1
                }, 8, ["onClick", "loading"]),
                $data.selectedItems.length > 0 ? (openBlock(), createBlock(VBtn, {
                  ...
                  variant: "tonal",
                  onClick: $options.exportConversations,
                  disabled: $data.loading,
                  size: "small",
                  class: "mr-2"
                }, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString($setup.tm("batch.exportSelected", { count: $data.selectedItems.length })), 1)
                  ]),
                  _: 1
                ...
                $data.selectedItems.length > 0 ? (openBlock(), createBlock(VBtn, {
                  ...
                  default: withCtx(() => [
                    createTextVNode(toDisplayString($setup.tm("batch.deleteSelected", { count: $data.selectedItems.length })), 1)
                  ]),
                  _: 1
                }, 8, ["onClick", "disabled"])) : createCommentVNode("", true)
              ]),
            ...
            createVNode(VCardText, { class: "pa-0" }, {
              default: withCtx(() => [
                createVNode(VDataTable, {
                  ...
                  "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => $data.selectedItems = $event),
                  ...
                  "hide-default-footer": "",
                  class: "elevation-0",
                  "items-per-page": $data.pagination.page_size,
                  "items-per-page-options": $data.pageSizeOptions,
                  "show-select": "",
                  "return-object": "",
                  disabled: $data.loading,
                  "onUpdate:options": $options.handleTableOptions
                }, {
                  "header.umo_source": withCtx(() => [
                    createBaseVNode("div", _hoisted_3, [
                      createBaseVNode("span", null, toDisplayString($setup.tm("table.headers.umo")), 1),
                      createVNode(VBtnToggle, {
                        modelValue: $data.umoDisplayMode,
                        "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => $data.umoDisplayMode = $event),
                        mandatory: "",
                        density: "compact",
                        divided: "",
                        variant: "outlined",
                        ...
                        default: withCtx(() => [
                          createVNode(VBtn, {
                            ...
                            default: withCtx(() => [
                              createTextVNode(toDisplayString($setup.tm("table.umoDisplay.parsed")), 1)
                            ]),
                            _: 1
                          }),
                          createVNode(VBtn, {
                            ...
                            default: withCtx(() => [
                              createTextVNode(toDisplayString($setup.tm("table.umoDisplay.raw")), 1)
                            ]),
                            _: 1
                          })
                        ]),
                  ...
                  "item.title": withCtx(({ item }) => [
                    createBaseVNode("div", _hoisted_4, [
                      createBaseVNode("div", _hoisted_5, [
                        createBaseVNode("span", _hoisted_6, toDisplayString(item.title || $setup.tm("status.noTitle")), 1),
                        createVNode(VBtn, {
                          icon: "",
                          variant: "plain",
                          size: "x-small",
                          ...
                          onClick: withModifiers(($event) => $options.editConversation(item), ["stop"]),
                          disabled: $data.loading
                        }, {
                          default: withCtx(() => [
                      ...
                      createBaseVNode("span", _hoisted_7, toDisplayString(item.cid || $setup.tm("status.unknown")), 1)
                    ])
                  ]),
                  "item.umo_source": withCtx(({ item }) => [
                    createBaseVNode("div", _hoisted_8, [
                      createBaseVNode("div", _hoisted_9, [
                        $data.umoDisplayMode === "parsed" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                          createVNode(VChip, {
                            size: "x-small",
                            label: ""
                          }, {
                            default: withCtx(() => [
                              createTextVNode(toDisplayString(item.sessionInfo.platform || $setup.tm("status.unknown")), 1)
                            ]),
                            _: 2
                          }, 1024),
                          _hoisted_10,
                          createVNode(VChip, {
                            ...
                            default: withCtx(() => [
                              createTextVNode(toDisplayString($options.getMessageTypeDisplay(item.sessionInfo.messageType)), 1)
                            ]),
                            _: 2
                          }, 1024),
                          _hoisted_11,
                          createBaseVNode("span", _hoisted_12, toDisplayString(item.sessionInfo.sessionId || $setup.tm("status.unknown")), 1)
                        ], 64)) : (openBlock(), createElementBlock("span", _hoisted_13, toDisplayString(item.user_id || $setup.tm("status.unknown")), 1))
                      ]),
                      createVNode(VBtn, {
                        icon: "",
                        variant: "plain",
                        ...
                        onClick: withModifiers(($event) => $options.copyUmoSource(item), ["stop"])
                      }, {
                        default: withCtx(() => [
                          createVNode(VIcon, { size: "16" }, {
                            default: withCtx(() => [
                  ...
                  "item.created_at": withCtx(({ item }) => [
                    createTextVNode(toDisplayString($options.formatTimestamp(item.created_at)), 1)
                  ]),
                  "item.updated_at": withCtx(({ item }) => [
                    createTextVNode(toDisplayString($options.formatTimestamp(item.updated_at)), 1)
                  ]),
                  "item.actions": withCtx(({ item }) => [
                    createBaseVNode("div", _hoisted_14, [
                      createVNode(VBtn, {
                        ...
                        size: "x-small",
                        class: "action-button",
                        onClick: ($event) => $options.viewConversation(item),
                        disabled: $data.loading
                      }, {
                        default: withCtx(() => [
                      ...
                      createVNode(VBtn, {
                        ...
                        size: "x-small",
                        class: "action-button",
                        onClick: ($event) => $options.confirmDeleteConversation(item),
                        disabled: $data.loading
                      }, {
                        default: withCtx(() => [
                          createVNode(VIcon, null, {
                  ...
                  "no-data": withCtx(() => [
                    createBaseVNode("div", _hoisted_15, [
                      createVNode(VIcon, {
                        ...
                        default: withCtx(() => [
                          createTextVNode("mdi-chat-remove")
                        ]),
                        _: 1
                      }),
                      createBaseVNode("span", _hoisted_16, toDisplayString($setup.tm("status.noData")), 1)
                    ])
                  ]),
                  _: 1
                }, 8, ["modelValue", "headers", "items", "loading", "items-per-page", "items-per-page-options", "disabled", "onUpdate:options"]),
                createBaseVNode("div", _hoisted_17, [
                  createBaseVNode("div", _hoisted_18, [
                    createBaseVNode("div", _hoisted_19, [
                      createBaseVNode("span", _hoisted_20, toDisplayString($setup.tm("pagination.itemsPerPage")) + ":", 1),
                      createVNode(VSelect, {
                        modelValue: $data.pagination.page_size,
                        "onUpdate:modelValue": [
                          _cache[5] || (_cache[5] = ($event) => $data.pagination.page_size = $event),
                    ...
                    createBaseVNode("div", _hoisted_21, toDisplayString($setup.tm("pagination.showingItems", {
                      start: Math.min(($data.pagination.page - 1) * $data.pagination.page_size + 1, $data.pagination.total),
                      end: Math.min($data.pagination.page * $data.pagination.page_size, $data.pagination.total),
                  ...
                  createVNode(VPagination, {
                    ...
                    "onUpdate:modelValue": [
                      _cache[6] || (_cache[6] = ($event) => $data.pagination.page = $event),
                      $options.fetchConversations
                    ],
                    length: $data.pagination.total_pages,
                    disabled: $data.loading,
                    rounded: "circle",
                    "total-visible": 7
                  }, null, 8, ["modelValue", "length", "disabled", "onUpdate:modelValue"])
                ])
              ]),
              _: 1
            })
    ...
    createVNode(VDialog, {
      modelValue: $data.dialogView,
      "onUpdate:modelValue": _cache[10] || (_cache[10] = ($event) => $data.dialogView = $event),
      "max-width": "900px",
      scrollable: ""
    }, {
      default: withCtx(() => [
        createVNode(VCard, { class: "conversation-detail-card" }, {
          default: withCtx(() => [
            createVNode(VCardTitle, { class: "ml-2 mt-2 d-flex align-center" }, {
              default: withCtx(() => {
                var _a, _b;
                return [
                  createBaseVNode("span", _hoisted_22, toDisplayString(((_a = $data.selectedConversation) == null ? void 0 : _a.title) || $setup.tm("status.noTitle")), 1),
                  createVNode(VSpacer),
                  ((_b = $data.selectedConversation) == null ? void 0 : _b.sessionInfo) ? (openBlock(), createElementBlock("div", _hoisted_23, [
                    createVNode(VChip, {
                      "text-color": "primary",
                      size: "small",
                      class: "mr-2",
                      ...
                      default: withCtx(() => [
                        createTextVNode(toDisplayString($data.selectedConversation.sessionInfo.platform), 1)
                      ]),
                      _: 1
                    }),
                    createVNode(VChip, {
                      ...
                      default: withCtx(() => [
                        createTextVNode(toDisplayString($options.getMessageTypeDisplay($data.selectedConversation.sessionInfo.messageType)), 1)
                      ]),
                      _: 1
                    })
                  ])) : createCommentVNode("", true)
              ...
              default: withCtx(() => [
                createBaseVNode("div", _hoisted_24, [
                  createVNode(VBtn, {
                    ...
                    size: "small",
                    class: "mr-2",
                    onClick: _cache[7] || (_cache[7] = ($event) => $data.isEditingHistory = !$data.isEditingHistory)
                  }, {
                    default: withCtx(() => [
                      createVNode(VIcon, { class: "mr-1" }, {
                        default: withCtx(() => [
                          createTextVNode(toDisplayString($data.isEditingHistory ? "mdi-eye" : "mdi-pencil"), 1)
                        ]),
                        _: 1
                      }),
                      createTextVNode(" " + toDisplayString($data.isEditingHistory ? $setup.tm("dialogs.view.previewMode") : $setup.tm("dialogs.view.editMode")), 1)
                    ]),
                    _: 1
                  }),
                  $data.isEditingHistory ? (openBlock(), createBlock(VBtn, {
                    key: 0,
                    color: "success",
                    variant: "tonal",
                    size: "small",
                    loading: $data.savingHistory,
                    onClick: $options.saveHistoryChanges
                  }, {
                    default: withCtx(() => [
                      createVNode(VIcon, { class: "mr-1" }, {
                        default: withCtx(() => [
                      ...
                      createTextVNode(" " + toDisplayString($setup.tm("dialogs.view.saveChanges")), 1)
                    ]),
                    _: 1
                  }, 8, ["loading", "onClick"])) : createCommentVNode("", true)
                ]),
                $data.isEditingHistory ? (openBlock(), createElementBlock("div", _hoisted_25, [
                  createVNode(_component_VueMonacoEditor, {
                    value: $data.editedHistory,
                    "onUpdate:value": _cache[8] || (_cache[8] = ($event) => $data.editedHistory = $event),
                    theme: "vs-dark",
                    language: "json",
                    options: {
                    ...
                    onEditorDidMount: $options.onMonacoMounted
                  }, null, 8, ["value", "onEditorDidMount"])
                ])) : (openBlock(), createElementBlock("div", {
                  key: 1,
                  class: "conversation-messages-container",
                  style: { "background-color": "var(--v-theme-surface)" },
                  ref: "messagesContainer",
                  onWheel: _cache[9] || (_cache[9] = withModifiers((...args) => $options.onContainerWheel && $options.onContainerWheel(...args), ["prevent"]))
                }, [
                  $data.conversationHistory.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_26, [
                    createVNode(VIcon, {
                      size: "48",
                      color: "grey"
                    }, {
                    ...
                    createBaseVNode("p", _hoisted_27, toDisplayString($setup.tm("status.emptyContent")), 1)
                  ])) : (openBlock(), createBlock(_component_MessageList, {
                    key: 1,
                    messages: $options.formattedMessages,
                    isDark: $options.isDark
                  }, null, 8, ["messages", "isDark"]))
                ], 544))
              ]),
              _: 1
            }),
            createVNode(VCardActions, { class: "pa-4" }, {
              default: withCtx(() => [
                ...
                createVNode(VBtn, {
                  variant: "text",
                  onClick: $options.closeHistoryDialog
                }, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString($setup.tm("dialogs.view.close")), 1)
                  ]),
                  _: 1
                }, 8, ["onClick"])
              ]),
    ...
    createVNode(VDialog, {
      ...
      "onUpdate:modelValue": _cache[14] || (_cache[14] = ($event) => $data.dialogEdit = $event),
      "max-width": "500px"
    }, {
      default: withCtx(() => [
        createVNode(VCard, null, {
          default: withCtx(() => [
            createVNode(VCardTitle, { class: "bg-primary text-white py-3" }, {
              default: withCtx(() => [
                createVNode(VIcon, {
                  color: "white",
                  class: "me-2"
                ...
                createBaseVNode("span", null, toDisplayString($setup.tm("dialogs.edit.title")), 1)
              ]),
              _: 1
            }),
            createVNode(VCardText, { class: "py-4" }, {
              default: withCtx(() => [
                createVNode(VForm, {
                  ...
                  default: withCtx(() => [
                    createVNode(VTextField, {
                      modelValue: $data.editedItem.title,
                      "onUpdate:modelValue": _cache[11] || (_cache[11] = ($event) => $data.editedItem.title = $event),
                      label: $setup.tm("dialogs.edit.titleLabel"),
                      placeholder: $setup.tm("dialogs.edit.titlePlaceholder"),
                      variant: "outlined",
                      density: "comfortable",
                      class: "mb-3"
            ...
            createVNode(VCardActions, { class: "pa-4" }, {
              default: withCtx(() => [
                ...
                createVNode(VBtn, {
                  variant: "text",
                  onClick: _cache[13] || (_cache[13] = ($event) => $data.dialogEdit = false),
                  disabled: $data.loading
                }, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString($setup.tm("dialogs.edit.cancel")), 1)
                  ]),
                  _: 1
                }, 8, ["disabled"]),
                createVNode(VBtn, {
                  color: "primary",
                  onClick: $options.saveConversation,
                  loading: $data.loading
                }, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString($setup.tm("dialogs.edit.save")), 1)
                  ]),
                  _: 1
                }, 8, ["onClick", "loading"])
              ]),
    ...
    createVNode(VDialog, {
      ...
      "onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => $data.dialogDelete = $event),
      "max-width": "500px"
    }, {
      default: withCtx(() => [
        createVNode(VCard, null, {
          default: withCtx(() => [
            createVNode(VCardTitle, { class: "bg-error text-white py-3" }, {
              default: withCtx(() => [
                createVNode(VIcon, {
                  color: "white",
                  class: "me-2"
                ...
                createBaseVNode("span", null, toDisplayString($setup.tm("dialogs.delete.title")), 1)
              ]),
              _: 1
            }),
            createVNode(VCardText, { class: "py-4" }, {
              default: withCtx(() => {
                var _a;
                return [
                  createBaseVNode("p", null, toDisplayString($setup.tm("dialogs.delete.message", { title: ((_a = $data.selectedConversation) == null ? void 0 : _a.title) || $setup.tm("status.noTitle") })), 1)
                ];
              }),
              _: 1
            }),
            ...
            createVNode(VCardActions, { class: "pa-4" }, {
              default: withCtx(() => [
                ...
                createVNode(VBtn, {
                  variant: "text",
                  onClick: _cache[15] || (_cache[15] = ($event) => $data.dialogDelete = false),
                  disabled: $data.loading
                }, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString($setup.tm("dialogs.delete.cancel")), 1)
                  ]),
                  _: 1
                }, 8, ["disabled"]),
                createVNode(VBtn, {
                  color: "error",
                  onClick: $options.deleteConversation,
                  loading: $data.loading
                }, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString($setup.tm("dialogs.delete.confirm")), 1)
                  ]),
                  _: 1
                }, 8, ["onClick", "loading"])
              ]),
    ...
    createVNode(VDialog, {
      modelValue: $data.dialogBatchDelete,
      "onUpdate:modelValue": _cache[18] || (_cache[18] = ($event) => $data.dialogBatchDelete = $event),
      "max-width": "600px"
    }, {
      default: withCtx(() => [
        createVNode(VCard, null, {
          default: withCtx(() => [
            createVNode(VCardTitle, { class: "bg-error text-white py-3" }, {
              default: withCtx(() => [
                ...
                createBaseVNode("span", null, toDisplayString($setup.tm("dialogs.batchDelete.title")), 1)
              ]),
              _: 1
            }),
            createVNode(VCardText, { class: "py-4" }, {
              default: withCtx(() => [
                createBaseVNode("p", _hoisted_28, toDisplayString($setup.tm("dialogs.batchDelete.message", { count: $data.selectedItems.length })), 1),
                $data.selectedItems.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_29, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList($data.selectedItems.slice(0, 5), (item, index) => {
                    return openBlock(), createBlock(VChip, {
                      key: `${item.user_id}-${item.cid}`,
                      size: "small",
                      class: "mr-1 mb-1",
                      closable: "",
                      "onClick:close": ($event) => $options.removeFromSelection(item),
                      disabled: $data.loading
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(item.title || $setup.tm("status.noTitle")), 1)
                      ]),
                      _: 2
                    }, 1032, ["onClick:close", "disabled"]);
                  }), 128)),
                  $data.selectedItems.length > 5 ? (openBlock(), createBlock(VChip, {
                    key: 0,
                    size: "small",
                    class: "mr-1 mb-1"
                  }, {
                    default: withCtx(() => [
                      createTextVNode(toDisplayString($setup.tm("dialogs.batchDelete.andMore", { count: $data.selectedItems.length - 5 })), 1)
                    ]),
                    _: 1
                  })) : createCommentVNode("", true)
                ])) : createCommentVNode("", true),
                createVNode(VAlert, {
                  ...
                  default: withCtx(() => [
                    createTextVNode(toDisplayString($setup.tm("dialogs.batchDelete.warning")), 1)
                  ]),
                  _: 1
                })
              ]),
            ...
            createVNode(VCardActions, { class: "pa-4" }, {
              default: withCtx(() => [
                ...
                createVNode(VBtn, {
                  variant: "text",
                  onClick: _cache[17] || (_cache[17] = ($event) => $data.dialogBatchDelete = false),
                  disabled: $data.loading
                }, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString($setup.tm("dialogs.batchDelete.cancel")), 1)
                  ]),
                  _: 1
                }, 8, ["disabled"]),
                createVNode(VBtn, {
                  color: "error",
                  onClick: $options.batchDeleteConversations,
                  loading: $data.loading
                }, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString($setup.tm("dialogs.batchDelete.confirm")), 1)
                  ]),
                  _: 1
                }, 8, ["onClick", "loading"])
              ]),
    ...
    createVNode(VSnackbar, {
      ...
      modelValue: $data.showMessage,
      "onUpdate:modelValue": _cache[19] || (_cache[19] = ($event) => $data.showMessage = $event),
      location: "top"
    }, {
      default: withCtx(() => [
...
const ConversationPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
