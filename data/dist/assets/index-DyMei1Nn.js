...
const _sfc_main = {
  ...
  methods: {
    async loadSessions() {
      var _a;
      try {
        const r = await fetch("/api/miku/sessions");
        const d = await r.json();
        this.sessions = Array.isArray((_a = d == null ? void 0 : d.data) == null ? void 0 : _a.sessions) ? d.data.sessions : [];
      } catch (e) {
      }
    },
    async loadEntries() {
    ...
    createBaseVNode("div", _hoisted_6, [
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList($data.entries, (entry) => {
        return openBlock(), createElementBlock("div", {
          key: entry.id,
          class: "mb-2 pa-3",
          style: { "background": "var(--v-theme-surface-variant)", "border-radius": "8px", "border-left": "3px solid rgb(var(--v-theme-primary))" }
        }, [
