import { D as defineComponent, a5 as useI18n, u as useModuleI18n, L as ref, J as watch, h as createBlock, w as withCtx, b as createVNode, s as VCard, a6 as VCardTitle, d as createTextVNode, t as toDisplayString, $ as unref, v as VCardText, a as createBaseVNode, x as VDivider, al as VCheckbox, a7 as VTooltip, l as VIcon, a2 as mergeProps, k as VAlert, i as createCommentVNode, a9 as VCardActions, V as VSpacer, e as VBtn, an as withKeys, ai as VDialog, o as openBlock, _ as _export_sfc, C as resolveComponent, c as createElementBlock, ab as VRow, z as VBtnToggle, F as Fragment, y as VProgressLinear, r as renderList, ad as VCol, g as VChip, j as VTextField, f as VSelect, aP as VDataTable, ao as VContainer, a0 as withModifiers, T as normalizeClass, am as VSnackbar, bd as reactive, H as computed, M as onMounted, B as axios, ap as pushScopeId, aq as popScopeId, Z as renderSlot, bM as VBtnGroup, ae as VMenu, af as VList, ag as VListItem, ah as VListItemTitle, bN as VTable, a8 as VSwitch, bq as VSlideYTransition, S as withDirectives, W as vShow, aB as VListItemSubtitle, bO as VAlertTitle, b7 as VAvatar, U as normalizeStyle, aa as VImg, bA as useAttrs, O as inject, aA as isRef, bP as TransitionGroup, bL as VFadeTransition, bQ as EXTENSION_ROUTE_NAME, as as useCommonStore, aI as useRouter, aO as useRoute, bm as useDisplay, I as onUnmounted, p as VTabs, n as VTab, A as VWindow, q as VWindowItem, b8 as VFileInput } from "./index-Chcpfqng.js";
import { A as AstrBotConfig } from "./AstrBotConfig-BOuX4oeH.js";
import { C as ConsoleDisplayer } from "./ConsoleDisplayer-CTf5JxtC.js";
import { R as ReadmeDialog } from "./ReadmeDialog-CPj7itZV.js";
import { P as ProxySelector } from "./ProxySelector-CoreQTrn.js";
import { I as ItemCard } from "./ItemCard-BP_cE_CV.js";
import { n as normalizeTextInput } from "./inputValue-BqQtgRan.js";
import { u as useCustomizerStore } from "./customizer-BzxovCAs.js";
import { _ as _sfc_main$e } from "./StyledMenu.vue_vue_type_style_index_0_lang-DijVCElC.js";
...
const _hoisted_2$b = { class: "text-subtitle-2 mb-3" };
const _sfc_main$d = /* @__PURE__ */ defineComponent({
  __name: "UninstallConfirmDialog",
  props: {
    modelValue: {
      type: Boolean,
      default: false
          ...
          createVNode(VCard, null, {
            default: withCtx(() => [
              createVNode(VCardTitle, { class: "text-h5" }, {
                default: withCtx(() => [
                  createTextVNode(toDisplayString(unref(tm)("dialogs.uninstall.title")), 1)
                ]),
                _: 1
              }),
              createVNode(VCardText, null, {
                default: withCtx(() => [
                  createBaseVNode("div", _hoisted_1$d, toDisplayString(unref(tm)("dialogs.uninstall.message")), 1),
                  createVNode(VDivider, { class: "my-4" }),
                  createBaseVNode("div", _hoisted_2$b, toDisplayString(unref(t)("core.common.actions")) + ":", 1),
                  createVNode(VCheckbox, {
                    modelValue: deleteConfig.value,
                    "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => deleteConfig.value = $event),
                    label: unref(tm)("dialogs.uninstall.deleteConfig"),
                    color: "warning",
                    "hide-details": "",
                    class: "mb-2"
                  }, {
                    append: withCtx(() => [
                      createVNode(VTooltip, { location: "top" }, {
                        ...
                        default: withCtx(() => [
                          createBaseVNode("span", null, toDisplayString(unref(tm)("dialogs.uninstall.configHint")), 1)
                        ]),
                        _: 1
                      })
                    ]),
                  ...
                  createVNode(VCheckbox, {
                    modelValue: deleteData.value,
                    "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => deleteData.value = $event),
                    label: unref(tm)("dialogs.uninstall.deleteData"),
                    color: "error",
                    "hide-details": ""
                  }, {
                    append: withCtx(() => [
                      createVNode(VTooltip, { location: "top" }, {
                        ...
                        default: withCtx(() => [
                          createBaseVNode("span", null, toDisplayString(unref(tm)("dialogs.uninstall.dataHint")), 1)
                        ]),
                        _: 1
                      })
                    ]),
                  ...
                  deleteConfig.value || deleteData.value ? (openBlock(), createBlock(VAlert, {
                    key: 0,
                    type: "warning",
                    variant: "tonal",
                    density: "compact",
                    ...
                    default: withCtx(() => [
                      createTextVNode(" " + toDisplayString(unref(t)("messages.validation.operation_cannot_be_undone")), 1)
                    ]),
                    _: 1
...
const _sfc_main$c = {
  ...
  setup() {
    ...
    const activeReleaseCount = computed(
      () => neoReleases.value.filter((item) => item == null ? void 0 : item.is_active).length
    );
    ...
    const isSandboxPresetSkill = (skill) => (skill == null ? void 0 : skill.source_type) === "sandbox_only";
    ...
    const openUploadPicker = () => {
      var _a;
      if (uploading.value) return;
      (_a = uploadInput.value) == null ? void 0 : _a.click();
    };
    const addUploadFiles = (filesToAdd) => {
      ...
      for (const file of filesToAdd) {
        if (!(file == null ? void 0 : file.name)) continue;
    ...
    const handleUploadSelection = (event) => {
      var _a;
      const selected = Array.from(((_a = event == null ? void 0 : event.target) == null ? void 0 : _a.files) || []);
    ...
    const handleUploadDrop = (event) => {
      ...
      addUploadFiles(Array.from(((_a = event == null ? void 0 : event.dataTransfer) == null ? void 0 : _a.files) || []));
    };
    ...
    const buildResultMap = (items = []) => {
      ...
      for (const item of items) {
        const filenameKey = normalizeUploadName(item == null ? void 0 : item.filename);
    ...
    const applyUploadResults = (attemptedItems, payload) => {
      const succeededMap = buildResultMap(payload == null ? void 0 : payload.succeeded);
      const failedMap = buildResultMap(payload == null ? void 0 : payload.failed);
      const skippedMap = buildResultMap(payload == null ? void 0 : payload.skipped);
    ...
    const uploadSkillBatch = async () => {
      ...
      try {
        ...
        const responseColor = ((_b = res == null ? void 0 : res.data) == null ? void 0 : _b.status) === "error" ? "error" : failedCount > 0 ? "warning" : "success";
        showMessage(
          ((_c = res == null ? void 0 : res.data) == null ? void 0 : _c.message) || tm("skills.uploadSuccess"),
          responseColor
        );
        if (succeededCount > 0) {
          await fetchSkills();
    ...
    const fetchNeoCandidates = async () => {
      const params = {
        skill_key: neoFilters.skill_key || void 0,
        status: neoFilters.status || void 0
      };
    ...
    const loadNeoAvailability = async () => {
      ...
      try {
        ...
        const config = ((_b = (_a = res == null ? void 0 : res.data) == null ? void 0 : _a.data) == null ? void 0 : _b.config) || {};
        const providerSettings = (config == null ? void 0 : config.provider_settings) || {};
        const currentRuntime = (providerSettings == null ? void 0 : providerSettings.computer_use_runtime) || "local";
        const booter = ((_c = providerSettings == null ? void 0 : providerSettings.sandbox) == null ? void 0 : _c.booter) || "";
    ...
    const isCandidatePromoteLoading = (candidateId, stage) => !!candidatePromoteLoading[candidatePromoteLoadingKey(candidateId, stage)];
    const isCandidatePromoting = (candidateId) => isCandidatePromoteLoading(candidateId, "canary") || isCandidatePromoteLoading(candidateId, "stable");
    const promoteCandidate = async (candidate, stage) => {
      var _a, _b;
      const candidateId = candidate == null ? void 0 : candidate.id;
      ...
      try {
        ...
        const ok = ((_a = res == null ? void 0 : res.data) == null ? void 0 : _a.status) === "ok";
        if (!ok) {
          showMessage(
            ((_b = res == null ? void 0 : res.data) == null ? void 0 : _b.message) || tm("skills.neoPromoteFailed"),
            "error"
          );
        } else {
    ...
    const handleReleaseLifecycleAction = async (release) => {
      if (release == null ? void 0 : release.is_active) {
    ...
    const viewPayload = async (payloadRef) => {
      ...
      try {
        ...
        if (((_a = res == null ? void 0 : res.data) == null ? void 0 : _a.status) !== "ok") {
          showMessage(
            ((_b = res == null ? void 0 : res.data) == null ? void 0 : _b.message) || tm("skills.neoPayloadFailed"),
            "error"
          );
          return;
        }
        const payload = ((_c = res == null ? void 0 : res.data) == null ? void 0 : _c.data) || {};
...
const _withScopeId$1 = (n) => (pushScopeId("data-v-75a1ec37"), n = n(), popScopeId(), n);
const _hoisted_1$c = { class: "skills-page" };
const _hoisted_2$a = {
  key: 0,
  class: "px-2 pb-2 d-flex flex-column ga-2"
};
const _hoisted_3$9 = { style: { "color": "grey" } };
const _hoisted_4$9 = {
  key: 1,
  class: "px-3 pb-3"
};
...
const _hoisted_6$7 = { class: "text-grey mt-4" };
const _hoisted_7$7 = { class: "text-grey" };
const _hoisted_8$7 = { class: "d-flex align-center mb-2 ga-2 flex-wrap" };
const _hoisted_9$6 = { class: "text-caption text-medium-emphasis skill-description" };
const _hoisted_10$4 = { class: "text-caption text-medium-emphasis skill-path" };
const _hoisted_11$4 = { class: "d-flex flex-wrap justify-space-between align-center ga-2 mb-3" };
const _hoisted_12$4 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("div", { class: "text-subtitle-1 font-weight-bold" }, "Neo Skills", -1));
const _hoisted_13$4 = { class: "text-caption text-medium-emphasis" };
const _hoisted_14$3 = { class: "mx-3 mb-3 d-flex flex-wrap ga-2" };
const _hoisted_15$3 = { class: "d-flex ga-1 flex-wrap" };
const _hoisted_16$3 = { class: "d-flex ga-1 flex-wrap" };
const _hoisted_17$3 = { class: "skills-upload-dialog__heading" };
const _hoisted_18$3 = { class: "text-h4 font-weight-medium" };
const _hoisted_19$3 = { class: "skills-upload-dialog__description skills-upload-dialog__description--body" };
const _hoisted_20$3 = { class: "skills-upload-structure-note" };
const _hoisted_21$3 = { class: "skills-upload-capabilities" };
const _hoisted_22$2 = { class: "skills-upload-capability" };
const _hoisted_23$2 = { class: "skills-upload-capability__icon" };
const _hoisted_24$2 = { class: "skills-upload-capability" };
const _hoisted_25$2 = { class: "skills-upload-capability__icon" };
const _hoisted_26$2 = { class: "skills-upload-capability" };
const _hoisted_27$2 = { class: "skills-upload-capability__icon" };
const _hoisted_28$2 = ["aria-label"];
const _hoisted_29$2 = { class: "skills-dropzone__icon" };
const _hoisted_30$2 = { class: "text-h6 font-weight-medium" };
const _hoisted_31$2 = { class: "skills-dropzone__subtitle" };
const _hoisted_32$2 = { class: "skills-dropzone__hint" };
const _hoisted_33$2 = {
  key: 0,
...
const _hoisted_35$2 = { class: "skills-upload-list__header" };
const _hoisted_36$1 = { class: "skills-upload-row__meta" };
const _hoisted_37$1 = { class: "skills-upload-row__name" };
const _hoisted_38$1 = { class: "skills-upload-row__size" };
const _hoisted_39$1 = { class: "skills-upload-row__message" };
const _hoisted_40$1 = { class: "skills-upload-row__actions" };
const _hoisted_41$1 = {
  key: 2,
  class: "skills-upload-empty"
};
const _hoisted_42$1 = { class: "payload-preview" };
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_item_card = resolveComponent("item-card");
  return openBlock(), createElementBlock("div", _hoisted_1$c, [
    createVNode(VContainer, {
      ...
      default: withCtx(() => [
        createVNode(VRow, { class: "d-flex justify-space-between align-center px-4 py-3 pb-4" }, {
          default: withCtx(() => [
            createBaseVNode("div", null, [
              $setup.mode === "local" ? (openBlock(), createBlock(VBtn, {
                key: 0,
                color: "primary",
                ...
                default: withCtx(() => [
                  createTextVNode(toDisplayString($setup.tm("skills.upload")), 1)
                ]),
                _: 1
              ...
              createVNode(VBtn, {
                ...
                variant: "tonal",
                onClick: $setup.refreshCurrentMode
              }, {
                default: withCtx(() => [
                  createTextVNode(toDisplayString($setup.tm("skills.refresh")), 1)
                ]),
                _: 1
              }, 8, ["onClick"])
            ]),
            createVNode(VBtnToggle, {
              ...
              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $setup.mode = $event),
              mandatory: "",
              divided: "",
              density: "comfortable"
            }, {
              default: withCtx(() => [
                createVNode(VBtn, { value: "local" }, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString($setup.tm("skills.modeLocal")), 1)
                  ]),
                  _: 1
                }),
                createVNode(VBtn, {
                  value: "neo",
                  disabled: !$setup.neoEnabled
                }, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString($setup.tm("skills.modeNeo")), 1)
                  ]),
                  _: 1
                }, 8, ["disabled"])
              ]),
        ...
        $setup.mode === "local" ? (openBlock(), createElementBlock("div", _hoisted_2$a, [
          createBaseVNode("small", _hoisted_3$9, toDisplayString($setup.tm("skills.runtimeHint")), 1),
          $setup.runtime === "sandbox" && !$setup.sandboxCache.ready ? (openBlock(), createBlock(VAlert, {
            key: 0,
            type: "info",
            variant: "tonal",
            density: "comfortable",
            ...
            default: withCtx(() => [
              createTextVNode(toDisplayString($setup.tm("skills.sandboxDiscoveryPending")), 1)
            ]),
            _: 1
          })) : createCommentVNode("", true)
        ])) : createCommentVNode("", true),
        $setup.mode === "neo" && !$setup.neoEnabled ? (openBlock(), createElementBlock("div", _hoisted_4$9, [
          createVNode(VAlert, {
            type: "warning",
            variant: "tonal",
            density: "comfortable",
            ...
            default: withCtx(() => [
              createTextVNode(toDisplayString($setup.neoUnavailableMessage), 1)
            ]),
            _: 1
          })
        ])) : createCommentVNode("", true),
        $setup.mode === "local" ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [
          $setup.loading ? (openBlock(), createBlock(VProgressLinear, {
            key: 0,
            indeterminate: "",
            color: "primary"
          })) : $setup.skills.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_5$7, [
            createVNode(VIcon, {
              size: "64",
            ...
            createBaseVNode("p", _hoisted_6$7, toDisplayString($setup.tm("skills.empty")), 1),
            createBaseVNode("small", _hoisted_7$7, toDisplayString($setup.tm("skills.emptyHint")), 1)
          ])) : (openBlock(), createBlock(VRow, {
            key: 2,
            align: "stretch"
          }, {
            default: withCtx(() => [
              (openBlock(true), createElementBlock(Fragment, null, renderList($setup.skills, (skill) => {
                return openBlock(), createBlock(VCol, {
                  ...
                  default: withCtx(() => [
                    createVNode(_component_item_card, {
                      item: skill,
                      "title-field": "name",
                      "enabled-field": "active",
                      loading: $setup.itemLoading[skill.name] || false,
                      "show-edit-button": false,
                      "disable-toggle": $setup.isSandboxPresetSkill(skill),
                      "disable-delete": $setup.isSandboxPresetSkill(skill),
                      onToggleEnabled: $setup.toggleSkill,
                      ...
                      "item-details": withCtx(({ item }) => [
                        createBaseVNode("div", _hoisted_8$7, [
                          createVNode(VChip, {
                            size: "x-small",
                            variant: "tonal",
                            color: $setup.sourceTypeColor(item.source_type)
                          }, {
                            default: withCtx(() => [
                              createTextVNode(toDisplayString($setup.sourceTypeLabel(item.source_type)), 1)
                            ]),
                            _: 2
                          }, 1032, ["color"]),
                          createBaseVNode("div", _hoisted_9$6, [
                            ...
                            createTextVNode(" " + toDisplayString(item.description || $setup.tm("skills.noDescription")), 1)
                          ])
                        ]),
                        createBaseVNode("div", _hoisted_10$4, [
                          ...
                          createTextVNode(" " + toDisplayString($setup.tm("skills.path")) + ": " + toDisplayString(item.path), 1)
                        ])
                      ]),
                      actions: withCtx(({ item }) => [
                        createVNode(VBtn, {
                          ...
                          size: "small",
                          rounded: "xl",
                          disabled: $setup.itemLoading[item.name] || false || $setup.isSandboxPresetSkill(item),
                          onClick: ($event) => $setup.downloadSkill(item)
                        }, {
                          default: withCtx(() => [
                            createTextVNode(toDisplayString($setup.tm("skills.download")), 1)
                          ]),
                          _: 2
                        }, 1032, ["disabled", "onClick"])
                      ]),
                      _: 2
                    }, 1032, ["item", "loading", "disable-toggle", "disable-delete", "onToggleEnabled", "onDelete"])
                  ]),
                  _: 2
                }, 1024);
              }), 128))
        ...
        ], 64)) : $setup.mode === "neo" && $setup.neoEnabled ? (openBlock(), createElementBlock(Fragment, { key: 3 }, [
          createVNode(VCard, {
            ...
            default: withCtx(() => [
              createBaseVNode("div", _hoisted_11$4, [
                createBaseVNode("div", null, [
                  _hoisted_12$4,
                  createBaseVNode("div", _hoisted_13$4, toDisplayString($setup.tm("skills.neoFilterHint")), 1)
                ]),
                createVNode(VBtn, {
                  color: "primary",
                  "prepend-icon": "mdi-refresh",
                  variant: "flat",
                  onClick: $setup.fetchNeoData
                }, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString($setup.tm("skills.refresh")), 1)
                  ]),
              ...
              createVNode(VRow, { class: "ga-md-0 ga-2" }, {
                default: withCtx(() => [
                  createVNode(VCol, {
                    cols: "12",
                    md: "4"
                    ...
                    default: withCtx(() => [
                      createVNode(VTextField, {
                        modelValue: $setup.neoFilters.skill_key,
                        "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => $setup.neoFilters.skill_key = $event),
                        label: $setup.tm("skills.neoSkillKey"),
                  ...
                  createVNode(VCol, {
                    ...
                    default: withCtx(() => [
                      createVNode(VSelect, {
                        modelValue: $setup.neoFilters.status,
                        "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => $setup.neoFilters.status = $event),
                        label: $setup.tm("skills.neoStatus"),
                        items: $setup.candidateStatusItems,
                        "item-title": "title",
                        "item-value": "value",
                  ...
                  createVNode(VCol, {
                    ...
                    default: withCtx(() => [
                      createVNode(VSelect, {
                        modelValue: $setup.neoFilters.stage,
                        "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => $setup.neoFilters.stage = $event),
                        label: $setup.tm("skills.neoStage"),
                        items: $setup.releaseStageItems,
                        "item-title": "title",
                        "item-value": "value",
          ...
          $setup.neoLoading ? (openBlock(), createBlock(VProgressLinear, {
            key: 0,
            indeterminate: "",
            color: "primary"
          })) : createCommentVNode("", true),
          createBaseVNode("div", _hoisted_14$3, [
            createVNode(VChip, {
              ...
              default: withCtx(() => [
                createTextVNode("Candidates: " + toDisplayString($setup.neoCandidates.length), 1)
              ]),
              _: 1
            }),
            createVNode(VChip, {
              ...
              default: withCtx(() => [
                createTextVNode("Releases: " + toDisplayString($setup.neoReleases.length), 1)
              ]),
              _: 1
            }),
            createVNode(VChip, {
              ...
              default: withCtx(() => [
                createTextVNode("Active: " + toDisplayString($setup.activeReleaseCount), 1)
              ]),
              _: 1
            })
          ]),
          createVNode(VCard, {
            ...
            default: withCtx(() => [
              createVNode(VCardTitle, { class: "text-subtitle-1 font-weight-bold" }, {
                default: withCtx(() => [
                  createTextVNode(toDisplayString($setup.tm("skills.neoCandidates")), 1)
                ]),
                _: 1
              }),
              createVNode(VDataTable, {
                headers: $setup.candidateHeaders,
                items: $setup.neoCandidates,
                density: "compact",
                "items-per-page": 10,
                class: "neo-data-table"
              }, {
                "item.latest_score": withCtx(({ item }) => [
                  createTextVNode(toDisplayString(item.latest_score ?? "-"), 1)
                ]),
                "item.actions": withCtx(({ item }) => [
                  createBaseVNode("div", _hoisted_15$3, [
                    createVNode(VBtn, {
                      ...
                      color: "success",
                      variant: "tonal",
                      onClick: ($event) => $setup.evaluateCandidate(item, true)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString($setup.tm("skills.neoPass")), 1)
                      ]),
                      _: 2
                    }, 1032, ["onClick"]),
                    createVNode(VBtn, {
                      ...
                      color: "warning",
                      variant: "tonal",
                      onClick: ($event) => $setup.evaluateCandidate(item, false)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString($setup.tm("skills.neoReject")), 1)
                      ]),
                      _: 2
                    }, 1032, ["onClick"]),
                    createVNode(VBtn, {
                      ...
                      color: "primary",
                      variant: "tonal",
                      loading: $setup.isCandidatePromoteLoading(item.id, "canary"),
                      disabled: $setup.isCandidatePromoting(item.id),
                      onClick: ($event) => $setup.promoteCandidate(item, "canary")
                    }, {
                      default: withCtx(() => [
                        createTextVNode(" Canary ")
                      ]),
                      _: 2
                    ...
                    createVNode(VBtn, {
                      ...
                      color: "primary",
                      variant: "tonal",
                      loading: $setup.isCandidatePromoteLoading(item.id, "stable"),
                      disabled: $setup.isCandidatePromoting(item.id),
                      onClick: ($event) => $setup.promoteCandidate(item, "stable")
                    }, {
                      default: withCtx(() => [
                        createTextVNode(" Stable ")
                      ]),
                      _: 2
                    }, 1032, ["loading", "disabled", "onClick"]),
                    createVNode(VBtn, {
                      ...
                      onClick: ($event) => $setup.viewPayload(item.payload_ref)
                    }, {
                      default: withCtx(() => [
                    ...
                    createVNode(VBtn, {
                      ...
                      color: "error",
                      variant: "tonal",
                      onClick: ($event) => $setup.deleteCandidate(item)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString($setup.tm("skills.neoDelete")), 1)
                      ]),
                      _: 2
                    }, 1032, ["onClick"])
                  ])
          ...
          createVNode(VCard, {
            ...
            default: withCtx(() => [
              createVNode(VCardTitle, { class: "text-subtitle-1 font-weight-bold" }, {
                default: withCtx(() => [
                  createTextVNode(toDisplayString($setup.tm("skills.neoReleases")), 1)
                ]),
                _: 1
              }),
              createVNode(VDataTable, {
                headers: $setup.releaseHeaders,
                items: $setup.neoReleases,
                density: "compact",
                "items-per-page": 10,
                class: "neo-data-table"
              }, {
                ...
                "item.actions": withCtx(({ item }) => [
                  createBaseVNode("div", _hoisted_16$3, [
                    createVNode(VBtn, {
                      ...
                      color: "warning",
                      variant: "tonal",
                      onClick: ($event) => $setup.handleReleaseLifecycleAction(item)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(item.is_active ? $setup.tm("skills.neoDeactivate") : $setup.tm("skills.neoRollback")), 1)
                      ]),
                      _: 2
                    }, 1032, ["onClick"]),
                    createVNode(VBtn, {
                      ...
                      color: "primary",
                      variant: "tonal",
                      onClick: ($event) => $setup.syncRelease(item)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString($setup.tm("skills.neoSync")), 1)
                      ]),
                      _: 2
                    }, 1032, ["onClick"]),
                    createVNode(VBtn, {
                      ...
                      color: "error",
                      variant: "tonal",
                      onClick: ($event) => $setup.deleteRelease(item)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString($setup.tm("skills.neoDelete")), 1)
                      ]),
    ...
    createVNode(VDialog, {
      modelValue: $setup.uploadDialog,
      "onUpdate:modelValue": _cache[11] || (_cache[11] = ($event) => $setup.uploadDialog = $event),
      "max-width": "880px",
      persistent: $setup.uploading
    }, {
      default: withCtx(() => [
        createVNode(VCard, { class: "skills-upload-dialog" }, {
          default: withCtx(() => [
            createVNode(VCardTitle, { class: "skills-upload-dialog__header px-6 pt-6 pb-2" }, {
              default: withCtx(() => [
                createBaseVNode("div", _hoisted_17$3, [
                  createBaseVNode("div", _hoisted_18$3, toDisplayString($setup.tm("skills.uploadDialogTitle")), 1)
                ]),
                createVNode(VBtn, {
            ...
            createVNode(VCardText, { class: "skills-upload-dialog__body px-6 pb-5 pt-2" }, {
              default: withCtx(() => [
                createBaseVNode("p", _hoisted_19$3, toDisplayString($setup.tm("skills.uploadHint")), 1),
                createBaseVNode("div", _hoisted_20$3, [
                  ...
                  createBaseVNode("span", null, toDisplayString($setup.tm("skills.structureRequirement")), 1)
                ]),
                createBaseVNode("div", _hoisted_21$3, [
                  createBaseVNode("div", _hoisted_22$2, [
                    createBaseVNode("div", _hoisted_23$2, [
                      createVNode(VIcon, { size: "18" }, {
                        default: withCtx(() => [
                          createTextVNode("mdi-layers-outline")
                        ]),
                        _: 1
                      })
                    ]),
                    createBaseVNode("span", null, toDisplayString($setup.tm("skills.abilityMultiple")), 1)
                  ]),
                  createBaseVNode("div", _hoisted_24$2, [
                    ...
                    createBaseVNode("span", null, toDisplayString($setup.tm("skills.abilityValidate")), 1)
                  ]),
                  createBaseVNode("div", _hoisted_26$2, [
                    createBaseVNode("div", _hoisted_27$2, [
                      createVNode(VIcon, { size: "18" }, {
                        default: withCtx(() => [
                          createTextVNode("mdi-skip-next-circle-outline")
                        ]),
                        _: 1
                      })
                    ]),
                    createBaseVNode("span", null, toDisplayString($setup.tm("skills.abilitySkip")), 1)
                  ])
                ]),
                createBaseVNode("div", {
                  class: normalizeClass(["skills-dropzone", { "skills-dropzone--dragover": $setup.isUploadDragging }]),
                  role: "button",
                  tabindex: "0",
                  "aria-label": $setup.tm("skills.dropzoneTitle"),
                  onClick: _cache[5] || (_cache[5] = (...args) => $setup.openUploadPicker && $setup.openUploadPicker(...args)),
                  onKeydown: [
                    _cache[6] || (_cache[6] = withKeys((...args) => $setup.openUploadPicker && $setup.openUploadPicker(...args), ["enter"])),
                    _cache[7] || (_cache[7] = withKeys(withModifiers((...args) => $setup.openUploadPicker && $setup.openUploadPicker(...args), ["prevent"]), ["space"]))
                  ],
                  onDragover: _cache[8] || (_cache[8] = withModifiers(($event) => $setup.isUploadDragging = true, ["prevent"])),
                  onDragleave: _cache[9] || (_cache[9] = withModifiers(($event) => $setup.isUploadDragging = false, ["prevent"])),
                  onDrop: _cache[10] || (_cache[10] = withModifiers((...args) => $setup.handleUploadDrop && $setup.handleUploadDrop(...args), ["prevent"]))
                }, [
                  createBaseVNode("div", _hoisted_29$2, [
                    createVNode(VIcon, { size: "34" }, {
                      default: withCtx(() => [
                        createTextVNode("mdi-folder-zip-outline")
                      ]),
                      _: 1
                    })
                  ]),
                  createBaseVNode("div", _hoisted_30$2, toDisplayString($setup.tm("skills.dropzoneTitle")), 1),
                  createBaseVNode("div", _hoisted_31$2, toDisplayString($setup.tm("skills.dropzoneAction")), 1),
                  createBaseVNode("div", _hoisted_32$2, toDisplayString($setup.tm("skills.dropzoneHint")), 1),
                  createBaseVNode("input", {
                    ...
                    hidden: "",
                    accept: ".zip",
                    onChange: _cache[4] || (_cache[4] = (...args) => $setup.handleUploadSelection && $setup.handleUploadSelection(...args))
                  }, null, 544)
                ], 42, _hoisted_28$2),
                $setup.uploadItems.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_33$2, [
                  createVNode(VChip, {
                    size: "small",
                    variant: "flat",
                    ...
                    default: withCtx(() => [
                      createTextVNode(toDisplayString($setup.tm("skills.summaryTotal", { count: $setup.uploadStateCounts.total })), 1)
                    ]),
                    _: 1
                  }),
                  createVNode(VChip, {
                    ...
                    default: withCtx(() => [
                      createTextVNode(toDisplayString($setup.tm("skills.summaryReady", {
                        count: $setup.uploadStateCounts.waiting + $setup.uploadStateCounts.uploading
                      })), 1)
                    ]),
                    _: 1
                  }),
                  createVNode(VChip, {
                    ...
                    default: withCtx(() => [
                      createTextVNode(toDisplayString($setup.tm("skills.summarySuccess", {
                        count: $setup.uploadStateCounts.success
                      })), 1)
                    ]),
                    _: 1
                  }),
                  createVNode(VChip, {
                    ...
                    default: withCtx(() => [
                      createTextVNode(toDisplayString($setup.tm("skills.summaryFailed", { count: $setup.uploadStateCounts.error })), 1)
                    ]),
                    _: 1
                  }),
                  createVNode(VChip, {
                    ...
                    default: withCtx(() => [
                      createTextVNode(toDisplayString($setup.tm("skills.summarySkipped", {
                        count: $setup.uploadStateCounts.skipped
                      })), 1)
                    ]),
                    _: 1
                  })
                ])) : createCommentVNode("", true),
                $setup.uploadItems.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_34$2, [
                  createBaseVNode("div", _hoisted_35$2, [
                    createBaseVNode("span", null, toDisplayString($setup.tm("skills.fileListTitle")), 1)
                  ]),
                  (openBlock(true), createElementBlock(Fragment, null, renderList($setup.uploadItems, (item) => {
                    return openBlock(), createElementBlock("div", {
                      key: item.id,
                      class: "skills-upload-row"
                    }, [
                      createBaseVNode("div", _hoisted_36$1, [
                        createBaseVNode("div", _hoisted_37$1, toDisplayString(item.name), 1),
                        createBaseVNode("div", _hoisted_38$1, toDisplayString($setup.formatFileSize(item.size)), 1),
                        createBaseVNode("div", _hoisted_39$1, toDisplayString(item.validationMessage), 1)
                      ]),
                      createBaseVNode("div", _hoisted_40$1, [
                        createVNode(VChip, {
                          size: "small",
                          variant: "flat",
                          class: normalizeClass($setup.statusChipClass(item.status))
                        }, {
                          default: withCtx(() => [
                            createTextVNode(toDisplayString($setup.uploadStatusLabel(item.status)), 1)
                          ]),
                          _: 2
                        }, 1032, ["class"]),
                        createVNode(VBtn, {
                          ...
                          size: "small",
                          variant: "text",
                          disabled: $setup.uploading || item.status === "uploading",
                          onClick: ($event) => $setup.removeUploadItem(item.id)
                        }, null, 8, ["disabled", "onClick"])
                      ])
                    ]);
                  }), 128))
                ])) : (openBlock(), createElementBlock("div", _hoisted_41$1, toDisplayString($setup.tm("skills.fileListEmpty")), 1))
              ]),
              _: 1
            }),
            createVNode(VCardActions, { class: "skills-upload-dialog__actions justify-end px-6 pb-3 pt-2" }, {
              default: withCtx(() => [
                createVNode(VBtn, {
                  ...
                  default: withCtx(() => [
                    createTextVNode(toDisplayString($setup.tm("skills.cancel")), 1)
                  ]),
                  _: 1
                }, 8, ["disabled", "onClick"]),
                createVNode(VBtn, {
                  ...
                  disabled: !$setup.hasUploadableItems,
                  onClick: $setup.uploadSkillBatch
                }, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString($setup.tm("skills.confirmUpload")), 1)
                  ]),
                  _: 1
    ...
    createVNode(VDialog, {
      modelValue: $setup.deleteDialog,
      "onUpdate:modelValue": _cache[13] || (_cache[13] = ($event) => $setup.deleteDialog = $event),
      "max-width": "400px"
    }, {
      default: withCtx(() => [
        createVNode(VCard, null, {
          default: withCtx(() => [
            createVNode(VCardTitle, null, {
              default: withCtx(() => [
                createTextVNode(toDisplayString($setup.tm("skills.deleteTitle")), 1)
              ]),
              _: 1
            }),
            createVNode(VCardText, null, {
              default: withCtx(() => [
                createTextVNode(toDisplayString($setup.tm("skills.deleteMessage")), 1)
              ]),
              _: 1
            }),
            createVNode(VCardActions, { class: "d-flex justify-end" }, {
              default: withCtx(() => [
                createVNode(VBtn, {
                  variant: "text",
                  onClick: _cache[12] || (_cache[12] = ($event) => $setup.deleteDialog = false)
                }, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString($setup.tm("skills.cancel")), 1)
                  ]),
    ...
    createVNode(VDialog, {
      modelValue: $setup.payloadDialog.show,
      "onUpdate:modelValue": _cache[15] || (_cache[15] = ($event) => $setup.payloadDialog.show = $event),
      "max-width": "820px"
    }, {
      default: withCtx(() => [
        createVNode(VCard, null, {
          default: withCtx(() => [
            createVNode(VCardTitle, null, {
              default: withCtx(() => [
                createTextVNode(toDisplayString($setup.tm("skills.neoPayloadTitle")), 1)
              ]),
              _: 1
            }),
            createVNode(VCardText, null, {
              default: withCtx(() => [
                createBaseVNode("pre", _hoisted_42$1, toDisplayString($setup.payloadDialog.content), 1)
              ]),
              _: 1
            }),
            createVNode(VCardActions, { class: "d-flex justify-end" }, {
              default: withCtx(() => [
                createVNode(VBtn, {
                  variant: "text",
                  onClick: _cache[14] || (_cache[14] = ($event) => $setup.payloadDialog.show = false)
                }, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString($setup.tm("skills.cancel")), 1)
                  ]),
    ...
    createVNode(VSnackbar, {
      ...
      "onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => $setup.snackbar.show = $event),
      timeout: 3500,
      color: $setup.snackbar.color,
      elevation: "24"
    }, {
      default: withCtx(() => [
        createTextVNode(toDisplayString($setup.snackbar.message), 1)
      ]),
      _: 1
    }, 8, ["modelValue", "color"])
  ]);
}
const SkillsSection = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render], ["__scopeId", "data-v-75a1ec37"]]);
function useComponentData() {
  ...
  const fetchCommands = async (errorMessage) => {
    loading.value = true;
    try {
      ...
      toast((err == null ? void 0 : err.message) || errorMessage, "error");
    } finally {
      loading.value = false;
    }
  };
  const fetchTools = async (errorMessage) => {
...
function useCommandFilters(commands) {
  ...
  const matchesFilters = (cmd, query) => {
    var _a, _b, _c;
    if (!effectiveShowSystemPlugins.value && cmd.reserved) {
      return false;
    }
    if (query) {
      const matchesSearch = ((_a = cmd.effective_command) == null ? void 0 : _a.toLowerCase().includes(query)) || ((_b = cmd.description) == null ? void 0 : _b.toLowerCase().includes(query)) || ((_c = cmd.plugin) == null ? void 0 : _c.toLowerCase().includes(query));
...
function useCommandActions(toast, fetchCommands) {
  ...
  const toggleCommand = async (cmd, successMessage, errorMessage) => {
    try {
  ...
  const openDetailsDialog = (cmd) => {
    detailsDialog.command = cmd;
    detailsDialog.show = true;
  };
  const getTypeInfo = (type, translations) => {
    switch (type) {
      case "group":
  ...
  const getPermissionLabel = (permission, translations) => {
    switch (permission) {
      case "admin":
  ...
  const getStatusInfo = (cmd, translations) => {
    if (cmd.has_conflict) {
  ...
  const updatePermission = async (cmd, permission, successMessage, errorMessage) => {
    try {
...
const _hoisted_1$b = { class: "mb-4 d-flex flex-wrap align-center ga-4" };
const _hoisted_2$9 = { style: { "min-width": "200px", "max-width": "350px", "flex": "1", "border": "1px solid #B9B9B9", "border-radius": "16px" } };
const _hoisted_3$8 = { class: "d-flex align-center ga-4" };
const _hoisted_4$8 = { class: "text-body-2" };
const _sfc_main$b = /* @__PURE__ */ defineComponent({
  __name: "CommandFilters",
  props: {
    availablePlugins: {},
    hasSystemPluginConflict: { type: Boolean },
    effectiveShowSystemPlugins: { type: Boolean },
    pluginFilter: {},
    typeFilter: {},
    permissionFilter: {},
    statusFilter: {},
    showSystemPlugins: { type: Boolean },
    searchQuery: {}
  },
  emits: ["update:pluginFilter", "update:typeFilter", "update:permissionFilter", "update:statusFilter", "update:showSystemPlugins", "update:searchQuery"],
  setup(__props, { emit }) {
    const props = __props;
        ...
        createVNode(VRow, {
          ...
          default: withCtx(() => [
            createVNode(VCol, {
              ...
              default: withCtx(() => [
                createVNode(VSelect, {
                  "model-value": _ctx.pluginFilter,
                  "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => emit("update:pluginFilter", $event)),
                  items: pluginItems.value,
                  label: unref(tm)("filters.byPlugin"),
                  density: "compact",
                  variant: "outlined",
                  "hide-details": ""
            ...
            createVNode(VCol, {
              ...
              default: withCtx(() => [
                createVNode(VSelect, {
                  "model-value": _ctx.typeFilter,
                  "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => emit("update:typeFilter", $event)),
                  items: typeItems,
                  label: unref(tm)("filters.byType"),
                  density: "compact",
                  variant: "outlined",
                  "hide-details": ""
            ...
            createVNode(VCol, {
              ...
              default: withCtx(() => [
                createVNode(VSelect, {
                  "model-value": _ctx.permissionFilter,
                  "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => emit("update:permissionFilter", $event)),
                  items: permissionItems,
                  label: unref(tm)("filters.byPermission"),
                  density: "compact",
                  variant: "outlined",
                  "hide-details": ""
                }, null, 8, ["model-value", "label"])
            ...
            createVNode(VCol, {
              ...
              default: withCtx(() => [
                createVNode(VSelect, {
                  "model-value": _ctx.statusFilter,
                  "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => emit("update:statusFilter", $event)),
                  items: statusItems,
                  label: unref(tm)("filters.byStatus"),
                  density: "compact",
                  variant: "outlined",
                  "hide-details": ""
                }, null, 8, ["model-value", "label"])
        ...
        createBaseVNode("div", _hoisted_1$b, [
          createBaseVNode("div", _hoisted_2$9, [
            createVNode(VTextField, {
              ...
              "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => emit("update:searchQuery", unref(normalizeTextInput)($event))),
              density: "compact",
              label: unref(tm)("search.placeholder"),
          ...
          createBaseVNode("div", _hoisted_3$8, [
            renderSlot(_ctx.$slots, "stats", {}, void 0, true),
            ...
            createVNode(VCheckbox, {
              "model-value": _ctx.effectiveShowSystemPlugins,
              "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => emit("update:showSystemPlugins", !!$event)),
              label: unref(tm)("filters.showSystemPlugins"),
              density: "compact",
              "hide-details": "",
              disabled: _ctx.hasSystemPluginConflict,
              class: "system-plugin-checkbox"
            }, {
              label: withCtx(() => [
                createBaseVNode("span", _hoisted_4$8, toDisplayString(unref(tm)("filters.showSystemPlugins")), 1),
                _ctx.hasSystemPluginConflict ? (openBlock(), createBlock(VTooltip, {
                  key: 0,
                  location: "top"
                }, {
                  ...
                  default: withCtx(() => [
                    createTextVNode(" " + toDisplayString(unref(tm)("filters.systemPluginConflictHint")), 1)
                  ]),
                  _: 1
                })) : createCommentVNode("", true)
              ]),
...
const CommandFilters = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-8cffa512"]]);
const _hoisted_1$a = { class: "d-flex align-center py-2" };
const _hoisted_2$8 = {
  key: 1,
  class: "ml-6"
};
const _hoisted_3$7 = { class: "text-subtitle-1 font-weight-medium" };
const _hoisted_4$7 = { class: "text-body-2" };
const _hoisted_5$6 = ["title"];
const _hoisted_6$6 = { class: "d-flex align-center" };
const _hoisted_7$6 = { class: "text-center pa-8" };
const _hoisted_8$6 = { class: "text-h5 mb-2" };
const _hoisted_9$5 = { class: "text-body-1 mb-4" };
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  emits: ["toggle-expand", "toggle-command", "rename", "view-details", "update-permission"],
  setup(__props, { emit }) {
    const props = __props;
    const { tm } = useModuleI18n("features/command");
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(VCard, { class: "rounded-lg overflow-hidden elevation-1" }, {
        default: withCtx(() => [
          createVNode(VDataTable, {
            headers: commandHeaders.value,
            items: _ctx.items,
            ...
            "item.effective_command": withCtx(({ item }) => {
              var _a;
              return [
                createBaseVNode("div", _hoisted_1$a, [
                  item.is_group && ((_a = item.sub_commands) == null ? void 0 : _a.length) > 0 ? (openBlock(), createBlock(VBtn, {
                    key: 0,
                    icon: "",
                    variant: "text",
                    size: "x-small",
                    class: "mr-1",
                    onClick: withModifiers(($event) => emit("toggle-expand", item), ["stop"])
                  }, {
                    default: withCtx(() => [
                      createVNode(VIcon, { size: "18" }, {
                        default: withCtx(() => [
                          createTextVNode(toDisplayString(isGroupExpanded(item) ? "mdi-chevron-down" : "mdi-chevron-right"), 1)
                        ]),
                        _: 2
                      }, 1024)
                    ]),
                    _: 2
                  }, 1032, ["onClick"])) : item.type === "sub_command" ? (openBlock(), createElementBlock("div", _hoisted_2$8)) : createCommentVNode("", true),
                  createBaseVNode("div", null, [
                    createBaseVNode("div", _hoisted_3$7, [
                      createBaseVNode("code", {
                        class: normalizeClass({ "sub-command-code": item.type === "sub_command" })
                      }, toDisplayString(item.effective_command), 3)
                    ])
                  ])
                ])
              ];
                ...
                default: withCtx(() => {
                  ...
                  return [
                    createVNode(VIcon, {
                      ...
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(getTypeInfo(item.type).icon), 1)
                      ]),
                      _: 2
                    }, 1024),
                    createTextVNode(" " + toDisplayString(getTypeInfo(item.type).text) + toDisplayString(item.is_group && ((_a = item.sub_commands) == null ? void 0 : _a.length) > 0 ? `(${item.sub_commands.length})` : ""), 1)
                  ];
                }),
                _: 2
              }, 1032, ["color"])
            ]),
            "item.plugin": withCtx(({ item }) => [
              createBaseVNode("div", _hoisted_4$7, toDisplayString(item.plugin_display_name || item.plugin), 1)
            ]),
            "item.description": withCtx(({ item }) => [
              ...
              }, toDisplayString(item.description || "-"), 9, _hoisted_5$6)
            ]),
            "item.permission": withCtx(({ item }) => [
              createVNode(VMenu, { location: "bottom" }, {
                activator: withCtx(({ props: props2 }) => [
                  createVNode(VChip, mergeProps(props2, {
                    ...
                    default: withCtx(() => [
                      createTextVNode(toDisplayString(getPermissionLabel(item.permission)) + " ", 1),
                      createVNode(VIcon, {
                        end: "",
                        size: "14"
                      }, {
                  ...
                  createVNode(VList, { density: "compact" }, {
                    default: withCtx(() => [
                      createVNode(VListItem, {
                        value: "member",
                        onClick: ($event) => _ctx.$emit("update-permission", item, "member"),
                        active: item.permission !== "admin"
                      }, {
                        default: withCtx(() => [
                          createVNode(VListItemTitle, null, {
                            default: withCtx(() => [
                              createTextVNode(toDisplayString(unref(tm)("permission.everyone")), 1)
                            ]),
                            _: 1
                          })
                        ]),
                      ...
                      createVNode(VListItem, {
                        value: "admin",
                        onClick: ($event) => _ctx.$emit("update-permission", item, "admin"),
                        active: item.permission === "admin"
                      }, {
                        default: withCtx(() => [
                          createVNode(VListItemTitle, null, {
                            default: withCtx(() => [
                              createTextVNode(toDisplayString(unref(tm)("permission.admin")), 1)
                            ]),
                            _: 1
                          })
                        ]),
            ...
            "item.enabled": withCtx(({ item }) => [
              createVNode(VChip, {
                ...
                default: withCtx(() => [
                  createTextVNode(toDisplayString(getStatusInfo(item).text), 1)
                ]),
                _: 2
              }, 1032, ["color", "variant"])
            ]),
            "item.actions": withCtx(({ item }) => [
              createBaseVNode("div", _hoisted_6$6, [
                createVNode(VBtnGroup, {
                  ...
                  default: withCtx(() => [
                    !item.enabled ? (openBlock(), createBlock(VBtn, {
                      key: 0,
                      icon: "",
                      size: "small",
                      color: "success",
                      onClick: ($event) => emit("toggle-command", item)
                    }, {
                      default: withCtx(() => [
                        ...
                        createVNode(VTooltip, {
                          ...
                          default: withCtx(() => [
                            createTextVNode(toDisplayString(unref(tm)("tooltips.enable")), 1)
                          ]),
                          _: 1
                        })
                      ]),
                      ...
                      default: withCtx(() => [
                        ...
                        createVNode(VTooltip, {
                          ...
                          default: withCtx(() => [
                            createTextVNode(toDisplayString(unref(tm)("tooltips.disable")), 1)
                          ]),
                          _: 1
                        })
                      ]),
                    ...
                    createVNode(VBtn, {
                      ...
                      size: "small",
                      color: "warning",
                      onClick: ($event) => emit("rename", item)
                    }, {
                      default: withCtx(() => [
                        createVNode(VIcon, { size: "22" }, {
                          default: withCtx(() => [
                        ...
                        createVNode(VTooltip, {
                          ...
                          default: withCtx(() => [
                            createTextVNode(toDisplayString(unref(tm)("tooltips.rename")), 1)
                          ]),
                          _: 1
                        })
                      ]),
                    ...
                    createVNode(VBtn, {
                      icon: "",
                      size: "small",
                      onClick: ($event) => emit("view-details", item)
                    }, {
                      default: withCtx(() => [
                        createVNode(VIcon, { size: "22" }, {
                          default: withCtx(() => [
                        ...
                        createVNode(VTooltip, {
                          ...
                          default: withCtx(() => [
                            createTextVNode(toDisplayString(unref(tm)("tooltips.viewDetails")), 1)
                          ]),
                          _: 1
                        })
                      ]),
            ...
            "no-data": withCtx(() => [
              createBaseVNode("div", _hoisted_7$6, [
                createVNode(VIcon, {
                  ...
                  default: withCtx(() => [
                    createTextVNode("mdi-console-line")
                  ]),
                  _: 1
                }),
                createBaseVNode("div", _hoisted_8$6, toDisplayString(unref(tm)("empty.noCommands")), 1),
                createBaseVNode("div", _hoisted_9$5, toDisplayString(unref(tm)("empty.noCommandsDesc")), 1)
              ])
            ]),
            _: 1
...
const CommandTable = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-52b2e3cc"]]);
const _hoisted_1$9 = { class: "py-2" };
const _hoisted_2$7 = { class: "d-flex flex-wrap align-center ga-1" };
const _hoisted_3$6 = { class: "tool-name text-body-2 font-weight-medium" };
const _hoisted_4$6 = { class: "tool-config-tooltip" };
const _hoisted_5$5 = { class: "text-body-2 font-weight-medium mb-2" };
...
const _hoisted_9$4 = { class: "text-center pa-8" };
const _hoisted_10$3 = { class: "text-h5 mb-2" };
const _hoisted_11$3 = ["colspan"];
const _hoisted_12$3 = { class: "d-flex align-start ga-4" };
const _hoisted_13$3 = { class: "flex-1" };
const _hoisted_14$2 = { class: "text-subtitle-2 font-weight-medium mb-2" };
const _hoisted_15$2 = {
  key: 0,
  class: "text-caption text-medium-emphasis"
};
const _hoisted_16$2 = { class: "text-left text-caption text-medium-emphasis" };
const _hoisted_17$2 = {
  class: "text-left text-caption text-medium-emphasis",
  style: { "width": "140px" }
};
const _hoisted_18$2 = { class: "text-left text-caption text-medium-emphasis" };
const _hoisted_19$2 = { class: "font-weight-medium text-body-2" };
const _hoisted_20$2 = { class: "text-body-2" };
const _hoisted_21$2 = { class: "text-body-2 text-medium-emphasis" };
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    const parameterEntries = (tool) => {
      var _a;
      return Object.entries(((_a = tool.parameters) == null ? void 0 : _a.properties) || {});
    };
          ...
          createVNode(VDataTable, {
            ...
            "item.name": withCtx(({ item }) => [
              createBaseVNode("div", _hoisted_1$9, [
                createBaseVNode("div", _hoisted_2$7, [
                  createBaseVNode("div", _hoisted_3$6, toDisplayString(item.name), 1),
                  (openBlock(true), createElementBlock(Fragment, null, renderList(enabledConfigTags(item), (tag) => {
                    return openBlock(), createBlock(VTooltip, {
                      ...
                      activator: withCtx(({ props: tooltipProps }) => [
                        createVNode(VChip, mergeProps(tooltipProps, {
                          ...
                          default: withCtx(() => [
                            createTextVNode(toDisplayString(tag.conf_name), 1)
                          ]),
                          _: 2
                        }, 1040)
                      ]),
                      default: withCtx(() => [
                        createBaseVNode("div", _hoisted_4$6, [
                          createBaseVNode("div", _hoisted_5$5, toDisplayString(unref(tmTool)("functionTools.configTags.tooltipTitle", { config: tag.conf_name })), 1),
                          (openBlock(true), createElementBlock(Fragment, null, renderList(tag.matched_conditions, (condition, index) => {
                            return openBlock(), createElementBlock("div", {
                              key: `${tag.conf_id}-${index}-${condition.key}`,
                              class: "text-body-2 text-medium-emphasis mb-1"
                            }, toDisplayString(formatCondition(condition)), 1);
                          }), 128))
                        ])
                      ]),
                      _: 2
            ...
            "item.description": withCtx(({ item }) => [
              createBaseVNode("div", {
                ...
                title: item.description
              }, toDisplayString(item.description || "-"), 9, _hoisted_6$5)
            ]),
            "item.origin": withCtx(({ item }) => [
              createVNode(VChip, {
                size: "x-small",
                variant: "tonal",
                color: "info",
            ...
            "item.origin_name": withCtx(({ item }) => [
              createBaseVNode("div", {
                class: "text-body-2 text-medium-emphasis",
                style: { "max-width": "200px", "overflow": "hidden", "text-overflow": "ellipsis", "white-space": "nowrap" },
                title: item.origin_name
              }, toDisplayString(item.origin_name || "-"), 9, _hoisted_7$5)
            ]),
            "item.actions": withCtx(({ item }) => [
              item.readonly ? (openBlock(), createElementBlock("span", _hoisted_8$5, "-")) : (openBlock(), createBlock(VSwitch, {
                key: 1,
                ...
                "hide-details": "",
                inset: "",
                "onUpdate:modelValue": ($event) => emit("toggle-tool", item)
            ...
            "no-data": withCtx(() => [
              createBaseVNode("div", _hoisted_9$4, [
                createVNode(VIcon, {
                  ...
                  default: withCtx(() => [
                    createTextVNode("mdi-function-variant")
                  ]),
                  _: 1
                }),
                createBaseVNode("div", _hoisted_10$3, toDisplayString(unref(tmTool)("functionTools.empty")), 1)
              ])
            ]),
            "expanded-row": withCtx(({ item }) => [
              createBaseVNode("td", {
                colspan: toolHeaders.value.length + 1,
                class: "pa-4"
              }, [
                createBaseVNode("div", _hoisted_12$3, [
                  ...
                  createBaseVNode("div", _hoisted_13$3, [
                    createBaseVNode("div", _hoisted_14$2, toDisplayString(unref(tmTool)("functionTools.parameters")), 1),
                    parameterEntries(item).length === 0 ? (openBlock(), createElementBlock("div", _hoisted_15$2, toDisplayString(unref(tmTool)("functionTools.noParameters")), 1)) : (openBlock(), createBlock(VTable, {
                      key: 1,
                      density: "compact",
                      class: "param-table"
                    }, {
                      default: withCtx(() => [
                        createBaseVNode("thead", null, [
                          createBaseVNode("tr", null, [
                            createBaseVNode("th", _hoisted_16$2, toDisplayString(unref(tmTool)("functionTools.table.paramName")), 1),
                            createBaseVNode("th", _hoisted_17$2, toDisplayString(unref(tmTool)("functionTools.table.type")), 1),
                            createBaseVNode("th", _hoisted_18$2, toDisplayString(unref(tmTool)("functionTools.table.description")), 1)
                          ])
                        ]),
                        createBaseVNode("tbody", null, [
                          (openBlock(true), createElementBlock(Fragment, null, renderList(parameterEntries(item), ([paramName, param]) => {
                            return openBlock(), createElementBlock("tr", { key: paramName }, [
                              createBaseVNode("td", _hoisted_19$2, toDisplayString(paramName), 1),
                              createBaseVNode("td", _hoisted_20$2, [
                                createVNode(VChip, {
                                  ...
                                  default: withCtx(() => [
                                    createTextVNode(toDisplayString((param == null ? void 0 : param.type) || "-"), 1)
                                  ]),
                                  _: 2
                                }, 1024)
                              ]),
                              createBaseVNode("td", _hoisted_21$2, toDisplayString((param == null ? void 0 : param.description) || "-"), 1)
                            ]);
                          }), 128))
                        ])
                      ]),
...
const ToolTable = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-e97c6376"]]);
const _hoisted_1$8 = { class: "text-subtitle-1" };
const _hoisted_2$6 = {
  key: 0,
  class: "px-4 py-3"
};
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  emits: ["update:show", "update:newName", "update:aliases", "confirm"],
  setup(__props, { emit }) {
    const props = __props;
    const { tm } = useModuleI18n("features/command");
    const addAlias = () => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(VDialog, {
        ...
        "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => emit("update:show", $event)),
        "max-width": "500"
      }, {
        default: withCtx(() => [
          createVNode(VCard, null, {
            default: withCtx(() => [
              createVNode(VCardTitle, { class: "text-h5" }, {
                default: withCtx(() => [
                  createTextVNode(toDisplayString(unref(tm)("dialogs.rename.title")), 1)
                ]),
                _: 1
              }),
              createVNode(VCardText, null, {
                default: withCtx(() => [
                  createVNode(VTextField, {
                    ...
                    "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => emit("update:newName", $event)),
                    label: unref(tm)("dialogs.rename.newName"),
                    variant: "outlined",
                    density: "compact",
                    autofocus: "",
                    class: "mb-2"
                  ...
                  createVNode(VCard, {
                    ...
                    default: withCtx(() => [
                      createBaseVNode("div", {
                        ...
                        role: "button",
                        tabindex: "0",
                        onClick: _cache[1] || (_cache[1] = ($event) => showAliasEditor.value = !showAliasEditor.value),
                        onKeydown: [
                          _cache[2] || (_cache[2] = withKeys(withModifiers(($event) => showAliasEditor.value = !showAliasEditor.value, ["prevent"]), ["enter"])),
                          _cache[3] || (_cache[3] = withKeys(withModifiers(($event) => showAliasEditor.value = !showAliasEditor.value, ["prevent"]), ["space"]))
                        ]
                      }, [
                        createBaseVNode("div", _hoisted_1$8, toDisplayString(unref(tm)("dialogs.rename.aliases")), 1),
                        createVNode(VIcon, { size: "20" }, {
                          default: withCtx(() => [
                            createTextVNode(toDisplayString(showAliasEditor.value ? "mdi-chevron-up" : "mdi-chevron-down"), 1)
                          ]),
                          _: 1
                        })
                      ], 32),
                      showAliasEditor.value ? (openBlock(), createBlock(VDivider, { key: 0 })) : createCommentVNode("", true),
                      createVNode(VSlideYTransition, null, {
                        default: withCtx(() => [
                          aliasEditorEverOpened.value ? withDirectives((openBlock(), createElementBlock("div", _hoisted_2$6, [
                            (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.aliases, (alias, index) => {
                              return openBlock(), createElementBlock("div", {
                                key: index,
                                ...
                                createVNode(VTextField, {
                                  "model-value": alias,
                                  "onUpdate:modelValue": ($event) => updateAlias(index, $event),
                                  variant: "outlined",
                                  density: "compact",
                                  "hide-details": "",
                                ...
                                createVNode(VBtn, {
                                  ...
                                  color: "error",
                                  density: "compact",
                                  onClick: ($event) => removeAlias(index)
                                }, null, 8, ["onClick"])
                              ]);
                            }), 128)),
                            createVNode(VBtn, {
                              ...
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(unref(tm)("dialogs.rename.addAlias")), 1)
                              ]),
                              _: 1
                            })
                          ], 512)), [
                            [vShow, showAliasEditor.value]
                          ]) : createCommentVNode("", true)
                        ]),
                        _: 1
                      })
              ...
              createVNode(VCardActions, null, {
                default: withCtx(() => [
                  ...
                  createVNode(VBtn, {
                    ...
                    default: withCtx(() => [
                      createTextVNode(toDisplayString(unref(tm)("dialogs.rename.cancel")), 1)
                    ]),
                    _: 1
                  }),
                  createVNode(VBtn, {
                    ...
                    onClick: _cache[5] || (_cache[5] = ($event) => emit("confirm"))
                  }, {
                    default: withCtx(() => [
                      createTextVNode(toDisplayString(unref(tm)("dialogs.rename.confirm")), 1)
                    ]),
                    _: 1
                  }, 8, ["loading"])
                ]),
...
const _hoisted_1$7 = { class: "d-flex flex-wrap ga-1 mt-1" };
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  __name: "DetailsDialog",
  props: {
    show: { type: Boolean },
    command: {}
  },
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(VDialog, {
        "model-value": _ctx.show,
        "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => emit("update:show", $event)),
        "max-width": "500"
      }, {
        default: withCtx(() => [
          _ctx.command ? (openBlock(), createBlock(VCard, { key: 0 }, {
            default: withCtx(() => [
              createVNode(VCardTitle, { class: "text-h5" }, {
                default: withCtx(() => [
                  createTextVNode(toDisplayString(unref(tm)("dialogs.details.title")), 1)
                ]),
                _: 1
              }),
              createVNode(VCardText, null, {
                      ...
                      return [
                        createVNode(VListItem, null, {
                          default: withCtx(() => [
                            createVNode(VListItemTitle, { class: "font-weight-bold" }, {
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(unref(tm)("dialogs.details.type")), 1)
                              ]),
                              _: 1
                            }),
                            createVNode(VListItemSubtitle, null, {
                              default: withCtx(() => [
                                createVNode(VChip, {
                                  color: getTypeInfo(_ctx.command.type).color,
                                  size: "small",
                                  variant: "tonal"
                                }, {
                                  default: withCtx(() => [
                                    createVNode(VIcon, {
                                      ...
                                      default: withCtx(() => [
                                        createTextVNode(toDisplayString(getTypeInfo(_ctx.command.type).icon), 1)
                                      ]),
                                      _: 1
                                    }),
                                    createTextVNode(" " + toDisplayString(getTypeInfo(_ctx.command.type).text), 1)
                                  ]),
                                  _: 1
                                }, 8, ["color"])
                              ]),
                        ...
                        createVNode(VListItem, null, {
                          default: withCtx(() => [
                            createVNode(VListItemTitle, { class: "font-weight-bold" }, {
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(unref(tm)("dialogs.details.handler")), 1)
                              ]),
                              _: 1
                            }),
                            createVNode(VListItemSubtitle, null, {
                              default: withCtx(() => [
                                createBaseVNode("code", null, toDisplayString(_ctx.command.handler_name), 1)
                              ]),
                              _: 1
                            })
                          ]),
                        ...
                        createVNode(VListItem, null, {
                          default: withCtx(() => [
                            createVNode(VListItemTitle, { class: "font-weight-bold" }, {
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(unref(tm)("dialogs.details.module")), 1)
                              ]),
                              _: 1
                            }),
                            createVNode(VListItemSubtitle, null, {
                              default: withCtx(() => [
                                createBaseVNode("code", null, toDisplayString(_ctx.command.module_path), 1)
                              ]),
                              _: 1
                            })
                          ]),
                        ...
                        createVNode(VListItem, null, {
                          default: withCtx(() => [
                            createVNode(VListItemTitle, { class: "font-weight-bold" }, {
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(unref(tm)("dialogs.details.originalCommand")), 1)
                              ]),
                              _: 1
                            }),
                            createVNode(VListItemSubtitle, null, {
                              default: withCtx(() => [
                                createBaseVNode("code", null, toDisplayString(_ctx.command.original_command), 1)
                              ]),
                              _: 1
                            })
                          ]),
                        ...
                        createVNode(VListItem, null, {
                          default: withCtx(() => [
                            createVNode(VListItemTitle, { class: "font-weight-bold" }, {
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(unref(tm)("dialogs.details.effectiveCommand")), 1)
                              ]),
                              _: 1
                            }),
                            createVNode(VListItemSubtitle, null, {
                              default: withCtx(() => [
                                createBaseVNode("code", null, toDisplayString(_ctx.command.effective_command), 1)
                              ]),
                              _: 1
                            })
                          ]),
                        ...
                        _ctx.command.parent_signature ? (openBlock(), createBlock(VListItem, { key: 0 }, {
                          default: withCtx(() => [
                            createVNode(VListItemTitle, { class: "font-weight-bold" }, {
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(unref(tm)("dialogs.details.parentGroup")), 1)
                              ]),
                              _: 1
                            }),
                            createVNode(VListItemSubtitle, null, {
                              default: withCtx(() => [
                                createBaseVNode("code", null, toDisplayString(_ctx.command.parent_signature), 1)
                              ]),
                              _: 1
                            })
                          ]),
                        ...
                        _ctx.command.aliases.length > 0 ? (openBlock(), createBlock(VListItem, { key: 1 }, {
                          default: withCtx(() => [
                            createVNode(VListItemTitle, { class: "font-weight-bold" }, {
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(unref(tm)("dialogs.details.aliases")), 1)
                              ]),
                              _: 1
                            }),
                            createVNode(VListItemSubtitle, null, {
                              default: withCtx(() => [
                                (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.command.aliases, (alias) => {
                        ...
                        _ctx.command.is_group && ((_a = _ctx.command.sub_commands) == null ? void 0 : _a.length) > 0 ? (openBlock(), createBlock(VListItem, { key: 2 }, {
                          default: withCtx(() => [
                            createVNode(VListItemTitle, { class: "font-weight-bold" }, {
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(unref(tm)("dialogs.details.subCommands")), 1)
                              ]),
                              _: 1
                            }),
                            createVNode(VListItemSubtitle, null, {
                              default: withCtx(() => [
                                createBaseVNode("div", _hoisted_1$7, [
                                  (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.command.sub_commands, (sub) => {
                                    return openBlock(), createBlock(VChip, {
                                      ...
                                      default: withCtx(() => [
                                        createTextVNode(toDisplayString(sub.current_fragment), 1)
                                      ]),
                                      _: 2
                                    }, 1024);
                                  }), 128))
                        ...
                        createVNode(VListItem, null, {
                          default: withCtx(() => [
                            createVNode(VListItemTitle, { class: "font-weight-bold" }, {
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(unref(tm)("dialogs.details.permission")), 1)
                              ]),
                              _: 1
                            }),
                            createVNode(VListItemSubtitle, null, {
                              default: withCtx(() => [
                                createVNode(VChip, {
                                  color: getPermissionColor(_ctx.command.permission),
                                  size: "small"
                                }, {
                                  default: withCtx(() => [
                                    createTextVNode(toDisplayString(getPermissionLabel(_ctx.command.permission)), 1)
                                  ]),
                                  _: 1
                                }, 8, ["color"])
                              ]),
                        ...
                        _ctx.command.has_conflict ? (openBlock(), createBlock(VListItem, { key: 3 }, {
                          default: withCtx(() => [
                            createVNode(VListItemTitle, { class: "font-weight-bold" }, {
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(unref(tm)("dialogs.details.conflictStatus")), 1)
                              ]),
                              _: 1
                            }),
                            createVNode(VListItemSubtitle, null, {
                              default: withCtx(() => [
                                createVNode(VChip, {
                                  ...
                                  default: withCtx(() => [
                                    createTextVNode(toDisplayString(unref(tm)("status.conflict")), 1)
                                  ]),
                                  _: 1
                                })
                              ]),
              ...
              createVNode(VCardActions, null, {
                default: withCtx(() => [
                  ...
                  createVNode(VBtn, {
                    color: "primary",
                    variant: "text",
                    onClick: _cache[0] || (_cache[0] = ($event) => emit("update:show", false))
                  }, {
                    default: withCtx(() => [
                      createTextVNode(toDisplayString(unref(t)("core.actions.close")), 1)
                    ]),
                    _: 1
                  })
                ]),
...
const DetailsDialog = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-34dd8605"]]);
const _hoisted_1$6 = { class: "d-flex justify-space-between align-center mb-6 flex-wrap ga-3" };
const _hoisted_2$5 = { key: 0 };
const _hoisted_3$5 = { class: "d-flex align-center" };
const _hoisted_4$5 = { class: "text-body-2 text-medium-emphasis mr-1" };
const _hoisted_5$4 = { class: "text-body-1 font-weight-bold text-primary" };
const _hoisted_6$4 = { class: "d-flex align-center" };
const _hoisted_7$4 = { class: "text-body-2 text-medium-emphasis mr-1" };
const _hoisted_8$4 = { class: "text-body-1 font-weight-bold text-error" };
const _hoisted_9$3 = { class: "text-body-2 mt-1" };
const _hoisted_10$2 = { class: "text-body-2 mt-2" };
const _hoisted_11$2 = { key: 1 };
const _hoisted_12$2 = { class: "d-flex flex-wrap align-center ga-3 mb-4" };
const _hoisted_13$2 = { style: { "min-width": "240px", "max-width": "380px", "flex": "1" } };
  ...
  setup(__props) {
    ...
    const filteredTools = computed(() => {
      ...
      return tools.value.filter(
        (tool) => {
          var _a, _b;
          return ((_a = tool.name) == null ? void 0 : _a.toLowerCase().includes(query)) || ((_b = tool.description) == null ? void 0 : _b.toLowerCase().includes(query));
        }
      );
    });
    ...
    const handleUpdatePermission = async (cmd, permission) => {
    ...
    const handleToggleTool = async (tool) => {
      ...
      try {
        ...
        tool.active = previous;
        toast(((_b = (_a = error == null ? void 0 : error.response) == null ? void 0 : _a.data) == null ? void 0 : _b.message) || (error == null ? void 0 : error.message) || tmTool("messages.toggleToolError", { error: "" }), "error");
      }
    };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
            ...
            createVNode(VCol, { cols: "12" }, {
              default: withCtx(() => [
                createVNode(VCard, {
                  ...
                  default: withCtx(() => [
                    createVNode(VCardText, { style: { "padding": "20px 12px", "padding-top": "0px" } }, {
                      default: withCtx(() => [
                        createBaseVNode("div", _hoisted_1$6, [
                          createVNode(VBtnToggle, {
                            ...
                            default: withCtx(() => [
                              createVNode(VBtn, { value: "commands" }, {
                                default: withCtx(() => [
                                  createVNode(VIcon, {
                                    size: "18",
                                    class: "mr-1"
                                  ...
                                  createTextVNode(" " + toDisplayString(unref(tm)("type.command")), 1)
                                ]),
                                _: 1
                              }),
                              createVNode(VBtn, { value: "tools" }, {
                                default: withCtx(() => [
                                  createVNode(VIcon, {
                                    size: "18",
                                    class: "mr-1"
                                  ...
                                  createTextVNode(" " + toDisplayString(unref(tmTool)("functionTools.title")), 1)
                                ]),
                                _: 1
                              })
                            ]),
                          ...
                          viewMode.value === "commands" && unref(loading) ? (openBlock(), createBlock(VProgressLinear, {
                            key: 0,
                            indeterminate: "",
                            color: "primary",
                            style: { "max-width": "220px", "flex": "1" }
                          })) : viewMode.value === "tools" && unref(toolsLoading) ? (openBlock(), createBlock(VProgressLinear, {
                            key: 1,
                            indeterminate: "",
                            color: "primary",
                            style: { "max-width": "220px", "flex": "1" }
                        ...
                        viewMode.value === "commands" ? (openBlock(), createElementBlock("div", _hoisted_2$5, [
                          createVNode(CommandFilters, {
                            "plugin-filter": unref(pluginFilter),
                            "onUpdate:pluginFilter": _cache[1] || (_cache[1] = ($event) => pluginFilter.value = $event),
                            "type-filter": unref(typeFilter),
                            "onUpdate:typeFilter": _cache[2] || (_cache[2] = ($event) => typeFilter.value = $event),
                            "permission-filter": unref(permissionFilter),
                            "onUpdate:permissionFilter": _cache[3] || (_cache[3] = ($event) => permissionFilter.value = $event),
                            "status-filter": unref(statusFilter),
                            "onUpdate:statusFilter": _cache[4] || (_cache[4] = ($event) => statusFilter.value = $event),
                            "show-system-plugins": unref(showSystemPlugins),
                            "onUpdate:showSystemPlugins": _cache[5] || (_cache[5] = ($event) => showSystemPlugins.value = $event),
                            "search-query": unref(searchQuery),
                            "onUpdate:searchQuery": _cache[6] || (_cache[6] = ($event) => searchQuery.value = $event),
                            "available-plugins": unref(availablePlugins),
                            "has-system-plugin-conflict": unref(hasSystemPluginConflict),
                            "effective-show-system-plugins": unref(effectiveShowSystemPlugins)
                          }, {
                            stats: withCtx(() => [
                              createBaseVNode("div", _hoisted_3$5, [
                                ...
                                createBaseVNode("span", _hoisted_4$5, toDisplayString(unref(tm)("summary.total")) + ":", 1),
                                createBaseVNode("span", _hoisted_5$4, toDisplayString(unref(filteredCommands).length), 1)
                              ]),
                              createVNode(VDivider, {
                                vertical: "",
                                class: "mx-1",
                              ...
                              createBaseVNode("div", _hoisted_6$4, [
                                ...
                                createBaseVNode("span", _hoisted_7$4, toDisplayString(unref(tm)("summary.disabled")) + ":", 1),
                                createBaseVNode("span", _hoisted_8$4, toDisplayString(unref(summary).disabled), 1)
                              ])
                            ]),
                            _: 1
                          }, 8, ["plugin-filter", "type-filter", "permission-filter", "status-filter", "show-system-plugins", "search-query", "available-plugins", "has-system-plugin-conflict", "effective-show-system-plugins"]),
                          unref(summary).conflicts > 0 ? (openBlock(), createBlock(VAlert, {
                            key: 0,
                            type: "error",
                            variant: "tonal",
                            class: "mb-4",
                            ...
                            default: withCtx(() => [
                              createVNode(VAlertTitle, { class: "text-subtitle-1 font-weight-bold" }, {
                                default: withCtx(() => [
                                  createTextVNode(toDisplayString(unref(tm)("conflictAlert.title")), 1)
                                ]),
                                _: 1
                              }),
                              createBaseVNode("div", _hoisted_9$3, toDisplayString(unref(tm)("conflictAlert.description", { count: unref(summary).conflicts })), 1),
                              createBaseVNode("div", _hoisted_10$2, [
                                ...
                                createTextVNode(" " + toDisplayString(unref(tm)("conflictAlert.hint")), 1)
                              ])
                            ]),
                            _: 1
                          })) : createCommentVNode("", true),
                          createVNode(CommandTable, {
                            items: unref(filteredCommands),
                            "expanded-groups": unref(expandedGroups),
                            loading: unref(loading),
                            onToggleExpand: unref(toggleGroupExpand),
                            onToggleCommand: handleToggleCommand,
                            onRename: unref(openRenameDialog),
                            onViewDetails: unref(openDetailsDialog),
                            onUpdatePermission: handleUpdatePermission
                          }, null, 8, ["items", "expanded-groups", "loading", "onToggleExpand", "onRename", "onViewDetails"])
                        ])) : (openBlock(), createElementBlock("div", _hoisted_11$2, [
                          createBaseVNode("div", _hoisted_12$2, [
                            createBaseVNode("div", _hoisted_13$2, [
                              createVNode(VTextField, {
                                "model-value": toolSearch.value,
                                "onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => toolSearch.value = unref(normalizeTextInput)($event)),
                                "prepend-inner-icon": "mdi-magnify",
                                label: unref(tmTool)("functionTools.search"),
                                variant: "outlined",
                                density: "compact",
                                "hide-details": "",
                                clearable: ""
                          ...
                          createVNode(ToolTable, {
                            items: filteredTools.value,
                            loading: unref(toolsLoading),
        ...
        createVNode(_sfc_main$8, {
          show: unref(renameDialog).show,
          "onUpdate:show": _cache[8] || (_cache[8] = ($event) => unref(renameDialog).show = $event),
          "new-name": unref(renameDialog).newName,
          "onUpdate:newName": _cache[9] || (_cache[9] = ($event) => unref(renameDialog).newName = $event),
          aliases: unref(renameDialog).aliases,
          "onUpdate:aliases": _cache[10] || (_cache[10] = ($event) => unref(renameDialog).aliases = $event),
          command: unref(renameDialog).command,
          loading: unref(renameDialog).loading,
          onConfirm: handleConfirmRename
        }, null, 8, ["show", "new-name", "aliases", "command", "loading"]),
        createVNode(DetailsDialog, {
          show: unref(detailsDialog).show,
          "onUpdate:show": _cache[11] || (_cache[11] = ($event) => unref(detailsDialog).show = $event),
          command: unref(detailsDialog).command
        }, null, 8, ["show", "command"]),
        createVNode(VSnackbar, {
          timeout: 2e3,
          elevation: "24",
          ...
          "onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => unref(snackbar).show = $event)
        }, {
          default: withCtx(() => [
            createTextVNode(toDisplayString(unref(snackbar).message), 1)
          ]),
          _: 1
        }, 8, ["color", "modelValue"])
      ], 64);
...
const _hoisted_1$5 = { class: "plugin-sort-control" };
const _sfc_main$5 = {
  __name: "PluginSortControl",
  props: {
    modelValue: {
      type: String,
      required: true
  ...
  emits: ["update:modelValue", "update:order"],
  setup(__props, { emit }) {
    const props = __props;
        ...
        createVNode(VSelect, {
          ...
          "prepend-inner": withCtx(() => [
            createVNode(VIcon, { size: "small" }, {
              default: withCtx(() => [
                createTextVNode("mdi-sort")
              ]),
              _: 1
            })
          ]),
          _: 1
        }, 8, ["model-value", "items", "label"]),
        __props.showOrder ? (openBlock(), createBlock(VBtn, {
          key: 0,
          icon: "",
          variant: "text",
          density: "compact",
          ...
          default: withCtx(() => [
            createVNode(VIcon, null, {
              default: withCtx(() => [
                createTextVNode(toDisplayString(__props.order === "desc" ? "mdi-arrow-down-thin" : "mdi-arrow-up-thin"), 1)
              ]),
              _: 1
            }),
            createVNode(VTooltip, {
              ...
              default: withCtx(() => [
                createTextVNode(toDisplayString(__props.order === "desc" ? __props.descendingLabel : __props.ascendingLabel), 1)
              ]),
              _: 1
            })
          ]),
...
const PluginSortControl = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-90e0bc8a"]]);
const defaultPluginIcon = "/assets/plugin_icon-xgxlkBou.png";
const _hoisted_1$4 = {
...
const _hoisted_4$4 = { style: { "display": "flex", "align-items": "center", "gap": "8px", "min-width": "0" } };
const _hoisted_5$3 = ["src", "alt"];
const _hoisted_6$3 = { style: { "min-width": "0", "overflow": "hidden" } };
const _hoisted_7$3 = { style: { "font-weight": "600", "font-size": "0.95rem", "white-space": "nowrap", "text-overflow": "ellipsis", "overflow": "hidden" } };
const _hoisted_8$3 = { style: { "font-size": "0.8rem", "color": "var(--v-theme-on-surface)", "opacity": "0.8", "white-space": "nowrap", "text-overflow": "ellipsis", "overflow": "hidden" } };
const _sfc_main$4 = {
  __name: "PinnedPluginItem",
  props: {
    plugin: {
      type: Object,
      required: true
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(["pinned-item pinned-card-wrapper", { "is-dragging": __props.dragged }]),
        style: { "position": "relative" },
        draggable: "true",
        onDragstart: _cache[7] || (_cache[7] = ($event) => _ctx.$emit("dragstart")),
        onDragover: _cache[8] || (_cache[8] = withModifiers(($event) => _ctx.$emit("dragover", $event), ["prevent"])),
        onDragenter: _cache[9] || (_cache[9] = withModifiers(($event) => _ctx.$emit("dragenter", $event), ["prevent"])),
        onDragend: _cache[10] || (_cache[10] = ($event) => _ctx.$emit("dragend", $event)),
        onDrop: _cache[11] || (_cache[11] = ($event) => _ctx.$emit("drop", $event))
      }, [
        createVNode(VMenu, { "offset-y": "" }, {
          activator: withCtx(({ props: menuProps }) => [
            createBaseVNode("div", _hoisted_1$4, [
              createVNode(VAvatar, mergeProps(menuProps, {
                size: "72",
                class: "pinned-avatar activator-avatar mb-1",
                title: __props.plugin.display_name || __props.plugin.name
              }), {
                default: withCtx(() => [
                  createBaseVNode("img", {
                    src: typeof __props.plugin.logo === "string" && __props.plugin.logo.trim() ? __props.plugin.logo : unref(defaultPluginIcon),
                    alt: __props.plugin.name,
                    onError: handlePinnedImgError
                  }, null, 40, _hoisted_2$4)
                ]),
                _: 2
              }, 1040, ["title"]),
              createBaseVNode("span", _hoisted_3$4, toDisplayString(__props.plugin.display_name || __props.plugin.name), 1)
            ])
          ]),
          default: withCtx(() => [
            createVNode(VCard, null, {
              default: withCtx(() => [
                  ...
                  default: withCtx(() => [
                    createBaseVNode("div", _hoisted_4$4, [
                      ...
                      createBaseVNode("div", _hoisted_6$3, [
                        createBaseVNode("div", _hoisted_7$3, toDisplayString(__props.plugin.display_name || __props.plugin.name), 1),
                        createBaseVNode("div", _hoisted_8$3, toDisplayString(authorDisplay.value || (__props.plugin.author || "")), 1)
                      ])
                    ])
                  ]),
                  _: 1
                ...
                createVNode(VCardText, {
                  ...
                  default: withCtx(() => [
                    createVNode(VTooltip, {
                      location: "top",
                      text: __props.tm("buttons.viewDocs")
                    }, {
                      activator: withCtx(({ props: a }) => [
                        createVNode(VBtn, mergeProps(a, {
                          icon: "",
                          size: "small",
                          variant: "tonal",
                          color: "info",
                          onClick: _cache[0] || (_cache[0] = withModifiers(($event) => _ctx.$emit("view-readme", __props.plugin), ["stop"]))
                        }), {
                          default: withCtx(() => [
                            createVNode(VIcon, null, {
                              default: withCtx(() => [
                    ...
                    createVNode(VTooltip, {
                      location: "top",
                      text: __props.tm("card.actions.pluginConfig")
                    }, {
                      activator: withCtx(({ props: a }) => [
                        createVNode(VBtn, mergeProps(a, {
                          icon: "",
                          ...
                          variant: "tonal",
                          color: "primary",
                          onClick: _cache[1] || (_cache[1] = withModifiers(($event) => _ctx.$emit("open-config", __props.plugin.name), ["stop"]))
                        }), {
                          default: withCtx(() => [
                            createVNode(VIcon, null, {
                              default: withCtx(() => [
                    ...
                    createVNode(VTooltip, {
                      location: "top",
                      text: __props.tm("card.actions.reloadPlugin")
                    }, {
                      activator: withCtx(({ props: a }) => [
                        createVNode(VBtn, mergeProps(a, {
                          icon: "",
                          ...
                          variant: "tonal",
                          color: "primary",
                          onClick: _cache[2] || (_cache[2] = withModifiers(($event) => _ctx.$emit("reload", __props.plugin.name), ["stop"]))
                        }), {
                          default: withCtx(() => [
                            createVNode(VIcon, null, {
                              default: withCtx(() => [
                    ...
                    createVNode(VTooltip, {
                      location: "top",
                      text: __props.tm("buttons.update")
                    }, {
                      activator: withCtx(({ props: a }) => [
                        createVNode(VBtn, mergeProps(a, {
                          icon: "",
                          ...
                          variant: "tonal",
                          color: "warning",
                          onClick: _cache[3] || (_cache[3] = withModifiers(($event) => _ctx.$emit("update", __props.plugin.name), ["stop"]))
                        }), {
                          default: withCtx(() => [
                            createVNode(VIcon, null, {
                              default: withCtx(() => [
                    ...
                    createVNode(VTooltip, {
                      location: "top",
                      text: __props.tm("buttons.viewInfo")
                    }, {
                      activator: withCtx(({ props: a }) => [
                        createVNode(VBtn, mergeProps(a, {
                          icon: "",
                          ...
                          variant: "tonal",
                          color: "secondary",
                          onClick: _cache[4] || (_cache[4] = withModifiers(($event) => _ctx.$emit("show-info", __props.plugin), ["stop"]))
                        }), {
                          default: withCtx(() => [
                            createVNode(VIcon, null, {
                              default: withCtx(() => [
                    ...
                    createVNode(VTooltip, {
                      location: "top",
                      text: __props.tm("buttons.uninstall")
                    }, {
                      activator: withCtx(({ props: a }) => [
                        !__props.plugin.reserved ? (openBlock(), createBlock(VBtn, mergeProps({ key: 0 }, a, {
                          icon: "",
                          size: "small",
                          variant: "tonal",
                          color: "error",
                          onClick: _cache[5] || (_cache[5] = withModifiers(($event) => _ctx.$emit("uninstall", __props.plugin.name), ["stop"]))
                        }), {
                          default: withCtx(() => [
                            createVNode(VIcon, null, {
                              default: withCtx(() => [
        ...
        createVNode(VBtn, {
          ...
          color: __props.isPinned ? "primary" : "secondary",
          onClick: _cache[6] || (_cache[6] = withModifiers(($event) => _ctx.$emit("toggle-pin", __props.plugin), ["stop"])),
          title: __props.isPinned ? __props.tm("buttons.unpin") : __props.tm("buttons.pin"),
          style: { "position": "absolute", "top": "6px", "right": "6px", "min-width": "22px", "width": "22px", "height": "22px" }
        }, {
          default: withCtx(() => [
            createVNode(VIcon, { size: "14" }, {
              default: withCtx(() => [
                createTextVNode(toDisplayString(__props.isPinned ? "mdi-pin" : "mdi-pin-outline"), 1)
              ]),
              _: 1
            })
          ]),
...
const PinnedPluginItem = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-6178b982"]]);
function getPlatformIcon(name) {
  if (name === "webchat") {
    return new URL("@/assets/images/platform_logos/webchat.svg", import.meta.url).href;
  }
}
function getPlatformDisplayName(platformId) {
  const displayNameMap = {
    webchat: "WebChat (网页聊天)"
  };
  return displayNameMap[platformId] || platformId;
}
const _hoisted_1$3 = { class: "d-inline-block" };
const _hoisted_2$3 = {
...
const _hoisted_4$3 = { class: "text-caption font-weight-bold" };
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  __name: "PluginPlatformChip",
  props: {
    platforms: {
      type: Array,
      default: () => []
  ...
  setup(__props) {
    ...
    const platformDetails = computed(() => {
      ...
      return props.platforms.filter((item) => typeof item === "string").map((platformId) => ({
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        platformDetails.value.length ? (openBlock(), createBlock(VChip, {
          key: 0,
          color: "info",
          variant: "outlined",
          label: "",
          ...
          style: normalizeStyle({ cursor: "pointer", ...__props.chipStyle }),
          onClick: _cache[1] || (_cache[1] = withModifiers(($event) => showMenu.value = !showMenu.value, ["stop"]))
        }, {
          default: withCtx(() => [
            createBaseVNode("div", _hoisted_2$3, [
              platformDetails.value.some((p) => p.icon) ? (openBlock(), createElementBlock("div", _hoisted_3$3, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(platformDetails.value.slice(0, 5), (platform, index) => {
                  return openBlock(), createBlock(VAvatar, {
                    key: index,
                    size: __props.size === "x-small" ? 12 : 14,
                    class: "platform-mini-icon",
                    style: normalizeStyle({ marginLeft: index > 0 ? "-4px" : "0", zIndex: 10 - index })
                  }, {
                    default: withCtx(() => [
                      platform.icon ? (openBlock(), createBlock(VImg, {
                        key: 0,
                        src: platform.icon
                      }, null, 8, ["src"])) : (openBlock(), createBlock(VIcon, {
                        key: 1,
                        icon: "mdi-circle-small",
                        size: __props.size === "x-small" ? 8 : 10
                      }, null, 8, ["size"]))
                    ]),
                    _: 2
                  }, 1032, ["size", "style"]);
              ...
              createBaseVNode("span", _hoisted_4$3, toDisplayString(unref(tm)("card.status.supportPlatformsCount", {
                count: platformDetails.value.length
              })), 1),
              createVNode(VIcon, {
                icon: showMenu.value ? "mdi-chevron-up" : "mdi-chevron-down",
                size: __props.size === "x-small" ? 14 : 16,
                class: "ml-n1"
              }, null, 8, ["icon", "size"])
            ]),
            createVNode(VMenu, {
              modelValue: showMenu.value,
              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => showMenu.value = $event),
              activator: "parent",
              location: "top",
              ...
              default: withCtx(() => [
                createVNode(VList, {
                  ...
                  default: withCtx(() => [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(platformDetails.value, (platform) => {
                      return openBlock(), createBlock(VListItem, {
                        ...
                        prepend: withCtx(() => [
                          platform.icon ? (openBlock(), createBlock(VAvatar, {
                            key: 0,
                            size: "14",
                            class: "mr-2"
                          }, {
                            ...
                            _: 2
                          }, 1024)) : (openBlock(), createBlock(VIcon, {
                            key: 1,
                            icon: "mdi-platform",
                            size: "12",
                            class: "mr-2"
                        ...
                        default: withCtx(() => [
                          createVNode(VListItemTitle, {
                            ...
                            default: withCtx(() => [
                              createTextVNode(toDisplayString(platform.name), 1)
                            ]),
                            _: 2
                          }, 1024)
                        ]),
          ...
          _: 1
        }, 8, ["size", "style"])) : createCommentVNode("", true)
      ]);
    };
  }
});
const PluginPlatformChip = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-ae8a6845"]]);
const _hoisted_1$2 = { style: { "overflow-x": "auto", "width": "100%" } };
const _hoisted_2$2 = { style: { "width": "100%", "margin-bottom": "24px" } };
const _hoisted_3$2 = { class: "extension-title-row" };
const _hoisted_4$2 = {
  key: 1,
  class: "extension-market-menu-wrap"
};
const _hoisted_5$2 = { class: "extension-content-row mt-2" };
const _hoisted_6$2 = { class: "extension-image-container" };
const _hoisted_7$2 = ["src", "alt"];
const _hoisted_8$2 = { class: "extension-meta-group" };
const _hoisted_9$2 = { class: "extension-chip-group d-flex flex-wrap" };
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    const supportPlatforms = computed(() => {
      var _a;
      const platforms = (_a = props.extension) == null ? void 0 : _a.support_platforms;
    ...
    const astrbotVersionRequirement = computed(() => {
      var _a;
      const versionSpec = (_a = props.extension) == null ? void 0 : _a.astrbot_version;
    ...
    const logoSrc = computed(() => {
      var _a;
      const logo = (_a = props.extension) == null ? void 0 : _a.logo;
    ...
    watch(
      () => {
        var _a;
        return (_a = props.extension) == null ? void 0 : _a.logo;
      },
      () => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createVNode(VCard, mergeProps(unref(attrs), {
          class: "mx-auto d-flex flex-column h-100",
          elevation: "0",
          height: "100%",
          style: {
            position: "relative",
            backgroundColor: unref(useCustomizerStore)().uiTheme === "NormalTheme" ? __props.marketMode ? "#f8f0dd" : "#ffffff" : __props.marketMode ? "#3a3425" : "#282833",
            color: unref(useCustomizerStore)().uiTheme === "NormalTheme" ? "#000000dd" : "#ffffffdd"
          }
        }), {
          default: withCtx(() => [
            createVNode(VCardText, { style: { "padding": "16px", "padding-bottom": "0px", "width": "100%" } }, {
              default: withCtx(() => {
                var _a, _b, _c, _d;
                return [
                  createBaseVNode("div", _hoisted_1$2, [
                    createBaseVNode("div", _hoisted_2$2, [
                      createBaseVNode("div", _hoisted_3$2, [
                        createBaseVNode("p", {
                          class: normalizeClass(["text-h3 font-weight-black extension-title", { "text-h4": _ctx.$vuetify.display.xs }])
                        }, [
                          createVNode(VTooltip, {
                            location: "top",
                            text: ((_a = __props.extension.display_name) == null ? void 0 : _a.length) && __props.extension.display_name !== __props.extension.name ? `${__props.extension.display_name} (${__props.extension.name})` : __props.extension.name
                          }, {
                            activator: withCtx(({ props: titleTooltipProps }) => {
                              var _a2;
                              return [
                                createBaseVNode("span", mergeProps(titleTooltipProps, { class: "extension-title__text" }), toDisplayString(((_a2 = __props.extension.display_name) == null ? void 0 : _a2.length) ? __props.extension.display_name : __props.extension.name), 17)
                              ];
                            }),
                            _: 1
                          }, 8, ["text"]),
                          ((_b = __props.extension) == null ? void 0 : _b.has_update) && !__props.marketMode ? (openBlock(), createBlock(VTooltip, {
                            key: 0,
                            location: "top"
                          }, {
                            activator: withCtx(({ props: tooltipProps }) => [
                              createVNode(VIcon, mergeProps(tooltipProps, {
                                ...
                                onClick: withModifiers(updateExtension, ["stop"])
                              }), null, 16, ["onClick"])
                            ]),
                            default: withCtx(() => [
                              createBaseVNode("span", null, toDisplayString(unref(tm)("card.status.hasUpdate")) + ": " + toDisplayString(__props.extension.online_version), 1)
                            ]),
                            _: 1
                          })) : createCommentVNode("", true)
                        ], 2),
                        !__props.marketMode ? (openBlock(), createBlock(VTooltip, {
                          key: 0,
                          location: "left"
                        }, {
                          activator: withCtx(({ props: tooltipProps }) => [
                            createBaseVNode("div", {
                              ...
                              createBaseVNode("div", mergeProps(tooltipProps, { style: { "display": "inline-flex", "align-items": "center" } }), [
                                createVNode(VSwitch, {
                                  "model-value": __props.extension.activated,
                                  color: "success",
                                  density: "compact",
                                  "hide-details": "",
                                  inset: "",
                                  "onUpdate:modelValue": toggleActivation
                                }, null, 8, ["model-value"])
                              ], 16),
                              createVNode(VTooltip, {
                                location: "top",
                                text: __props.pinned ? unref(tm)("buttons.unpin") : unref(tm)("buttons.pin")
                              }, {
                                activator: withCtx(({ props: pinProps }) => [
                                  createVNode(VBtn, mergeProps(pinProps, {
                                    icon: "",
                                    size: "small",
                                    variant: "tonal",
                                    color: __props.pinned ? "primary" : "secondary",
                                    class: "ml-2",
                                    ...
                                    default: withCtx(() => [
                                      createVNode(VIcon, { size: "18" }, {
                                        default: withCtx(() => [
                                          createTextVNode(toDisplayString(__props.pinned ? "mdi-pin" : "mdi-pin-outline"), 1)
                                        ]),
                                        _: 1
                                      })
                                    ]),
                          ...
                          default: withCtx(() => [
                            createBaseVNode("span", null, toDisplayString(__props.extension.activated ? unref(tm)("buttons.disable") : unref(tm)("buttons.enable")), 1)
                          ]),
                          _: 1
                          ...
                          createVNode(VMenu, { "offset-y": "" }, {
                            activator: withCtx(({ props: menuProps }) => {
                              var _a2, _b2;
                              return [
                                ((_a2 = __props.extension) == null ? void 0 : _a2.repo) ? (openBlock(), createBlock(VBtn, {
                                  key: 0,
                                  icon: "",
                                  variant: "text",
                                  "aria-label": "more",
                                  href: (_b2 = __props.extension) == null ? void 0 : _b2.repo,
                                  target: "_blank"
                                }, {
                                  default: withCtx(() => [
                                    createVNode(VIcon, { icon: "mdi-github" })
                                  ]),
                                  _: 1
                            ...
                            default: withCtx(() => [
                              createVNode(VList, null, {
                                default: withCtx(() => {
                                  var _a2, _b2;
                                  return [
                                    createVNode(VListItem, { onClick: viewReadme }, {
                                      default: withCtx(() => [
                                        createVNode(VListItemTitle, null, {
                                          default: withCtx(() => [
                                            createTextVNode(toDisplayString(unref(tm)("buttons.viewDocs")), 1)
                                          ]),
                                          _: 1
                                        })
                                      ]),
                                    ...
                                    __props.marketMode && !((_a2 = __props.extension) == null ? void 0 : _a2.installed) ? (openBlock(), createBlock(VListItem, {
                                      key: 0,
                                      ...
                                      default: withCtx(() => [
                                        createVNode(VListItemTitle, null, {
                                          default: withCtx(() => [
                                            createTextVNode(toDisplayString(unref(tm)("buttons.install")), 1)
                                          ]),
                                          _: 1
                                        })
                                      ]),
                                    ...
                                    __props.marketMode && ((_b2 = __props.extension) == null ? void 0 : _b2.installed) ? (openBlock(), createBlock(VListItem, { key: 1 }, {
                                      default: withCtx(() => [
                                        createVNode(VListItemTitle, { class: "text--disabled" }, {
                                          default: withCtx(() => [
                                            createTextVNode(toDisplayString(unref(tm)("status.installed")), 1)
                                          ]),
                                          _: 1
                                        })
                                      ]),
                      ...
                      createBaseVNode("div", _hoisted_5$2, [
                        createBaseVNode("div", _hoisted_6$2, [
                          createBaseVNode("img", {
                            src: logoSrc.value,
                            alt: __props.extension.name,
                            class: "extension-logo",
                            onError: _cache[1] || (_cache[1] = ($event) => logoLoadFailed.value = true)
                          ...
                          createBaseVNode("div", _hoisted_9$2, [
                            createVNode(VChip, {
                              ...
                              default: withCtx(() => [
                                ...
                                createTextVNode(" " + toDisplayString(__props.extension.version), 1)
                              ]),
                              _: 1
                            }),
                            ((_c = __props.extension) == null ? void 0 : _c.has_update) ? (openBlock(), createBlock(VChip, {
                              key: 0,
                              color: "warning",
                              label: "",
                              size: "small",
                              ...
                              default: withCtx(() => [
                                ...
                                createTextVNode(" " + toDisplayString(__props.extension.online_version), 1)
                              ]),
                              _: 1
                            })) : createCommentVNode("", true),
                            ((_d = __props.extension.handlers) == null ? void 0 : _d.length) ? (openBlock(), createBlock(VChip, {
                              key: 1,
                              color: "primary",
                              label: "",
                              size: "small",
                              onClick: viewHandlers,
                              style: { "cursor": "pointer" }
                            }, {
                              default: withCtx(() => {
                                var _a2;
                                return [
                                  ...
                                  createTextVNode(" " + toDisplayString((_a2 = __props.extension.handlers) == null ? void 0 : _a2.length) + toDisplayString(unref(tm)("card.status.handlersCount")), 1)
                                ];
                              }),
                              _: 1
                            })) : createCommentVNode("", true),
                            (openBlock(true), createElementBlock(Fragment, null, renderList(__props.extension.tags, (tag) => {
                              return openBlock(), createBlock(VChip, {
                                key: tag,
                                ...
                                default: withCtx(() => [
                                  createTextVNode(toDisplayString(tag === "danger" ? unref(tm)("tags.danger") : tag), 1)
                                ]),
                                _: 2
                              }, 1032, ["color"]);
                            }), 128)),
                            createVNode(PluginPlatformChip, { platforms: supportPlatforms.value }, null, 8, ["platforms"]),
                            authorDisplay.value ? (openBlock(), createBlock(VChip, {
                              key: 2,
                              color: "info",
                              label: "",
                              size: "small"
                              ...
                              default: withCtx(() => [
                                ...
                                createTextVNode(" " + toDisplayString(authorDisplay.value), 1)
                              ]),
                              _: 1
                            })) : createCommentVNode("", true),
                            astrbotVersionRequirement.value ? (openBlock(), createBlock(VChip, {
                              key: 3,
                              color: "secondary",
                              variant: "outlined",
                              label: "",
                              ...
                              default: withCtx(() => [
                                createTextVNode(" AstrBot: " + toDisplayString(astrbotVersionRequirement.value), 1)
                              ]),
                              _: 1
                            })) : createCommentVNode("", true)
                          ]),
                          createBaseVNode("div", {
                            class: normalizeClass(["extension-desc", { "text-caption": _ctx.$vuetify.display.xs }])
                          }, toDisplayString(__props.extension.desc), 3)
                        ])
                      ])
                    ])
                  ])
            ...
            createVNode(VCardActions, {
              ...
              default: withCtx(() => {
                var _a;
                return [
                  !__props.marketMode ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                    createVNode(VSpacer),
                    createVNode(VTooltip, {
                      location: "top",
                      text: unref(tm)("buttons.viewDocs")
                    }, {
                      activator: withCtx(({ props: actionProps }) => [
                        createVNode(VBtn, mergeProps(actionProps, {
                    ...
                    createVNode(VTooltip, {
                      location: "top",
                      text: unref(tm)("card.actions.pluginConfig")
                    }, {
                      activator: withCtx(({ props: actionProps }) => [
                        createVNode(VBtn, mergeProps(actionProps, {
                          icon: "mdi-cog",
                    ...
                    ((_a = __props.extension) == null ? void 0 : _a.repo) ? (openBlock(), createBlock(VTooltip, {
                      key: 0,
                      location: "top",
                      text: unref(tm)("buttons.viewRepo")
                    }, {
                      activator: withCtx(({ props: actionProps }) => [
                        createVNode(VBtn, mergeProps(actionProps, {
                          icon: "mdi-github",
                    ...
                    createVNode(VTooltip, {
                      location: "top",
                      text: unref(tm)("card.actions.reloadPlugin")
                    }, {
                      activator: withCtx(({ props: actionProps }) => [
                        createVNode(VBtn, mergeProps(actionProps, {
                          icon: "mdi-refresh",
                      ...
                      default: withCtx(() => [
                        createVNode(VListItem, {
                          ...
                          default: withCtx(() => [
                            createVNode(VListItemTitle, null, {
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(unref(tm)("buttons.viewInfo")), 1)
                              ]),
                              _: 1
                            })
                          ]),
                        ...
                        createVNode(VListItem, {
                          ...
                          default: withCtx(() => [
                            createVNode(VListItemTitle, null, {
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(__props.extension.has_update ? unref(tm)("card.actions.updateTo") + " " + __props.extension.online_version : unref(tm)("card.actions.reinstall")), 1)
                              ]),
                              _: 1
                            })
                          ]),
                        ...
                        createVNode(VListItem, {
                          ...
                          default: withCtx(() => [
                            createVNode(VListItemTitle, { class: "text-error" }, {
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(unref(tm)("card.actions.uninstallPlugin")), 1)
                              ]),
                              _: 1
                            })
                          ]),
        ...
        createVNode(_sfc_main$d, {
          modelValue: showUninstallDialog.value,
          "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => showUninstallDialog.value = $event),
...
const ExtensionCard = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-b0a17252"]]);
const _withScopeId = (n) => (pushScopeId("data-v-6154e10a"), n = n(), popScopeId(), n);
const _hoisted_1$1 = { class: "mb-4 pt-4 pb-4" };
const _hoisted_2$1 = {
  class: "d-flex align-center flex-wrap",
  style: { "gap": "12px" }
};
const _hoisted_3$1 = { class: "text-h2 mb-0" };
const _hoisted_4$1 = {
  class: "d-flex align-center flex-wrap ml-auto",
  style: { "gap": "8px" }
};
const _hoisted_5$1 = { class: "installed-toolbar" };
const _hoisted_6$1 = { class: "installed-toolbar__actions" };
const _hoisted_7$1 = { class: "installed-toolbar__controls" };
const _hoisted_8$1 = { class: "d-flex align-center justify-space-between" };
const _hoisted_9$1 = { class: "text-h6 mb-0" };
const _hoisted_10$1 = { class: "text-body-2 mb-3" };
...
const _hoisted_24$1 = { class: "py-2" };
const _hoisted_25$1 = {
  class: "text-body-2 text-medium-emphasis",
...
const _hoisted_27$1 = { class: "text-caption text-medium-emphasis mr-2" };
const _hoisted_28$1 = {
  key: 1,
  class: "d-flex align-center flex-wrap mt-1"
};
const _hoisted_29$1 = { class: "text-caption text-medium-emphasis mr-2" };
const _hoisted_30$1 = { class: "d-flex align-center" };
const _hoisted_31$1 = { class: "text-body-2" };
const _hoisted_32$1 = ["onClick"];
const _hoisted_33$1 = { class: "text-body-2" };
const _hoisted_34$1 = { class: "table-action-row d-flex align-center flex-nowrap justify-start ga-2 py-1" };
const _hoisted_35$1 = { class: "text-center pa-8" };
const _hoisted_36 = { class: "text-h5 mb-2" };
const _hoisted_37 = { class: "text-body-1 mb-4" };
const _hoisted_38 = { key: 1 };
const _hoisted_39 = { class: "text-h5 mb-2" };
const _hoisted_40 = { class: "text-body-1 mb-4" };
const _hoisted_41 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", { class: "v-btn__overlay" }, null, -1));
const _hoisted_42 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", { class: "v-btn__underlay" }, null, -1));
const _hoisted_43 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", {
  class: "v-btn__content",
  "data-no-activator": ""
}, [
  /* @__PURE__ */ createBaseVNode("i", {
    class: "mdi-plus mdi v-icon notranslate v-theme--NormalTheme v-icon--size-default",
    "aria-hidden": "true",
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const {
      ...
      sortOrder,
      randomPluginNames,
      normalizeStr: normalizeStr2,
      toPinyinText: toPinyinText2,
      toInitials: toInitials2,
    ...
    const togglePin = (extension) => {
      const name = extension == null ? void 0 : extension.name;
      if (!name) return;
    ...
    const pinnedPlugins = computed(() => {
      ...
      const installedAll = Array.isArray(extension_data == null ? void 0 : extension_data.data) ? extension_data.data : [];
      const all = Array.isArray(sortedPlugins == null ? void 0 : sortedPlugins.value) ? sortedPlugins.value : [];
      const filtered = Array.isArray(filteredPlugins == null ? void 0 : filteredPlugins.value) ? filteredPlugins.value : [];
      const market = Array.isArray(pluginMarketData == null ? void 0 : pluginMarketData.value) ? pluginMarketData.value : [];
      const findByName = (name) => {
        return installedAll.find((p) => p.name === name) || all.find((p) => p.name === name) || filtered.find((p) => p.name === name) || market.find((p) => p.name === name);
      };
      return pinnedNames.value.map((name) => findByName(name)).filter(Boolean);
    });
    return (_ctx, _cache) => {
      const _component_v_tab_item = resolveComponent("v-tab-item");
      return withDirectives((openBlock(), createBlock(_component_v_tab_item, null, {
        default: withCtx(() => [
          createBaseVNode("div", _hoisted_1$1, [
            createBaseVNode("div", _hoisted_2$1, [
              createBaseVNode("h2", _hoisted_3$1, toDisplayString(unref(tm)("titles.installedAstrBotPlugins")), 1),
              createBaseVNode("div", _hoisted_4$1, [
                createVNode(VTextField, {
                  "model-value": unref(pluginSearch),
                  "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => pluginSearch.value = unref(normalizeTextInput)($event)),
                  density: "compact",
                  label: unref(tm)("search.placeholder"),
                  "prepend-inner-icon": "mdi-magnify",
                  clearable: "",
                ...
                createVNode(VBtnToggle, {
                  modelValue: unref(isListView),
                  "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => isRef(isListView) ? isListView.value = $event : null),
                  mandatory: "",
                  density: "compact",
                  color: "primary",
                ...
                default: withCtx(() => [
                  createBaseVNode("div", _hoisted_5$1, [
                    createBaseVNode("div", _hoisted_6$1, [
                      createVNode(VBtn, {
                        variant: "tonal",
                        onClick: unref(toggleShowReserved)
                      }, {
                        default: withCtx(() => [
                          createVNode(VIcon, null, {
                            default: withCtx(() => [
                              createTextVNode(toDisplayString(unref(showReserved) ? "mdi-eye-off" : "mdi-eye"), 1)
                            ]),
                            _: 1
                          }),
                          createTextVNode(" " + toDisplayString(unref(showReserved) ? unref(tm)("buttons.hideSystemPlugins") : unref(tm)("buttons.showSystemPlugins")), 1)
                        ]),
                        _: 1
                      }, 8, ["onClick"]),
                      createVNode(VBtn, {
                        color: "warning",
                        variant: "tonal",
                        disabled: unref(updatableExtensions).length === 0,
                        loading: unref(updatingAll),
                        onClick: unref(showUpdateAllConfirm)
                      }, {
                        default: withCtx(() => [
                          createVNode(VIcon, null, {
                            default: withCtx(() => [
                          ...
                          createTextVNode(" " + toDisplayString(unref(tm)("buttons.updateAll")), 1)
                        ]),
                        _: 1
                    ...
                    createBaseVNode("div", _hoisted_7$1, [
                      createVNode(VBtnToggle, {
                        modelValue: unref(installedStatusFilter),
                        "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => isRef(installedStatusFilter) ? installedStatusFilter.value = $event : null),
                        mandatory: "",
                        divided: "",
                        density: "compact",
                        color: "primary",
                        ...
                        default: withCtx(() => [
                          createVNode(VBtn, {
                            ...
                            default: withCtx(() => [
                              createTextVNode(toDisplayString(unref(tm)("filters.all")), 1)
                            ]),
                            _: 1
                          }),
                          createVNode(VBtn, {
                            ...
                            default: withCtx(() => [
                              createTextVNode(toDisplayString(unref(tm)("status.enabled")), 1)
                            ]),
                            _: 1
                          }),
                          createVNode(VBtn, {
                            ...
                            default: withCtx(() => [
                              createTextVNode(toDisplayString(unref(tm)("status.disabled")), 1)
                            ]),
                            _: 1
                          })
                        ]),
                      ...
                      createVNode(PluginSortControl, {
                        modelValue: unref(installedSortBy),
                        "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => isRef(installedSortBy) ? installedSortBy.value = $event : null),
                        items: unref(installedSortItems),
                        label: unref(tm)("sort.by"),
                        order: unref(installedSortOrder),
                        "ascending-label": unref(tm)("sort.ascending"),
                        "descending-label": unref(tm)("sort.descending"),
                        "show-order": unref(installedSortUsesOrder),
                        "onUpdate:order": _cache[4] || (_cache[4] = ($event) => installedSortOrder.value = $event)
                      }, null, 8, ["modelValue", "items", "label", "order", "ascending-label", "descending-label", "show-order"]),
                      createVNode(VSwitch, {
                        modelValue: unref(pinUpdatesOnTop),
                        "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => isRef(pinUpdatesOnTop) ? pinUpdatesOnTop.value = $event : null),
                        label: unref(tm)("sort.pinUpdatesOnTop"),
                        color: "primary",
                        density: "compact",
                        "hide-details": "",
                        class: "ml-4",
          ...
          pinnedPlugins.value.length > 0 ? (openBlock(), createBlock(VRow, {
            key: 0,
            class: "mb-4"
          }, {
            default: withCtx(() => [
              createVNode(VCol, { cols: "12" }, {
                default: withCtx(() => [
                  createVNode(VCard, {
                    class: "rounded-lg overflow-hidden elevation-0",
                    variant: "flat"
                  }, {
                    default: withCtx(() => [
                      createVNode(VCardText, { class: "pa-4" }, {
                        default: withCtx(() => [
                          createBaseVNode("div", _hoisted_8$1, [
                            createBaseVNode("h3", _hoisted_9$1, toDisplayString(unref(tm)("titles.pinnedPlugins")), 1)
                          ]),
                          createVNode(VRow, {
                            class: "mt-3 relative",
                            dense: "",
                            ...
                            default: withCtx(() => [
                              createVNode(TransitionGroup, {
                                ...
                                default: withCtx(() => [
                                  (openBlock(true), createElementBlock(Fragment, null, renderList(pinnedPlugins.value, (p, index) => {
                                    return openBlock(), createBlock(VCol, {
                                      cols: "auto",
                                      key: p.name
                                    }, {
                                      default: withCtx(() => [
                                        createVNode(PinnedPluginItem, {
                                          plugin: p,
                                          "is-pinned": isPinned(p.name),
                                          tm: unref(tm),
                                          dragged: draggedIndex.value === index,
                                          onTogglePin: togglePin,
                                          onViewReadme: unref(viewReadme),
                                          onOpenConfig: unref(openExtensionConfig),
                                          onReload: unref(reloadPlugin),
                                          onUpdate: unref(updateExtension),
                                          onShowInfo: unref(showPluginInfo),
                                          onUninstall: unref(uninstallExtension),
                                          onDragstart: ($event) => onDragStart(index),
                                          onDragover: _cache[6] || (_cache[6] = ($event) => onDragOver($event)),
                                          onDragenter: ($event) => onDragEnter($event, index),
                                          onDragend: _cache[7] || (_cache[7] = ($event) => onDragEnd($event)),
                                          onDrop: _cache[8] || (_cache[8] = ($event) => onDrop($event))
                                        }, null, 8, ["plugin", "is-pinned", "tm", "dragged", "onViewReadme", "onOpenConfig", "onReload", "onUpdate", "onShowInfo", "onUninstall", "onDragstart", "onDragenter"])
                                      ]),
                                      _: 2
                                    }, 1024);
                                  }), 128))
          ...
          unref(failedPluginItems).length > 0 ? (openBlock(), createBlock(VCard, {
            key: 1,
            ...
            default: withCtx(() => [
              createVNode(VCardTitle, { class: "d-flex align-center" }, {
                default: withCtx(() => [
                  ...
                  createTextVNode(" " + toDisplayString(unref(tm)("failedPlugins.title", { count: unref(failedPluginItems).length })), 1)
                ]),
                _: 1
              }),
              createVNode(VCardText, { class: "pt-0" }, {
                default: withCtx(() => [
                  createBaseVNode("div", _hoisted_10$1, toDisplayString(unref(tm)("failedPlugins.hint")), 1),
                  createVNode(VTable, { density: "compact" }, {
                    default: withCtx(() => [
                      createBaseVNode("thead", null, [
                        createBaseVNode("tr", null, [
                          createBaseVNode("th", null, toDisplayString(unref(tm)("failedPlugins.columns.plugin")), 1),
                          createBaseVNode("th", null, toDisplayString(unref(tm)("failedPlugins.columns.error")), 1),
                          createBaseVNode("th", _hoisted_11$1, toDisplayString(unref(tm)("buttons.actions")), 1)
                        ])
                      ]),
                      createBaseVNode("tbody", null, [
                        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(failedPluginItems), (plugin) => {
                          return openBlock(), createElementBlock("tr", {
                            key: plugin.dir_name
                          }, [
                            createBaseVNode("td", null, [
                              createBaseVNode("div", _hoisted_12$1, toDisplayString(plugin.display_name), 1),
                              createBaseVNode("div", _hoisted_13$1, toDisplayString(plugin.dir_name), 1)
                            ]),
                            createBaseVNode("td", _hoisted_14$1, [
                              createBaseVNode("div", _hoisted_15$1, toDisplayString(plugin.error || unref(tm)("status.unknown")), 1)
                            ]),
                            createBaseVNode("td", _hoisted_16$1, [
                              createVNode(VBtn, {
                                ...
                                class: "mr-2",
                                "prepend-icon": "mdi-refresh",
                                onClick: ($event) => unref(reloadFailedPlugin)(plugin.dir_name)
                              }, {
                                default: withCtx(() => [
                                  createTextVNode(toDisplayString(unref(tm)("buttons.reload")), 1)
                                ]),
                                _: 2
                              }, 1032, ["onClick"]),
                              createVNode(VBtn, {
                                ...
                                onClick: ($event) => unref(requestUninstallFailedPlugin)(plugin.dir_name)
                              }, {
                                default: withCtx(() => [
                                  createTextVNode(toDisplayString(unref(tm)("buttons.uninstall")), 1)
                                ]),
                                _: 2
                              }, 1032, ["disabled", "onClick"])
                            ])
          ...
          createVNode(VFadeTransition, { "hide-on-leave": "" }, {
            default: withCtx(() => [
              unref(isListView) ? (openBlock(), createElementBlock("div", _hoisted_17$1, [
                createVNode(VCard, { class: "rounded-lg overflow-hidden elevation-0" }, {
                  default: withCtx(() => [
                    createVNode(VDataTable, {
                      class: "plugin-list-table",
                      headers: unref(pluginHeaders),
                      items: unref(filteredPlugins),
                      loading: unref(loading_),
                      "item-key": "name",
                      hover: ""
                    }, {
                      "item.name": withCtx(({ item }) => [
                        createBaseVNode("div", _hoisted_18$1, [
                          createBaseVNode("div", _hoisted_19$1, [
                            createBaseVNode("img", {
                              src: typeof item.logo === "string" && item.logo.trim() ? item.logo : unref(defaultPluginIcon),
                              alt: item.name,
                              style: { "height": "40px", "width": "40px", "border-radius": "8px", "object-fit": "cover" }
                            }, null, 8, _hoisted_20$1)
                          ]),
                          createBaseVNode("div", null, [
                            createBaseVNode("div", _hoisted_21$1, toDisplayString(item.display_name && item.display_name.length ? item.display_name : item.name), 1),
                            item.display_name && item.display_name.length ? (openBlock(), createElementBlock("div", _hoisted_22$1, toDisplayString(item.name), 1)) : createCommentVNode("", true),
                            item.reserved ? (openBlock(), createElementBlock("div", _hoisted_23$1, [
                              createVNode(VChip, {
                                color: "primary",
                                size: "x-small",
                                class: "font-weight-medium"
                                ...
                                default: withCtx(() => [
                                  createTextVNode(toDisplayString(unref(tm)("status.system")), 1)
                                ]),
                                _: 1
                              })
                            ])) : createCommentVNode("", true)
                      ...
                      "item.desc": withCtx(({ item }) => {
                        var _a;
                        return [
                          createBaseVNode("div", _hoisted_24$1, [
                            createBaseVNode("div", _hoisted_25$1, toDisplayString(item.desc), 1),
                            ((_a = item.support_platforms) == null ? void 0 : _a.length) ? (openBlock(), createElementBlock("div", _hoisted_26$1, [
                              createBaseVNode("span", _hoisted_27$1, toDisplayString(unref(tm)("card.status.supportPlatform")) + ": ", 1),
                              (openBlock(true), createElementBlock(Fragment, null, renderList(item.support_platforms, (platformId) => {
                                return openBlock(), createBlock(VChip, {
                                  key: platformId,
                                  size: "x-small",
                                  color: "info",
                                  ...
                                  default: withCtx(() => [
                                    createTextVNode(toDisplayString(platformId), 1)
                                  ]),
                                  _: 2
                                }, 1024);
                              }), 128))
                            ])) : createCommentVNode("", true),
                            item.astrbot_version ? (openBlock(), createElementBlock("div", _hoisted_28$1, [
                              createBaseVNode("span", _hoisted_29$1, toDisplayString(unref(tm)("card.status.astrbotVersion")) + ": ", 1),
                              createVNode(VChip, {
                                size: "x-small",
                                color: "secondary",
                                variant: "outlined",
                                ...
                                default: withCtx(() => [
                                  createTextVNode(toDisplayString(item.astrbot_version), 1)
                                ]),
                                _: 2
                              }, 1024)
                            ])) : createCommentVNode("", true)
                      ...
                      "item.version": withCtx(({ item }) => [
                        createBaseVNode("div", _hoisted_30$1, [
                          createBaseVNode("span", _hoisted_31$1, toDisplayString(item.version), 1),
                          item.has_update ? (openBlock(), createBlock(VTooltip, {
                            key: 0,
                            location: "top"
                          }, {
                            activator: withCtx(({ props: tooltipProps }) => [
                              createVNode(VIcon, mergeProps(tooltipProps, {
                                ...
                                class: "ml-1",
                                style: { "cursor": "pointer" },
                                onClick: withModifiers(($event) => unref(updateExtension)(item.name), ["stop"])
                              }), {
                                default: withCtx(() => [
                                  createTextVNode("mdi-alert")
                                ]),
                            ...
                            default: withCtx(() => [
                              createBaseVNode("span", null, toDisplayString(unref(tm)("messages.hasUpdate")) + " " + toDisplayString(item.online_version), 1)
                            ]),
                            _: 2
                          ...
                          item.has_update ? (openBlock(), createBlock(VTooltip, {
                            ...
                            activator: withCtx(({ props: tooltipProps }) => [
                              createBaseVNode("span", mergeProps(tooltipProps, {
                                class: "ml-1 text-caption text-warning",
                                style: { "cursor": "pointer" },
                                onClick: withModifiers(($event) => unref(updateExtension)(item.name), ["stop"])
                              }), toDisplayString(item.online_version), 17, _hoisted_32$1)
                            ]),
                            default: withCtx(() => [
                              createBaseVNode("span", null, toDisplayString(unref(tm)("buttons.update")), 1)
                            ]),
                            _: 2
                          }, 1024)) : createCommentVNode("", true)
                        ])
                      ...
                      "item.author": withCtx(({ item }) => [
                        createBaseVNode("div", _hoisted_33$1, toDisplayString(item.author), 1)
                      ]),
                      "item.actions": withCtx(({ item }) => [
                        createBaseVNode("div", _hoisted_34$1, [
                          createVNode(VBtn, {
                            ...
                            onClick: withModifiers(($event) => togglePin(item), ["stop"]),
                            title: isPinned(item.name) ? unref(tm)("buttons.unpin") : unref(tm)("buttons.pin")
                          }, {
                            default: withCtx(() => [
                              createVNode(VIcon, { size: "18" }, {
                                default: withCtx(() => [
                                  createTextVNode(toDisplayString(isPinned(item.name) ? "mdi-pin" : "mdi-pin-outline"), 1)
                                ]),
                                _: 2
                              }, 1024)
                            ]),
                          ...
                          !item.activated ? (openBlock(), createBlock(VBtn, {
                            key: 0,
                            size: "small",
                            variant: "tonal",
                            color: "success",
                            ...
                            onClick: ($event) => unref(pluginOn)(item)
                          }, {
                            default: withCtx(() => [
                              createTextVNode(toDisplayString(unref(tm)("buttons.enable")), 1)
                            ]),
                            _: 2
                          }, 1032, ["onClick"])) : (openBlock(), createBlock(VBtn, {
                            key: 1,
                            ...
                            onClick: ($event) => unref(pluginOff)(item)
                          }, {
                            default: withCtx(() => [
                              createTextVNode(toDisplayString(unref(tm)("buttons.disable")), 1)
                            ]),
                            _: 2
                          }, 1032, ["onClick"])),
                          createVNode(VBtn, {
                            ...
                            class: "table-action-btn",
                            "prepend-icon": "mdi-refresh",
                            onClick: ($event) => unref(reloadPlugin)(item.name)
                          }, {
                            default: withCtx(() => [
                              createTextVNode(toDisplayString(unref(tm)("buttons.reload")), 1)
                            ]),
                          ...
                          createVNode(VBtn, {
                            ...
                            onClick: ($event) => unref(openExtensionConfig)(item.name)
                          }, {
                            default: withCtx(() => [
                              createTextVNode(toDisplayString(unref(tm)("buttons.configure")), 1)
                            ]),
                            _: 2
                          }, 1032, ["onClick"]),
                          createVNode(VBtn, {
                            ...
                            disabled: !item.repo,
                            onClick: ($event) => item.repo && unref(viewReadme)(item)
                          }, {
                            default: withCtx(() => [
                              createTextVNode(toDisplayString(unref(tm)("buttons.viewDocs")), 1)
                            ]),
                          ...
                          createVNode(_sfc_main$e, {
                            ...
                            default: withCtx(() => [
                              createVNode(VListItem, {
                                class: "styled-menu-item",
                                "prepend-icon": "mdi-information",
                                onClick: ($event) => unref(showPluginInfo)(item)
                              }, {
                                default: withCtx(() => [
                                  createVNode(VListItemTitle, null, {
                                    default: withCtx(() => [
                              ...
                              createVNode(VListItem, {
                                class: "styled-menu-item",
                                "prepend-icon": "mdi-update",
                                onClick: ($event) => unref(updateExtension)(item.name)
                              }, {
                                default: withCtx(() => [
                                  createVNode(VListItemTitle, null, {
                                    default: withCtx(() => [
                                      createTextVNode(toDisplayString(unref(tm)("buttons.update")), 1)
                                    ]),
                                    _: 1
                                  })
                                ]),
                              ...
                              createVNode(VListItem, {
                                ...
                                onClick: ($event) => unref(uninstallExtension)(item.name)
                              }, {
                                default: withCtx(() => [
                                  createVNode(VListItemTitle, null, {
                                    default: withCtx(() => [
                      ...
                      "no-data": withCtx(() => [
                        createBaseVNode("div", _hoisted_35$1, [
                          ...
                          createBaseVNode("div", _hoisted_36, toDisplayString(unref(tm)("empty.noPlugins")), 1),
                          createBaseVNode("div", _hoisted_37, toDisplayString(unref(tm)("empty.noPluginsDesc")), 1)
                        ])
                      ]),
                      _: 1
                    }, 8, ["headers", "items", "loading"])
                ...
                unref(filteredPlugins).length === 0 ? (openBlock(), createBlock(VRow, {
                  key: 0,
                  class: "text-center"
                }, {
                  default: withCtx(() => [
                    createVNode(VCol, {
                      ...
                      default: withCtx(() => [
                        ...
                        createBaseVNode("div", _hoisted_39, toDisplayString(unref(tm)("empty.noPlugins")), 1),
                        createBaseVNode("div", _hoisted_40, toDisplayString(unref(tm)("empty.noPluginsDesc")), 1)
                      ]),
                      _: 1
                    })
                  ]),
                ...
                createVNode(VRow, null, {
                  default: withCtx(() => [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(unref(filteredPlugins), (extension) => {
                      return openBlock(), createBlock(VCol, {
                        cols: "12",
                        md: "6",
                        lg: "4",
                        ...
                        default: withCtx(() => [
                          createVNode(ExtensionCard, {
                            extension,
                            pinned: isPinned(extension.name),
                            onTogglePin: () => togglePin(extension),
                            class: "rounded-lg",
                            style: { "background-color": "rgb(var(--v-theme-mcpCardBg))" },
                            onConfigure: ($event) => unref(openExtensionConfig)(extension.name),
                            onUninstall: _cache[9] || (_cache[9] = (ext, options) => unref(uninstallExtension)(ext.name, options)),
                            onUpdate: ($event) => unref(updateExtension)(extension.name),
                            onReload: ($event) => unref(reloadPlugin)(extension.name),
                            onToggleActivation: ($event) => extension.activated ? unref(pluginOff)(extension) : unref(pluginOn)(extension),
                            onViewHandlers: ($event) => unref(showPluginInfo)(extension),
                            onViewReadme: ($event) => unref(viewReadme)(extension),
                            onViewChangelog: ($event) => unref(viewChangelog)(extension)
                          }, null, 8, ["extension", "pinned", "onTogglePin", "onConfigure", "onUpdate", "onReload", "onToggleActivation", "onViewHandlers", "onViewReadme", "onViewChangelog"])
                        ]),
                        _: 2
                      }, 1024);
                    }), 128))
          ...
          createVNode(VTooltip, {
            text: unref(tm)("market.installPlugin"),
            location: "left"
          }, {
            activator: withCtx(({ props: props2 }) => [
              createBaseVNode("button", mergeProps(props2, {
                type: "button",
                class: "v-btn v-btn--elevated v-btn--icon v-theme--NormalTheme bg-darkprimary v-btn--density-default v-btn--size-x-large v-btn--variant-elevated fab-button",
                style: { "position": "fixed", "right": "52px", "bottom": "52px", "z-index": "10000", "border-radius": "16px" },
                onClick: _cache[10] || (_cache[10] = ($event) => dialog.value = true)
              }), _hoisted_44, 16)
            ]),
            _: 1
          }, 8, ["text"])
        ...
        [vShow, unref(activeTab) === "installed"]
      ]);
    };
  }
};
const InstalledPluginsTab = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-6154e10a"]]);
const INVALID_ERROR_STRINGS = /* @__PURE__ */ new Set(["[object Object]", "undefined", "null", ""]);
...
const resolveErrorMessage = (err, fallbackMessage = "") => {
  ...
  const fromResponse = pickResponseMessage((_a = err == null ? void 0 : err.response) == null ? void 0 : _a.data) || (typeof ((_b = err == null ? void 0 : err.response) == null ? void 0 : _b.statusText) === "string" ? err.response.statusText.trim() : "");
  const fromError = typeof (err == null ? void 0 : err.message) === "string" ? err.message.trim() : "";
  let fromString = "";
  if (typeof (err == null ? void 0 : err.toString) === "function") {
...
const HAN_IDEOGRAPH_RE = new RegExp("\\p{Unified_Ideograph}", "u");
const normalizeStr = (s) => (s ?? "").toString().toLowerCase().trim();
const normalizeLooseFromNormalized = (normalized) => normalized.replace(/[\s_-]+/g, "").replace(/[()（）【】\[\]{}·•]+/g, "");
...
const getLooseText = memoizeStringFn(
  (text) => normalizeLooseFromNormalized(getNormalizedText(text))
);
const toPinyinText = memoizeStringFn(
  (text) => pinyin(text, { toneType: "none" }).toLowerCase().replace(/\s+/g, "")
);
const toInitials = memoizeStringFn(
  (text) => pinyin(text, { pattern: "first", toneType: "none" }).toLowerCase().replace(/\s+/g, "")
);
...
const matchesText = (value, query) => {
  if (value == null || !(query == null ? void 0 : query.norm)) return false;
  ...
  if (query.loose && (looseValue == null ? void 0 : looseValue.includes(query.loose))) return true;
...
const getPluginSearchFields = (plugin) => {
  const supportPlatforms = Array.isArray(plugin == null ? void 0 : plugin.support_platforms) ? plugin.support_platforms.join(" ") : "";
  const tags = Array.isArray(plugin == null ? void 0 : plugin.tags) ? plugin.tags.join(" ") : "";
  return [
    plugin == null ? void 0 : plugin.name,
    plugin == null ? void 0 : plugin.trimmedName,
    plugin == null ? void 0 : plugin.display_name,
    plugin == null ? void 0 : plugin.desc,
    plugin == null ? void 0 : plugin.author,
    plugin == null ? void 0 : plugin.repo,
    plugin == null ? void 0 : plugin.version,
    plugin == null ? void 0 : plugin.astrbot_version,
    supportPlatforms,
    tags
  ];
};
const matchesPluginSearch = (plugin, query) => {
  ...
  return getPluginSearchFields(plugin).some(
    (candidate) => matchesText(candidate, query)
  );
};
function getValidHashTab(routeHash, validTabs) {
...
function createTabRouteLocation(route, tab, fallbackRouteName = EXTENSION_ROUTE_NAME) {
  const query = (route == null ? void 0 : route.query) ? { ...route.query } : {};
  const params = (route == null ? void 0 : route.params) ? { ...route.params } : void 0;
...
async function replaceTabRoute(router, route, tab, logger = console) {
  var _a;
  try {
    await router.replace(createTabRouteLocation(route, tab));
    return true;
  } catch (error) {
    (_a = logger.warn) == null ? void 0 : _a.call(logger, "Failed to update extension tab route:", error);
    return false;
  }
}
const SHOW_RESERVED_PLUGINS_STORAGE_KEY = "showReservedPlugins";
const PLUGIN_LIST_VIEW_MODE_STORAGE_KEY = "pluginListViewMode";
const PIN_UPDATES_ON_TOP_STORAGE_KEY = "pinUpdatesOnTop";
const getStorageForRead = (storageOverride) => {
  if (typeof window === "undefined") {
    return null;
  }
  try {
    const localStorage2 = window.localStorage ?? null;
    return typeof (localStorage2 == null ? void 0 : localStorage2.getItem) === "function" ? localStorage2 : null;
  } catch {
    return null;
  }
};
const getStorageForWrite = (storageOverride) => {
  ...
  try {
    const localStorage2 = window.localStorage ?? null;
    return typeof (localStorage2 == null ? void 0 : localStorage2.setItem) === "function" ? localStorage2 : null;
  } catch {
    return null;
  }
};
const readBooleanPreference = (key, fallback, storage) => {
  const targetStorage = getStorageForRead();
  if (!targetStorage) {
    return fallback;
  }
  try {
...
const writeBooleanPreference = (key, value, storage) => {
  const targetStorage = getStorageForWrite();
  if (!targetStorage) {
    return;
  }
  try {
...
const useExtensionPage = () => {
  ...
  const checkAndPromptConflicts = async () => {
    ...
    try {
      const res = await axios.get("/api/commands");
      if (res.data.status === "ok") {
        const conflicts = ((_a = res.data.data.summary) == null ? void 0 : _a.conflicts) || 0;
        if (conflicts > 0) {
  ...
  const validTabs = ["installed", "skills", "components"];
  ...
  const marketCategoryMeta = computed(() => {
    ...
    for (const plugin of pluginMarketData.value) {
      const categoryKey = normalizeMarketCategory(plugin == null ? void 0 : plugin.category);
      ...
      categories.set(categoryKey, {
        count: 1,
        rawLabel: String((plugin == null ? void 0 : plugin.category) || "").trim()
      });
    }
    return categories;
  });
  ...
  const filteredExtensions = computed(() => {
    const data = Array.isArray(extension_data == null ? void 0 : extension_data.data) ? extension_data.data : [];
    if (!showReserved.value) {
      return data.filter((ext) => !ext.reserved);
    }
    return data;
  });
  const compareInstalledPluginNames = (left, right) => normalizeStr((left == null ? void 0 : left.name) ?? "").localeCompare(
    normalizeStr((right == null ? void 0 : right.name) ?? ""),
    void 0,
    {
      sensitivity: "base"
    }
  );
  const compareInstalledPluginAuthors = (left, right) => normalizeStr((left == null ? void 0 : left.author) ?? "").localeCompare(
    normalizeStr((right == null ? void 0 : right.author) ?? ""),
    void 0,
    { sensitivity: "base" }
  );
  const getInstalledAtTimestamp = (plugin) => {
    const parsed = Date.parse((plugin == null ? void 0 : plugin.installed_at) ?? "");
  ...
  const compareInstalledUpdatePinning = (left, right) => {
    var _a, _b;
    const leftHasUpdate = ((_a = left.plugin) == null ? void 0 : _a.has_update) ? 1 : 0;
    const rightHasUpdate = ((_b = right.plugin) == null ? void 0 : _b.has_update) ? 1 : 0;
  ...
  const sortInstalledPlugins = (plugins) => {
    return plugins.map((plugin, index) => ({
      ...
      if (installedSortBy.value === "install_time") {
        ...
        const timeDiff = installedSortOrder.value === "desc" ? rightTimestamp - leftTimestamp : leftTimestamp - rightTimestamp;
        return timeDiff !== 0 ? timeDiff : compareInstalledFallback(left, right);
      }
      if (installedSortBy.value === "name") {
        const nameCompare = compareInstalledPluginNames(left.plugin, right.plugin);
        if (nameCompare !== 0) {
          return installedSortOrder.value === "desc" ? -nameCompare : nameCompare;
        }
        return compareInstalledFallback(left, right);
      }
      if (installedSortBy.value === "author") {
        ...
        if (authorCompare !== 0) {
          return installedSortOrder.value === "desc" ? -authorCompare : authorCompare;
        }
        return compareInstalledFallback(left, right);
      }
      if (installedSortBy.value === "update_status") {
        const updateDiff = installedSortOrder.value === "desc" ? compareInstalledUpdatePinning(left, right) : compareInstalledUpdatePinning(right, left);
  ...
  const filteredPlugins = computed(() => {
    ...
    const filtered = query ? plugins.filter((plugin) => matchesPluginSearch(plugin, query)) : plugins;
  ...
  const filteredMarketPlugins = computed(() => {
    ...
    if (!query) {
      ...
      return pluginMarketData.value.filter(
        (plugin) => normalizeMarketCategory(plugin == null ? void 0 : plugin.category) === targetCategory
      );
    }
    return pluginMarketData.value.filter((plugin) => {
      const matchesSearch = matchesPluginSearch(plugin, query);
      const matchesCategory = shouldFilterByCategory ? normalizeMarketCategory(plugin == null ? void 0 : plugin.category) === targetCategory : true;
  ...
  const sortedPlugins = computed(() => {
    ...
    if (sortBy.value === "stars") {
      ...
      const pinned = plugins.filter((plugin) => plugin == null ? void 0 : plugin.pinned);
      const notPinned = plugins.filter((plugin) => !(plugin == null ? void 0 : plugin.pinned));
  ...
  const refreshRandomPlugins = () => {
    ...
    randomPluginNames.value = shuffled.slice(0, Math.min(RANDOM_PLUGINS_COUNT, shuffled.length)).map((plugin) => plugin.name);
  };
  ...
  const onLoadingDialogResult = (statusCode, result, timeToClose = 2e3) => {
  ...
  const handleReloadAllFailed = async () => {
    ...
    loading_.value = true;
    try {
      const promises = dirNames.map(
        (dir) => axios.post("/api/plugin/reload-failed", { dir_name: dir })
      );
  ...
  const requestUninstall = (target) => {
    if (!(target == null ? void 0 : target.id) || !(target == null ? void 0 : target.kind)) return;
  ...
  const uninstall = async (target, { deleteConfig = false, deleteData = false, skipConfirm = false } = {}) => {
    ...
    const payload = isFailed ? { dir_name: target.id, delete_config: deleteConfig, delete_data: deleteData } : { name: target.id, delete_config: deleteConfig, delete_data: deleteData };
  ...
  const checkUpdate = () => {
    const onlinePluginsMap = /* @__PURE__ */ new Map();
    const onlinePluginsNameMap = /* @__PURE__ */ new Map();
    ...
    data.forEach((extension) => {
      var _a;
      const repoKey = (_a = extension.repo) == null ? void 0 : _a.toLowerCase();
      const onlinePlugin = repoKey ? onlinePluginsMap.get(repoKey) : null;
      const onlinePluginByName = onlinePluginsNameMap.get(extension.name);
      const matchedPlugin = onlinePlugin || onlinePluginByName;
      if (matchedPlugin) {
        extension.online_version = matchedPlugin.version;
        extension.has_update = extension.version !== matchedPlugin.version && matchedPlugin.version !== tm("status.unknown");
      } else {
  ...
  const updateExtension = async (extension_name, forceUpdate = false) => {
    ...
    if (!(ext == null ? void 0 : ext.has_update) && !forceUpdate) {
    ...
    try {
      ...
      setTimeout(async () => {
        var _a, _b;
        toast(tm("messages.refreshing"), "info", 2e3);
        try {
          await getExtensions();
          toast(tm("messages.refreshSuccess"), "success");
          viewChangelog({
            name: extension_name,
            repo: (ext == null ? void 0 : ext.repo) || null
          });
        } catch (error) {
          const errorMsg = ((_b = (_a = error.response) == null ? void 0 : _a.data) == null ? void 0 : _b.message) || error.message || String(error);
  ...
  const updateAllExtensions = async () => {
    ...
    try {
      ...
      if (res.data.status === "error") {
        onLoadingDialogResult(
          2,
          res.data.message || tm("messages.updateAllFailed", {
      ...
      const results = ((_a = res.data.data) == null ? void 0 : _a.results) || [];
      const failures = results.filter((r) => r.status !== "ok");
      try {
        await getExtensions();
      } catch (err) {
        const errorMsg = ((_c = (_b = err.response) == null ? void 0 : _b.data) == null ? void 0 : _c.message) || err.message || String(err);
...
${detail}`, -1);
      ...
      const errorMsg = ((_e = (_d = err.response) == null ? void 0 : _d.data) == null ? void 0 : _e.message) || err.message || String(err);
  ...
  const selectPluginSource = (sourceUrl2) => {
    selectedSource.value = sourceUrl2;
    if (sourceUrl2) {
      localStorage.setItem("selectedPluginSource", sourceUrl2);
    } else {
  ...
  const checkAlreadyInstalled = () => {
    var _a;
    const data = Array.isArray(extension_data == null ? void 0 : extension_data.data) ? extension_data.data : [];
    const installedRepos = new Set(data.map((ext) => {
      var _a2;
      return (_a2 = ext.repo) == null ? void 0 : _a2.toLowerCase();
    }));
    const installedNames = new Set(data.map((ext) => normalizeStr(ext.name).replace(/_/g, "-")));
    const installedByRepo = new Map(
      data.filter((ext) => ext.repo).map((ext) => [ext.repo.toLowerCase(), ext])
    );
    ...
    for (let i = 0; i < pluginMarketData.value.length; i++) {
      ...
      const matchedInstalled = plugin.repo && installedByRepo.get(plugin.repo.toLowerCase()) || installedByName.get(plugin.name);
      if (matchedInstalled) {
        if ((!Array.isArray(plugin.support_platforms) || plugin.support_platforms.length === 0) && Array.isArray(matchedInstalled.support_platforms)) {
      ...
      plugin.installed = installedRepos.has((_a = plugin.repo) == null ? void 0 : _a.toLowerCase()) || installedNames.has(normalizeStr(plugin.name).replace(/_/g, "-"));
    }
    let installed = [];
    let notInstalled = [];
    for (let i = 0; i < pluginMarketData.value.length; i++) {
  ...
  const handleInstallResponse = async (resData, { toastStatus = false } = {}) => {
    var _a;
    if (resData.status === "warning" && ((_a = resData.data) == null ? void 0 : _a.warning_type) === "astrbot_version_incompatible") {
  ...
  const newExtension = async (ignoreVersionCheck = false) => {
    ...
    toast(
      source === "file" ? tm("messages.installing") : tm("messages.installingFromUrl") + " " + extension_url.value,
      "primary"
    );
    try {
  ...
  const getPlatformDisplayList = (platforms) => {
    return normalizePlatformList(platforms).map(
      (platformId) => getPlatformDisplayName(platformId)
    );
  };
  ...
  const checkInstallCompatibility = async () => {
    ...
    if (!(plugin == null ? void 0 : plugin.astrbot_version) || uploadTab.value !== "url") {
      return;
    }
    try {
      ...
      if (res.data.status === "ok") {
        ...
        installCompat.compatible = !!((_a = res.data.data) == null ? void 0 : _a.compatible);
        installCompat.message = ((_b = res.data.data) == null ? void 0 : _b.message) || "";
      }
    } catch (err) {
...
const _hoisted_1 = { class: "mb-4 pt-4 pb-4" };
const _hoisted_2 = {
  class: "d-flex align-center flex-wrap",
  style: { "gap": "12px" }
};
const _hoisted_3 = { class: "text-h2 mb-0" };
const _hoisted_4 = { class: "mb-4 pt-4 pb-4" };
const _hoisted_5 = {
  class: "d-flex align-center flex-wrap",
  style: { "gap": "12px" }
};
const _hoisted_6 = { class: "text-h2 mb-0" };
const _hoisted_7 = { style: { "max-height": "60vh", "overflow-y": "auto", "padding-right": "8px" } };
const _hoisted_8 = { key: 1 };
const _hoisted_9 = {
  key: 1,
  class: "py-8 text-center"
};
const _hoisted_10 = { class: "text-h4 font-weight-bold" };
const _hoisted_11 = { style: { "margin-top": "32px" } };
...
const _hoisted_16 = { class: "ml-2 text-body-1" };
const _hoisted_17 = {
  class: "text-body-2",
...
const _hoisted_20 = { class: "v-card v-card--density-default rounded-lg v-card--variant-elevated" };
const _hoisted_21 = { class: "v-card__loader" };
const _hoisted_22 = { class: "v-card-text" };
const _hoisted_23 = { class: "d-flex flex-column align-center justify-center pa-4" };
const _hoisted_24 = { class: "text-body-2 text-medium-emphasis mt-2" };
const _hoisted_25 = {
  key: 0,
  class: "mt-4 text-center"
};
const _hoisted_26 = { class: "text-caption ml-2" };
const _hoisted_27 = { class: "pa-4" };
const _hoisted_28 = {
  key: 0,
  class: "mb-3"
};
const _hoisted_29 = { class: "v-card-actions" };
const _hoisted_30 = { class: "d-flex align-center justify-space-between mb-2" };
const _hoisted_31 = { class: "text-subtitle-2" };
const _hoisted_32 = { class: "pa-2" };
const _hoisted_33 = { class: "text-caption text-medium-emphasis mt-2" };
const _hoisted_34 = {
  key: 0,
  class: "mt-2"
};
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      const _component_v_tab_item = resolveComponent("v-tab-item");
      return openBlock(), createElementBlock(Fragment, null, [
        createVNode(VRow, { class: "extension-page" }, {
          default: withCtx(() => [
            createVNode(VCol, {
              cols: "12",
              md: "12"
              ...
              default: withCtx(() => [
                createVNode(VCard, {
                  ...
                  default: withCtx(() => [
                    createVNode(VCardText, { style: { "padding": "0px 12px" } }, {
                      default: withCtx(() => [
                        createVNode(InstalledPluginsTab, { state: unref(pageState) }, null, 8, ["state"]),
                        unref(activeTab) === "components" ? (openBlock(), createBlock(_component_v_tab_item, { key: 0 }, {
                          default: withCtx(() => [
                            createBaseVNode("div", _hoisted_1, [
                              createBaseVNode("div", _hoisted_2, [
                                createBaseVNode("h2", _hoisted_3, toDisplayString(unref(tm)("tabs.handlersOperation")), 1)
                              ])
                            ]),
                            createVNode(VCard, {
                              class: "rounded-lg",
                                ...
                                createVNode(VCardText, { class: "pa-0" }, {
                                  default: withCtx(() => [
                                    createVNode(_sfc_main$6, {
                                      active: unref(activeTab) === "components"
                                    }, null, 8, ["active"])
                                  ]),
                                  _: 1
                                })
                        ...
                        unref(activeTab) === "skills" ? (openBlock(), createBlock(_component_v_tab_item, { key: 1 }, {
                          default: withCtx(() => [
                            createBaseVNode("div", _hoisted_4, [
                              createBaseVNode("div", _hoisted_5, [
                                createBaseVNode("h2", _hoisted_6, toDisplayString(unref(tm)("tabs.skills")), 1)
                              ])
                            ]),
                            createVNode(VCard, {
                              class: "rounded-lg",
        ...
        createVNode(VDialog, {
          modelValue: unref(configDialog),
          "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => isRef(configDialog) ? configDialog.value = $event : null),
          "max-width": "900"
        }, {
          default: withCtx(() => [
            createVNode(VCard, null, {
              default: withCtx(() => [
                createVNode(VCardTitle, { class: "text-h2 pa-4 pl-6 pb-0" }, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString(unref(tm)("dialogs.config.title")), 1)
                  ]),
                  _: 1
                }),
                createVNode(VCardText, null, {
                  default: withCtx(() => [
                    createBaseVNode("div", _hoisted_7, [
                      unref(extension_config).metadata ? (openBlock(), createBlock(AstrBotConfig, {
                        key: 0,
                        metadata: unref(extension_config).metadata,
                        iterable: unref(extension_config).config,
                        metadataKey: unref(curr_namespace),
                        pluginName: unref(curr_namespace)
                      }, null, 8, ["metadata", "iterable", "metadataKey", "pluginName"])) : (openBlock(), createElementBlock("p", _hoisted_8, toDisplayString(unref(tm)("dialogs.config.noConfig")), 1))
                    ])
                  ]),
                  _: 1
                }),
                createVNode(VCardActions, null, {
                  default: withCtx(() => [
                    ...
                    createVNode(VBtn, {
                      color: "blue-darken-1",
                      variant: "text",
                      onClick: unref(updateConfig)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(tm)("buttons.saveAndClose")), 1)
                      ]),
                      _: 1
                    }, 8, ["onClick"]),
                    createVNode(VBtn, {
                      color: "blue-darken-1",
                      variant: "text",
                      onClick: _cache[0] || (_cache[0] = ($event) => configDialog.value = false)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(tm)("buttons.close")), 1)
                      ]),
                      _: 1
                    })
                  ]),
        ...
        createVNode(VDialog, {
          modelValue: unref(loadingDialog).show,
          "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => unref(loadingDialog).show = $event),
          width: "700",
          persistent: ""
        }, {
          default: withCtx(() => [
            createVNode(VCard, null, {
              default: withCtx(() => [
                createVNode(VCardTitle, { class: "text-h5" }, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString(unref(loadingDialog).title), 1)
                  ]),
                  _: 1
                }),
                createVNode(VCardText, { style: { "max-height": "calc(100vh - 200px)", "overflow-y": "auto" } }, {
                  default: withCtx(() => [
                    unref(loadingDialog).statusCode === 0 ? (openBlock(), createBlock(VProgressLinear, {
                      key: 0,
                      indeterminate: "",
                      color: "primary",
                      class: "mb-4"
                    })) : createCommentVNode("", true),
                    unref(loadingDialog).statusCode !== 0 ? (openBlock(), createElementBlock("div", _hoisted_9, [
                      createVNode(VIcon, {
                        class: "mb-6",
                        color: unref(loadingDialog).statusCode === 1 ? "success" : "error",
                        icon: unref(loadingDialog).statusCode === 1 ? "mdi-check-circle-outline" : "mdi-alert-circle-outline",
                        size: "128"
                      }, null, 8, ["color", "icon"]),
                      createBaseVNode("div", _hoisted_10, toDisplayString(unref(loadingDialog).result), 1)
                    ])) : createCommentVNode("", true),
                    createBaseVNode("div", _hoisted_11, [
                      createBaseVNode("h3", null, toDisplayString(unref(tm)("dialogs.loading.logs")), 1),
                ...
                createVNode(VCardActions, { class: "pa-4" }, {
                  default: withCtx(() => [
                    ...
                    createVNode(VBtn, {
                      color: "blue-darken-1",
                      variant: "text",
                      onClick: unref(resetLoadingDialog)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(tm)("buttons.close")), 1)
                      ]),
        ...
        createVNode(VDialog, {
          modelValue: unref(showPluginInfoDialog),
          "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => isRef(showPluginInfoDialog) ? showPluginInfoDialog.value = $event : null),
          width: "1200"
        }, {
          default: withCtx(() => [
            createVNode(VCard, null, {
              default: withCtx(() => [
                createVNode(VCardTitle, { class: "text-h5" }, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString(unref(selectedPlugin).name) + " " + toDisplayString(unref(tm)("buttons.viewInfo")), 1)
                  ]),
                  _: 1
                }),
                createVNode(VCardText, null, {
                  default: withCtx(() => [
                    createVNode(VDataTable, {
                      ...
                      headers: unref(plugin_handler_info_headers),
                      items: unref(selectedPlugin).handlers,
                      "item-key": "name"
                    }, {
                      "header.id": withCtx(({ column }) => [
                        createBaseVNode("p", _hoisted_12, toDisplayString(column.title), 1)
                      ]),
                      "item.event_type": withCtx(({ item }) => [
                        createTextVNode(toDisplayString(item.event_type), 1)
                      ]),
                      "item.desc": withCtx(({ item }) => [
                        createTextVNode(toDisplayString(item.desc), 1)
                      ]),
                      "item.type": withCtx(({ item }) => [
                        createVNode(VChip, { color: "success" }, {
                          default: withCtx(() => [
                      ...
                      "item.cmd": withCtx(({ item }) => [
                        createBaseVNode("span", _hoisted_13, toDisplayString(item.cmd), 1)
                      ]),
                      _: 1
                    }, 8, ["headers", "items"])
                  ]),
                ...
                createVNode(VCardActions, null, {
                  default: withCtx(() => [
                    ...
                    createVNode(VBtn, {
                      color: "blue-darken-1",
                      variant: "text",
                      onClick: _cache[3] || (_cache[3] = ($event) => showPluginInfoDialog.value = false)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(tm)("buttons.close")), 1)
                      ]),
        ...
        createVNode(VSnackbar, {
          timeout: 2e3,
          elevation: "24",
          color: unref(snack_success),
          modelValue: unref(snack_show),
          "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => isRef(snack_show) ? snack_show.value = $event : null),
          location: "bottom center"
        }, {
          default: withCtx(() => [
            createTextVNode(toDisplayString(unref(snack_message)), 1)
          ]),
          _: 1
        }, 8, ["color", "modelValue"]),
        createVNode(ReadmeDialog, {
          show: unref(readmeDialog).show,
          "onUpdate:show": _cache[6] || (_cache[6] = ($event) => unref(readmeDialog).show = $event),
          "plugin-name": unref(readmeDialog).pluginName,
          "repo-url": unref(readmeDialog).repoUrl
        }, null, 8, ["show", "plugin-name", "repo-url"]),
        createVNode(ReadmeDialog, {
          show: unref(changelogDialog).show,
          "onUpdate:show": _cache[7] || (_cache[7] = ($event) => unref(changelogDialog).show = $event),
          "plugin-name": unref(changelogDialog).pluginName,
          "repo-url": unref(changelogDialog).repoUrl,
          mode: "changelog"
        }, null, 8, ["show", "plugin-name", "repo-url"]),
        createVNode(_sfc_main$d, {
          modelValue: unref(showUninstallDialog),
          "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => isRef(showUninstallDialog) ? showUninstallDialog.value = $event : null),
          onConfirm: unref(handleUninstallConfirm)
        }, null, 8, ["modelValue", "onConfirm"]),
        createVNode(VDialog, {
          modelValue: unref(updateAllConfirmDialog).show,
          "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => unref(updateAllConfirmDialog).show = $event),
          "max-width": "420"
        }, {
          default: withCtx(() => [
              ...
              default: withCtx(() => [
                createVNode(VCardTitle, { class: "d-flex align-center pa-4" }, {
                  default: withCtx(() => [
                    ...
                    createTextVNode(" " + toDisplayString(unref(tm)("dialogs.updateAllConfirm.title")), 1)
                  ]),
                  _: 1
                }),
                createVNode(VCardText, null, {
                  default: withCtx(() => [
                    createBaseVNode("p", _hoisted_14, toDisplayString(unref(tm)("dialogs.updateAllConfirm.message", { count: unref(updatableExtensions).length })), 1)
                  ]),
                  _: 1
                }),
                createVNode(VCardActions, { class: "pa-4" }, {
                  default: withCtx(() => [
                    ...
                    createVNode(VBtn, {
                      variant: "text",
                      onClick: unref(cancelUpdateAll)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(tm)("buttons.cancel")), 1)
                      ]),
                      _: 1
                    }, 8, ["onClick"]),
                    createVNode(VBtn, {
                      color: "warning",
                      variant: "flat",
                      onClick: unref(confirmUpdateAll)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(tm)("dialogs.updateAllConfirm.confirm")), 1)
                      ]),
                      _: 1
                    }, 8, ["onClick"])
                  ]),
        ...
        createVNode(VDialog, {
          modelValue: unref(conflictDialog).show,
          "onUpdate:modelValue": _cache[11] || (_cache[11] = ($event) => unref(conflictDialog).show = $event),
          "max-width": "420"
        }, {
          default: withCtx(() => [
            createVNode(VCard, { class: "rounded-lg" }, {
              default: withCtx(() => [
                createVNode(VCardTitle, { class: "d-flex align-center pa-4" }, {
                  default: withCtx(() => [
                    ...
                    createTextVNode(" " + toDisplayString(unref(tm)("conflicts.title")), 1)
                  ]),
                  _: 1
                }),
                  ...
                  default: withCtx(() => [
                    createBaseVNode("div", _hoisted_15, [
                      createVNode(VChip, {
                        ...
                        default: withCtx(() => [
                          createTextVNode(toDisplayString(unref(conflictDialog).count), 1)
                        ]),
                        _: 1
                      }),
                      createBaseVNode("span", _hoisted_16, toDisplayString(unref(tm)("conflicts.pairs")), 1)
                    ]),
                    createBaseVNode("p", _hoisted_17, toDisplayString(unref(tm)("conflicts.message")), 1)
                  ]),
                  _: 1
                }),
                createVNode(VCardActions, { class: "pa-4 pt-2" }, {
                  default: withCtx(() => [
                    createVNode(VSpacer),
                    createVNode(VBtn, {
                      variant: "text",
                      onClick: _cache[10] || (_cache[10] = ($event) => unref(conflictDialog).show = false)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(tm)("conflicts.later")), 1)
                      ]),
                      _: 1
                    }),
                    createVNode(VBtn, {
                      color: "warning",
                      variant: "flat",
                      onClick: unref(handleConflictConfirm)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(tm)("conflicts.goToManage")), 1)
                      ]),
                      _: 1
                    }, 8, ["onClick"])
                  ]),
        ...
        createVNode(VDialog, {
          modelValue: unref(dangerConfirmDialog),
          "onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => isRef(dangerConfirmDialog) ? dangerConfirmDialog.value = $event : null),
          width: "500",
          persistent: ""
        }, {
          default: withCtx(() => [
            createVNode(VCard, null, {
              default: withCtx(() => [
                createVNode(VCardTitle, { class: "text-h5 d-flex align-center" }, {
                  default: withCtx(() => [
                    createVNode(VIcon, {
                      color: "warning",
                      class: "mr-2"
                    ...
                    createTextVNode(" " + toDisplayString(unref(tm)("dialogs.danger_warning.title")), 1)
                  ]),
                  _: 1
                }),
                createVNode(VCardText, null, {
                  default: withCtx(() => [
                    createBaseVNode("div", null, toDisplayString(unref(tm)("dialogs.danger_warning.message")), 1)
                  ]),
                  _: 1
                }),
                createVNode(VCardActions, null, {
                  default: withCtx(() => [
                    ...
                    createVNode(VBtn, {
                      color: "grey",
                      onClick: unref(cancelDangerInstall)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(tm)("dialogs.danger_warning.cancel")), 1)
                      ]),
                      _: 1
                    }, 8, ["onClick"]),
                    createVNode(VBtn, {
                      color: "warning",
                      onClick: unref(confirmDangerInstall)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(tm)("dialogs.danger_warning.confirm")), 1)
                      ]),
                      _: 1
                    }, 8, ["onClick"])
                  ]),
        ...
        createVNode(VDialog, {
          modelValue: unref(versionCompatibilityDialog).show,
          "onUpdate:modelValue": _cache[13] || (_cache[13] = ($event) => unref(versionCompatibilityDialog).show = $event),
          width: "520",
          persistent: ""
        }, {
          default: withCtx(() => [
              ...
              default: withCtx(() => [
                createVNode(VCardTitle, { class: "text-h5 d-flex align-center" }, {
                  default: withCtx(() => [
                    ...
                    createTextVNode(" " + toDisplayString(unref(tm)("dialogs.versionCompatibility.title")), 1)
                  ]),
                  _: 1
                }),
                createVNode(VCardText, null, {
                  default: withCtx(() => [
                    createBaseVNode("div", _hoisted_18, toDisplayString(unref(tm)("dialogs.versionCompatibility.message")), 1),
                    createBaseVNode("div", _hoisted_19, toDisplayString(unref(versionCompatibilityDialog).message), 1)
                  ]),
                  _: 1
                }),
                createVNode(VCardActions, null, {
                  default: withCtx(() => [
                    ...
                    createVNode(VBtn, {
                      color: "grey",
                      onClick: unref(cancelInstallOnVersionWarning)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(tm)("dialogs.versionCompatibility.cancel")), 1)
                      ]),
                      _: 1
                    }, 8, ["onClick"]),
                    createVNode(VBtn, {
                      color: "warning",
                      onClick: unref(continueInstallIgnoringVersionWarning)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(tm)("dialogs.versionCompatibility.confirm")), 1)
                      ]),
                      _: 1
                    }, 8, ["onClick"])
                  ]),
        ...
        createVNode(VDialog, {
          ...
          "onUpdate:modelValue": _cache[21] || (_cache[21] = ($event) => isRef(dialog) ? dialog.value = $event : null),
          width: "500"
        }, {
          default: withCtx(() => [
            createBaseVNode("div", _hoisted_20, [
              createBaseVNode("div", _hoisted_21, [
                createVNode(VProgressLinear, {
                  indeterminate: unref(loading_),
                  color: "primary",
                  height: "2",
                  active: unref(loading_)
                }, null, 8, ["indeterminate", "active"])
              ]),
              createVNode(VCardTitle, { class: "text-h3 pa-4 pb-0 pl-6" }, {
                default: withCtx(() => [
                  createTextVNode(toDisplayString(unref(tm)("dialogs.install.title")), 1)
                ]),
                _: 1
              }),
              createBaseVNode("div", _hoisted_22, [
                createVNode(VTabs, {
                  modelValue: unref(uploadTab),
                  "onUpdate:modelValue": _cache[14] || (_cache[14] = ($event) => isRef(uploadTab) ? uploadTab.value = $event : null),
                  color: "primary"
                }, {
                  default: withCtx(() => [
                    createVNode(VTab, { value: "file" }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(tm)("dialogs.install.fromFile")), 1)
                      ]),
                      _: 1
                    }),
                    createVNode(VTab, { value: "url" }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(tm)("dialogs.install.fromUrl")), 1)
                      ]),
                      _: 1
                    })
                  ]),
                ...
                createVNode(VWindow, {
                  modelValue: unref(uploadTab),
                  "onUpdate:modelValue": _cache[19] || (_cache[19] = ($event) => isRef(uploadTab) ? uploadTab.value = $event : null),
                  class: "mt-4"
                }, {
                  default: withCtx(() => [
                      ...
                      default: withCtx(() => [
                        createBaseVNode("div", _hoisted_23, [
                          createVNode(VFileInput, {
                            ref_key: "fileInput",
                            ref: fileInput,
                            modelValue: unref(upload_file),
                            "onUpdate:modelValue": _cache[15] || (_cache[15] = ($event) => isRef(upload_file) ? upload_file.value = $event : null),
                            label: unref(tm)("upload.selectFile"),
                            accept: ".zip",
                            "hide-details": "",
                            "hide-input": "",
                            class: "d-none"
                          ...
                          createVNode(VBtn, {
                            ...
                            default: withCtx(() => [
                              createTextVNode(toDisplayString(unref(tm)("buttons.selectFile")), 1)
                            ]),
                            _: 1
                          }),
                          createBaseVNode("div", _hoisted_24, toDisplayString(unref(tm)("messages.supportedFormats")), 1),
                          unref(upload_file) ? (openBlock(), createElementBlock("div", _hoisted_25, [
                            createVNode(VChip, {
                              color: "primary",
                              size: "large",
                              closable: "",
                              "onClick:close": _cache[17] || (_cache[17] = ($event) => upload_file.value = null)
                            }, {
                              append: withCtx(() => [
                                createBaseVNode("span", _hoisted_26, "(" + toDisplayString((unref(upload_file).size / 1024).toFixed(1)) + "KB)", 1)
                              ]),
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(unref(upload_file).name) + " ", 1)
                              ]),
                              _: 1
                            })
                          ])) : createCommentVNode("", true)
                    ...
                    createVNode(VWindowItem, { value: "url" }, {
                      default: withCtx(() => [
                        createBaseVNode("div", _hoisted_27, [
                          createVNode(VTextField, {
                            modelValue: unref(extension_url),
                            "onUpdate:modelValue": _cache[18] || (_cache[18] = ($event) => isRef(extension_url) ? extension_url.value = $event : null),
                            label: unref(tm)("upload.enterUrl"),
                            variant: "outlined",
                          ...
                          unref(selectedInstallPlugin) ? (openBlock(), createElementBlock("div", _hoisted_28, [
                            unref(selectedInstallPlugin).astrbot_version ? (openBlock(), createBlock(VChip, {
                              key: 0,
                              size: "small",
                              color: "secondary",
                              variant: "outlined",
                              ...
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(unref(tm)("card.status.astrbotVersion")) + ": " + toDisplayString(unref(selectedInstallPlugin).astrbot_version), 1)
                              ]),
                              _: 1
                            })) : createCommentVNode("", true),
                            unref(normalizePlatformList)(unref(selectedInstallPlugin).support_platforms).length ? (openBlock(), createBlock(VChip, {
                              key: 1,
                              size: "small",
                              color: "info",
                              variant: "outlined",
                              ...
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(unref(tm)("card.status.supportPlatform")) + ": " + toDisplayString(unref(getPlatformDisplayList)(unref(selectedInstallPlugin).support_platforms).join(
                                  ", "
                                )), 1)
                              ]),
                              _: 1
                            })) : createCommentVNode("", true),
                            unref(selectedInstallPlugin).astrbot_version && unref(installCompat).checked && !unref(installCompat).compatible ? (openBlock(), createBlock(VAlert, {
                              key: 2,
                              type: "warning",
                              variant: "tonal",
                              density: "comfortable",
                              ...
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(unref(installCompat).message), 1)
                              ]),
                              _: 1
                            })) : createCommentVNode("", true)
                          ])) : createCommentVNode("", true),
              ...
              createBaseVNode("div", _hoisted_29, [
                ...
                createVNode(VBtn, {
                  color: "grey",
                  variant: "text",
                  onClick: _cache[20] || (_cache[20] = ($event) => dialog.value = false)
                }, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString(unref(tm)("buttons.cancel")), 1)
                  ]),
        ...
        createVNode(VDialog, {
          modelValue: unref(showSourceManagerDialog),
          "onUpdate:modelValue": _cache[25] || (_cache[25] = ($event) => isRef(showSourceManagerDialog) ? showSourceManagerDialog.value = $event : null),
          width: "640"
        }, {
          default: withCtx(() => [
            createVNode(VCard, null, {
              default: withCtx(() => [
                createVNode(VCardTitle, { class: "text-h3 pa-4 pl-6" }, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString(unref(tm)("market.sourceManagement")), 1)
                  ]),
                  _: 1
                }),
                createVNode(VCardText, null, {
                  default: withCtx(() => [
                    createVNode(VSelect, {
                      "model-value": unref(selectedSource) || "__default__",
                      "onUpdate:modelValue": _cache[22] || (_cache[22] = ($event) => unref(selectPluginSource)($event === "__default__" ? null : $event)),
                      items: unref(sourceSelectItems),
                      label: unref(tm)("market.currentSource"),
                      variant: "outlined",
                    ...
                    createBaseVNode("div", _hoisted_30, [
                      createBaseVNode("div", _hoisted_31, toDisplayString(unref(tm)("market.availableSources")), 1),
                      createVNode(VBtn, {
                        size: "small",
                        color: "primary",
                        variant: "tonal",
                        "prepend-icon": "mdi-plus",
                        onClick: unref(addCustomSource)
                      }, {
                        default: withCtx(() => [
                          createTextVNode(toDisplayString(unref(tm)("market.addSource")), 1)
                        ]),
                        _: 1
                      }, 8, ["onClick"])
                    ]),
                    createVNode(VList, {
                      ...
                      default: withCtx(() => [
                        createVNode(VListItem, {
                          rounded: "md",
                          color: "primary",
                          active: unref(selectedSource) === null,
                          onClick: _cache[23] || (_cache[23] = ($event) => unref(selectPluginSource)(null))
                        }, {
                          prepend: withCtx(() => [
                            createVNode(VIcon, {
                          ...
                          default: withCtx(() => [
                            createVNode(VListItemTitle, null, {
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(unref(tm)("market.defaultSource")), 1)
                              ]),
                              _: 1
                            })
                          ]),
                        ...
                        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(customSources), (source) => {
                          return openBlock(), createBlock(VListItem, {
                            key: source.url,
                            rounded: "md",
                            color: "primary",
                            active: unref(selectedSource) === source.url,
                            onClick: ($event) => unref(selectPluginSource)(source.url)
                          }, {
                            prepend: withCtx(() => [
                              createVNode(VIcon, {
                            ...
                            append: withCtx(() => [
                              createVNode(VBtn, {
                                ...
                                onClick: withModifiers(($event) => unref(editCustomSource)(source), ["stop"])
                              }, null, 8, ["onClick"]),
                              createVNode(VBtn, {
                                ...
                                variant: "text",
                                color: "error",
                                onClick: withModifiers(($event) => unref(removeCustomSource)(source), ["stop"])
                              }, null, 8, ["onClick"])
                            ]),
                            default: withCtx(() => [
                              createVNode(VListItemTitle, null, {
                              ...
                              createVNode(VListItemSubtitle, { class: "text-caption" }, {
                                default: withCtx(() => [
                                  createTextVNode(toDisplayString(source.url), 1)
                                ]),
                                _: 2
                              }, 1024)
                            ]),
                ...
                createVNode(VCardActions, null, {
                  default: withCtx(() => [
                    ...
                    createVNode(VBtn, {
                      color: "primary",
                      variant: "text",
                      onClick: _cache[24] || (_cache[24] = ($event) => showSourceManagerDialog.value = false)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(tm)("buttons.close")), 1)
                      ]),
        ...
        createVNode(VDialog, {
          modelValue: unref(showSourceDialog),
          "onUpdate:modelValue": _cache[29] || (_cache[29] = ($event) => isRef(showSourceDialog) ? showSourceDialog.value = $event : null),
          width: "500"
        }, {
          default: withCtx(() => [
            createVNode(VCard, null, {
              default: withCtx(() => [
                createVNode(VCardTitle, { class: "text-h5" }, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString(unref(editingSource) ? unref(tm)("market.editSource") : unref(tm)("market.addSource")), 1)
                  ]),
                  _: 1
                }),
                createVNode(VCardText, null, {
                  default: withCtx(() => [
                    createBaseVNode("div", _hoisted_32, [
                      createVNode(VTextField, {
                        modelValue: unref(sourceName),
                        "onUpdate:modelValue": _cache[26] || (_cache[26] = ($event) => isRef(sourceName) ? sourceName.value = $event : null),
                        label: unref(tm)("market.sourceName"),
                        variant: "outlined",
                      ...
                      createVNode(VTextField, {
                        modelValue: unref(sourceUrl),
                        "onUpdate:modelValue": _cache[27] || (_cache[27] = ($event) => isRef(sourceUrl) ? sourceUrl.value = $event : null),
                        label: unref(tm)("market.sourceUrl"),
                        variant: "outlined",
                        "prepend-inner-icon": "mdi-link",
                        "hide-details": "",
                        placeholder: "https://example.com/plugins.json"
                      }, null, 8, ["modelValue", "label"]),
                      createBaseVNode("div", _hoisted_33, toDisplayString(unref(tm)("messages.enterJsonUrl")), 1)
                    ])
                  ]),
                  _: 1
                }),
                createVNode(VCardActions, null, {
                  default: withCtx(() => [
                    ...
                    createVNode(VBtn, {
                      color: "grey",
                      variant: "text",
                      onClick: _cache[28] || (_cache[28] = ($event) => showSourceDialog.value = false)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(tm)("buttons.cancel")), 1)
                      ]),
                    ...
                    createVNode(VBtn, {
                      color: "primary",
                      variant: "text",
                      onClick: unref(saveCustomSource)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(tm)("buttons.save")), 1)
                      ]),
                      _: 1
                    }, 8, ["onClick"])
                  ]),
        ...
        createVNode(VDialog, {
          modelValue: unref(showRemoveSourceDialog),
          "onUpdate:modelValue": _cache[31] || (_cache[31] = ($event) => isRef(showRemoveSourceDialog) ? showRemoveSourceDialog.value = $event : null),
          width: "400"
        }, {
          default: withCtx(() => [
            createVNode(VCard, null, {
              default: withCtx(() => [
                ...
                createVNode(VCardText, null, {
                  default: withCtx(() => [
                    createBaseVNode("div", null, toDisplayString(unref(tm)("market.confirmRemoveSource")), 1),
                    unref(sourceToRemove) ? (openBlock(), createElementBlock("div", _hoisted_34, [
                      createBaseVNode("strong", null, toDisplayString(unref(sourceToRemove).name), 1),
                      createBaseVNode("div", _hoisted_35, toDisplayString(unref(sourceToRemove).url), 1)
                    ])) : createCommentVNode("", true)
                  ]),
                  _: 1
                }),
                createVNode(VCardActions, null, {
                  default: withCtx(() => [
                    ...
                    createVNode(VBtn, {
                      color: "grey",
                      variant: "text",
                      onClick: _cache[30] || (_cache[30] = ($event) => showRemoveSourceDialog.value = false)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(tm)("buttons.cancel")), 1)
                      ]),
                    ...
                    createVNode(VBtn, {
                      color: "error",
                      variant: "text",
                      onClick: unref(confirmRemoveSource)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(tm)("buttons.deleteSource")), 1)
                      ]),
                      _: 1
                    }, 8, ["onClick"])
                  ]),
        ...
        createVNode(VDialog, {
          modelValue: unref(forceUpdateDialog).show,
          "onUpdate:modelValue": _cache[33] || (_cache[33] = ($event) => unref(forceUpdateDialog).show = $event),
          "max-width": "420"
        }, {
          default: withCtx(() => [
            createVNode(VCard, { class: "rounded-lg" }, {
              default: withCtx(() => [
                createVNode(VCardTitle, { class: "text-h6 d-flex align-center" }, {
                  default: withCtx(() => [
                    ...
                    createTextVNode(" " + toDisplayString(unref(tm)("dialogs.forceUpdate.title")), 1)
                  ]),
                  _: 1
                }),
                createVNode(VCardText, null, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString(unref(tm)("dialogs.forceUpdate.message")), 1)
                  ]),
                  _: 1
                }),
                createVNode(VCardActions, null, {
                  default: withCtx(() => [
                    ...
                    createVNode(VBtn, {
                      variant: "text",
                      onClick: _cache[32] || (_cache[32] = ($event) => unref(forceUpdateDialog).show = false)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(tm)("buttons.cancel")), 1)
                      ]),
                    ...
                    createVNode(VBtn, {
                      color: "primary",
                      variant: "flat",
                      onClick: unref(confirmForceUpdate)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(tm)("dialogs.forceUpdate.confirm")), 1)
                      ]),
                      _: 1
                    }, 8, ["onClick"])
                  ]),
...
const ExtensionPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c5b6ef2e"]]);
export {
  ExtensionPage as default
};
