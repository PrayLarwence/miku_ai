import { D as defineComponent, bi as toRef, aH as resolveDynamicComponent, E as h, L as ref, bf as reactive, H as computed, $ as unref, M as onMounted, aA as isRef, J as watch, bj as readonly, bk as watchEffect, N as nextTick, bl as toValue, G as shallowRef, bm as provide, u as useModuleI18n, h as createBlock, w as withCtx, b as createVNode, j as VTextField, a as createBaseVNode, t as toDisplayString, e as VBtn, c as createElementBlock, k as VAlert, d as createTextVNode, i as createCommentVNode, be as useAuthStore, o as openBlock, a5 as useI18n, bn as useLanguageSwitcher, F as Fragment, r as renderList, ag as VListItem, T as normalizeClass, ah as VListItemTitle, a2 as mergeProps, l as VIcon, a7 as VTooltip, _ as _export_sfc, aF as useTheme, s as VCard, aI as useRouter, a6 as VCardTitle, x as VDivider, v as VCardText } from "./index-C6xMvtNz.js";
import { a as md5 } from "./md5-FTU4TkED.js";
import { _ as _sfc_main$3 } from "./StyledMenu.vue_vue_type_style_index_0_lang-_w7LzF51.js";
...
const Form = FormImpl;
const _hoisted_1$2 = { class: "mt-2" };
const _hoisted_2$1 = { style: { "color": "grey" } };
const _hoisted_3$1 = { class: "login-btn-text" };
const _hoisted_4$1 = {
  key: 0,
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function validate2(values, { setErrors }) {
      loading.value = true;
      ...
      return openBlock(), createBlock(unref(Form), {
        ...
        default: withCtx(({ errors, isSubmitting }) => [
          ...
          createVNode(VTextField, {
            ...
            variant: "outlined",
            "hide-details": "auto",
            "append-icon": show1.value ? "mdi-eye" : "mdi-eye-off",
            type: show1.value ? "text" : "password",
            "onClick:append": _cache[2] || (_cache[2] = ($event) => show1.value = !show1.value),
            class: "pwd-input",
            "prepend-inner-icon": "mdi-lock",
            disabled: loading.value
          }, null, 8, ["modelValue", "label", "append-icon", "type", "disabled"]),
          createBaseVNode("div", _hoisted_1$2, [
            createBaseVNode("small", _hoisted_2$1, toDisplayString(unref(t)("defaultHint")), 1)
          ]),
          createVNode(VBtn, {
            color: "secondary",
            ...
            default: withCtx(() => [
              createBaseVNode("span", _hoisted_3$1, toDisplayString(unref(t)("login")), 1)
            ]),
            _: 2
          }, 1032, ["loading", "disabled"]),
          errors.apiError ? (openBlock(), createElementBlock("div", _hoisted_4$1, [
            createVNode(VAlert, {
              color: "error",
              variant: "tonal",
...
const _hoisted_1$1 = { class: "language-flag" };
      ...
      return openBlock(), createBlock(_sfc_main$3, {
        ...
        activator: withCtx(({ props: activatorProps }) => [
          createVNode(VBtn, mergeProps(activatorProps, {
            ...
            color: props.variant === "header" || props.variant === "chatbox" ? "var(--v-theme-surface)" : void 0,
            rounded: props.variant === "header" || props.variant === "chatbox" ? "sm" : void 0,
            icon: "",
            size: "small",
            ...
            default: withCtx(() => [
              createVNode(VIcon, {
                size: "18",
                color: props.variant === "default" ? "rgb(var(--v-theme-primary))" : void 0
              }, {
                default: withCtx(() => [
            ...
            _: 2
          }, 1040, ["variant", "color", "rounded", "class"])
        ]),
        default: withCtx(() => [
          (openBlock(true), createElementBlock(Fragment, null, renderList(languages.value, (lang) => {
            return openBlock(), createBlock(VListItem, {
              ...
              prepend: withCtx(() => [
                createBaseVNode("span", _hoisted_1$1, toDisplayString(lang.flag), 1)
              ]),
              default: withCtx(() => [
...
const LanguageSwitcher = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-44671728"]]);
const _hoisted_1 = { class: "login-page-container" };
const _hoisted_2 = { class: "d-flex justify-space-between align-center w-100" };
const _hoisted_3 = /* @__PURE__ */ createBaseVNode("div", {
  class: "text-h3",
  style: { "font-size": "48px" }
}, "🫧", -1);
const _hoisted_4 = { class: "d-flex align-center gap-1" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function toggleTheme() {
      const themeCycle = {
        "MikuDarkTheme": "MikuLightTheme",
        "MikuLightTheme": "MikuSakuraTheme",
        "MikuSakuraTheme": "MikuCyberTheme",
        "MikuCyberTheme": "MikuDarkTheme"
      };
      const newTheme = themeCycle[customizer.uiTheme] || "MikuLightTheme";
    ...
    function initParticles() {
      ...
      const draw = () => {
        ...
        const isDark = customizer.uiTheme.includes("Dark") || customizer.uiTheme === "MikuCyberTheme";
        const hue = isDark ? 170 : 180;
        for (const p of particles) {
          ...
          ctx.fillStyle = `hsla(${hue}, 60%, ${isDark ? "65%" : "50%"}, ${p.alpha})`;
          ctx.fill();
        }
        for (let i = 0; i < particles.length; i++) {
          for (let j = i + 1; j < particles.length; j++) {
            ...
            if (dist < 120) {
              ...
              ctx.strokeStyle = `hsla(${hue}, 60%, ${isDark ? "65%" : "50%"}, ${0.08 * (1 - dist / 120)})`;
              ctx.lineWidth = 0.5;
              ctx.stroke();
            }
          }
                ...
                createBaseVNode("div", _hoisted_2, [
                  ...
                  createBaseVNode("div", _hoisted_4, [
                    ...
                    createVNode(VDivider, {
                      vertical: "",
                      class: "mx-1",
                      style: { "height": "24px !important", "opacity": "0.9 !important", "align-self": "center !important", "border-color": "rgba(var(--v-theme-primary), 0.45) !important" }
                    }),
                    createVNode(VBtn, {
                      onClick: toggleTheme,
                      ...
                      default: withCtx(() => [
                        createVNode(VIcon, {
                          ...
                          default: withCtx(() => [
                            createTextVNode(toDisplayString(unref(customizer).uiTheme.includes("Dark") ? "mdi-white-balance-sunny" : "mdi-weather-night"), 1)
                          ]),
                          _: 1
                        }, 8, ["color"]),
                        createVNode(VTooltip, {
                          ...
                          default: withCtx(() => [
                            createTextVNode(toDisplayString(unref(customizer).uiTheme.endsWith("Dark") || unref(customizer).uiTheme === "MikuCyberTheme" ? unref(t)("theme.switchToLight") : unref(t)("theme.switchToDark")), 1)
                          ]),
                          _: 1
                        })
                      ]),
