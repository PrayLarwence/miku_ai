...
var _a, _b;
import { a4 as __vitePreload } from "./index-BCHR8lhs.js";
  ...
  loadLanguages(langs) {
    ...
    if (missingLangs.length) {
      const dependents = langsGraphArray.filter(([_, lang]) => {
        ...
        return embedded == null ? void 0 : embedded.some((l) => missingLangs.map(([name]) => name).includes(l));
...
const bundledLanguagesAlias = Object.fromEntries(bundledLanguagesInfo.flatMap((i) => {
  var _a2;
  return ((_a2 = i.aliases) == null ? void 0 : _a2.map((a) => [a, i.import])) || [];
}));
...
async function ensureShikiLanguages(languages = []) {
  ...
  await Promise.all(
    languagesToLoad.map(
      (language) => highlighter.loadLanguage(language).catch((err) => {
...
function renderShikiCode(highlighter, code, language, colorMode = "auto") {
  const normalizedLanguage = normalizeLanguage(language);
  const options = colorMode === "dark" ? { lang: normalizedLanguage, theme: SHIKI_THEMES.dark } : colorMode === "light" ? { lang: normalizedLanguage, theme: SHIKI_THEMES.light } : { lang: normalizedLanguage, themes: SHIKI_THEMES };
  try {
    ...
    const fallbackOptions = colorMode === "dark" ? { lang: "text", theme: SHIKI_THEMES.dark } : colorMode === "light" ? { lang: "text", theme: SHIKI_THEMES.light } : { lang: "text", themes: SHIKI_THEMES };
...
export {
  ...
  isSpecialTheme as C,
  loadWasm as D,
  makeSingletonHighlighter as E,
  normalizeGetter as F,
  normalizeTheme as G,
  resolveColorReplacements as H,
  splitLines as I,
  splitToken as J,
  splitTokens as K,
  stringifyTokenStyle as L,
  toArray as M,
  tokenizeAnsiWithTheme as N,
  tokenizeWithTheme as O,
  tokensToHast as P,
  transformerDecorations as Q,
  warnDeprecated as R,
  ShikiError$2 as S,
  escapeHtml as a,
  addClassToHast as b,
  createHighlighter as c,
  applyColorReplacements as d,
  ensureShikiLanguages as e,
  bundledLanguages as f,
  bundledLanguagesAlias as g,
  bundledLanguagesBase as h,
  bundledLanguagesInfo as i,
  bundledThemes as j,
  bundledThemesInfo as k,
  createBundledHighlighter as l,
  createHighlighterCore as m,
  normalizeShikiLanguage as n,
  createOnigurumaEngine as o,
  createPositionConverter as p,
  createShikiInternal as q,
  renderShikiCode as r,
  createShikiInternalSync as s,
  createSingletonShorthands as t,
  flatTokenVariants as u,
  getSingletonHighlighter as v,
  getTokenStyleObject as w,
  guessEmbeddedLanguages as x,
  hastToHtml as y,
  isNoneTheme as z
};
