import { a5 as useI18n, aO as useRoute, H as computed, C as resolveComponent, o as openBlock, h as createBlock, w as withCtx, c as createElementBlock, F as Fragment, r as renderList, b as createVNode, ag as VListItem, a2 as mergeProps, ah as VListItemTitle, d as createTextVNode, t as toDisplayString, $ as unref, T as normalizeClass, bs as VListGroup, av as createSlots, g as VChip, aB as VListItemSubtitle, i as createCommentVNode, l as VIcon, U as normalizeStyle, L as ref, J as watch, s as VCard, a6 as VCardTitle, a as createBaseVNode, e as VBtn, v as VCardText, f as VSelect, aj as VProgressCircular, k as VAlert, a9 as VCardActions, V as VSpacer, ai as VDialog, B as axios, _ as _export_sfc, G as shallowRef, M as onMounted, I as onUnmounted, af as VList, bt as VNavigationDrawer, D as defineComponent, ap as pushScopeId, aq as popScopeId, aF as useTheme, as as useCommonStore, bm as useLanguageSwitcher, bu as VAppBar, a0 as withModifiers, z as VBtnToggle, x as VDivider, ae as VMenu, aA as isRef, aK as VForm, j as VTextField, bd as useAuthStore, bv as router, ao as VContainer, S as withDirectives, y as VProgressLinear, W as vShow, aP as VDataTable, aG as VCardSubtitle, au as VRadioGroup, at as VRadio, b9 as WaitingForRestart, bw as useRouterLoadingStore, bx as VLocaleProvider, by as VMain, ay as RouterView, ax as VApp } from "./index-IOsZtj6J.js";
import { useCustomizerStore } from "./customizer-tQjiYpHJ.js";
import { b as applySidebarCustomization, a as sidebarItem } from "./sidebarCustomization-p-RqDqrS.js";
import { y as yn, w as wo, L as Lt } from "./useMessages-DOTHT6gG.js";
import { m as md5Exports } from "./md5-CB0McBBn.js";
import { _ as _sfc_main$7 } from "./StyledMenu.vue_vue_type_style_index_0_lang-NB5AjzPV.js";
import AboutPage from "./AboutPage-Cds9fnnl.js";
import { g as getDesktopRuntimeInfo, r as restartAstrBot } from "./restartAstrBot-B3jZYatI.js";
...
const _withScopeId$1 = (n) => (pushScopeId("data-v-de816291"), n = n(), popScopeId(), n);
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const formatTitle = (title) => {
      if (title.includes("Miku AI ") || title.includes("Miku AI")) {
        return title.replace(/(Miku AI)\s+(.+)/, "$1<wbr> $2");
      }
      return title;
    };
    return (_ctx, _cache) => {
...
const Logo = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-de816291"]]);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const themeDotColor = computed(() => {
      const colors = {
        "MikuLightTheme": "#39c5bb",
        "MikuDarkTheme": "#39c5bb",
        "MikuSakuraTheme": "#f06292",
        "MikuCyberTheme": "#00e5ff",
        "NormalTheme": "#607d8b",
        "NormalLightTheme": "#607d8b"
      };
      return colors[customizer.uiTheme] || "#39c5bb";
    });
    const themeLabel = computed(() => {
      ...
      const brightnessLabel = customizer.brightness === "light" ? "☀️" : "🌙";
      return `${brightnessLabel} ${labels[customizer.uiTheme] || customizer.uiTheme}`;
    });
    ...
    function toggleDarkMode() {
      const lightVariants = {
        "NormalTheme": "NormalLightTheme",
        "MikuDarkTheme": "MikuLightTheme"
      };
      const darkVariants = {
        "NormalLightTheme": "NormalTheme",
        "MikuLightTheme": "MikuDarkTheme"
      };
      const current = customizer.uiTheme;
      const newBrightness = customizer.brightness === "dark" ? "light" : "dark";
      customizer.SET_BRIGHTNESS(newBrightness);
      if (newBrightness === "light") {
        const target = lightVariants[current];
        if (target) {
          customizer.SET_UI_THEME(target);
          theme.global.name.value = target;
        }
      } else {
        const target = darkVariants[current];
        if (target) {
          customizer.SET_UI_THEME(target);
          theme.global.name.value = target;
        }
