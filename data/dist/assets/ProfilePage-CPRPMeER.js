...
const _hoisted_7 = { class: "d-flex justify-space-between mb-1" };
const _hoisted_8 = { class: "text-caption font-weight-bold" };
const _hoisted_9 = {
  class: "text-caption",
  style: { "color": "#ff7eb3" }
};
const _hoisted_10 = { class: "text-caption font-weight-bold" };
const _hoisted_11 = {
...
const _hoisted_13 = { class: "d-flex align-center mb-4" };
const _hoisted_14 = {
  key: 0,
...
const _hoisted_17 = /* @__PURE__ */ createBaseVNode("p", {
  class: "text-body-2 mb-3",
  style: { "color": "var(--v-theme-secondaryText)" }
}, " AI 自动分析对话历史，提取兴趣、项目、技能等结构化知识，构建个人知识库。 ", -1);
const _hoisted_18 = { class: "d-flex gap-2 mb-3" };
...
const _hoisted_22 = { class: "d-flex justify-space-between align-center mb-1" };
const _hoisted_23 = { class: "text-caption font-weight-bold" };
const _hoisted_24 = {
                ...
                createVNode(VCardText, null, {
                  default: withCtx(() => [
                    ...
                    $data.mbtiResult ? (openBlock(), createElementBlock("div", _hoisted_4, [
                      ...
                      $data.mbtiResult.dimensions ? (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList($data.mbtiResult.dimensions, (dim, key) => {
                        var _a, _b;
                        return openBlock(), createElementBlock("div", {
                          ...
                          createBaseVNode("div", _hoisted_7, [
                            createBaseVNode("span", _hoisted_8, toDisplayString(((_a = $data.dimLabels[key]) == null ? void 0 : _a.left) || ""), 1),
                            createBaseVNode("span", _hoisted_9, toDisplayString(dim.label), 1),
                            createBaseVNode("span", _hoisted_10, toDisplayString(((_b = $data.dimLabels[key]) == null ? void 0 : _b.right) || ""), 1)
                          ]),
                          createVNode(VProgressLinear, {
                            "model-value": dim.score,
                            color: dim.score > 50 ? "#39c5bb" : "#ff7eb3",
                            height: "10",
                            rounded: ""
                          }, null, 8, ["model-value", "color"]),
                          createBaseVNode("p", _hoisted_11, toDisplayString(dim.summary), 1)
                        ]);
                      ...
                      $data.mbtiResult.confidence_note ? (openBlock(), createElementBlock("p", _hoisted_12, toDisplayString($data.mbtiResult.confidence_note), 1)) : createCommentVNode("", true)
                    ])) : createCommentVNode("", true),
              ...
              default: withCtx(() => [
                createVNode(VCardText, null, {
                  default: withCtx(() => [
                    ...
                    $data.timelineData && $data.timelineData.timeline && $data.timelineData.timeline.length ? (openBlock(), createElementBlock("div", _hoisted_14, [
                    ...
                    ])) : $data.timelineData && $data.timelineData.message ? (openBlock(), createElementBlock("p", _hoisted_15, toDisplayString($data.timelineData.message), 1)) : !$data.timelineLoading ? (openBlock(), createElementBlock("p", _hoisted_16, " 暂无时间线数据 ")) : createCommentVNode("", true),
              ...
              default: withCtx(() => [
                createVNode(VCardText, null, {
                  default: withCtx(() => [
                    ...
                    $data.knowledgeStats ? (openBlock(), createElementBlock("div", _hoisted_20, [
                      createVNode(VChip, {
                        size: "small",
                        color: "#39c5bb",
                        variant: "tonal"
                    ...
                    $data.knowledgeEntries.length ? (openBlock(), createElementBlock("div", _hoisted_21, [
                      (openBlock(true), createElementBlock(Fragment, null, renderList($data.knowledgeEntries, (entry) => {
                        return openBlock(), createElementBlock("div", {
                          ...
                          createBaseVNode("div", _hoisted_22, [
                            createBaseVNode("span", _hoisted_23, toDisplayString(entry.topic), 1),
                            createVNode(VChip, {
                              size: "x-small",
                          ...
                          createBaseVNode("p", _hoisted_24, toDisplayString(entry.content), 1)
                        ]);
                      }), 128))
                    ])) : (openBlock(), createElementBlock("p", _hoisted_25, '点击"提取知识"开始分析对话'))
                  ]),
                  _: 1
                })
              ]),
