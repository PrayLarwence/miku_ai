...
import { u as useConfirmDialog, a as askForConfirmation } from "./confirmDialog-DLjvXcW2.js";
import { r as restartAstrBot } from "./restartAstrBot-B3jZYatI.js";
...
const _withScopeId = (n) => (pushScopeId("data-v-e97bc3ff"), n = n(), popScopeId(), n);
...
const _hoisted_2 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "d-flex flex-column align-center mb-6" }, [
...
const _hoisted_3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "text-caption text-medium-emphasis mt-2" }, " 默认用户名和密码均为 miku ", -1));
const _sfc_main = {
  __name: "Settings",
  setup(__props) {
    const { tm } = useModuleI18n("features/settings");
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        createVNode(VDialog, {
          ...
          "onUpdate:modelValue": _cache[14] || (_cache[14] = ($event) => accountDialog.value = $event),
                ...
                createVNode(VCardText, { class: "py-6" }, {
                  default: withCtx(() => [
                    ...
                    createVNode(VForm, {
                      ...
                      "onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => accountFormValid.value = $event),
                      onSubmit: withModifiers(accountEdit, ["prevent"])
                    }, {
                      default: withCtx(() => [
                        createVNode(VTextField, {
                          modelValue: accountPassword.value,
                          "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => accountPassword.value = $event),
                          ...
                          required: "",
                          clearable: "",
                          "onClick:appendInner": _cache[6] || (_cache[6] = ($event) => showAccountPassword.value = !showAccountPassword.value),
                        ...
                        createVNode(VTextField, {
                          ...
                          "onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => accountNewPassword.value = $event),
                          "append-inner-icon": showAccountNewPassword.value ? "mdi-eye-off" : "mdi-eye",
                          type: showAccountNewPassword.value ? "text" : "password",
                          label: "新密码（留空不修改）",
                          variant: "outlined",
                          clearable: "",
                          "onClick:appendInner": _cache[8] || (_cache[8] = ($event) => showAccountNewPassword.value = !showAccountNewPassword.value),
                        ...
                        createVNode(VTextField, {
                          ...
                          "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => accountConfirmPassword.value = $event),
                          ...
                          variant: "outlined",
                          clearable: "",
                          "onClick:appendInner": _cache[10] || (_cache[10] = ($event) => showAccountConfirmPassword.value = !showAccountConfirmPassword.value),
                        ...
                        createVNode(VTextField, {
                          ...
                          "onUpdate:modelValue": _cache[11] || (_cache[11] = ($event) => accountNewUsername.value = $event),
                          label: "新用户名（留空不修改）",
                          variant: "outlined",
                          clearable: "",
                ...
                createVNode(VCardActions, { class: "pa-4" }, {
                  default: withCtx(() => [
                    ...
                    createVNode(VBtn, {
                      variant: "tonal",
                      color: "secondary",
                      onClick: _cache[13] || (_cache[13] = ($event) => accountDialog.value = false),
...
const Settings = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e97bc3ff"]]);
export {
  Settings as default
};
