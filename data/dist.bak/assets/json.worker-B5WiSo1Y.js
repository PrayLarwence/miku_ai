...
(function() {
  ...
  class Emitter {
    constructor(options) {
      ...
      this._leakageMon = ((_a2 = this._options) == null ? void 0 : _a2.leakWarningThreshold) ? new LeakageMonitor((options == null ? void 0 : options.onListenerError) ?? onUnexpectedError, ((_b3 = this._options) == null ? void 0 : _b3.leakWarningThreshold) ?? _globalLeakWarningThreshold) : void 0;
      this._perfMon = ((_c2 = this._options) == null ? void 0 : _c2._profName) ? new EventProfiling(this._options._profName) : void 0;
    ...
    _removeListener(listener) {
      var _a2, _b3, _c2, _d2;
      (_b3 = (_a2 = this._options) == null ? void 0 : _a2.onWillRemoveListener) == null ? void 0 : _b3.call(_a2, this);
      if (!this._listeners) {
        return;
      }
      if (this._size === 1) {
  ...
  const isElectronProcess = typeof ((_b2 = nodeProcess == null ? void 0 : nodeProcess.versions) == null ? void 0 : _b2.electron) === "string";
  ...
  var JSONCompletion = class {
    ...
    doesSupportMarkdown() {
      ...
      if (!isDefined(this.supportsMarkdown)) {
        const documentationFormat = (_c2 = (_b3 = (_a2 = this.clientCapabilities.textDocument) == null ? void 0 : _a2.completion) == null ? void 0 : _b3.completionItem) == null ? void 0 : _c2.documentationFormat;
    ...
    doesSupportsCommitCharacters() {
      ...
      if (!isDefined(this.supportsCommitCharacters)) {
        this.labelDetailsSupport = (_c2 = (_b3 = (_a2 = this.clientCapabilities.textDocument) == null ? void 0 : _a2.completion) == null ? void 0 : _b3.completionItem) == null ? void 0 : _c2.commitCharactersSupport;
      }
    ...
    doesSupportsLabelDetails() {
      ...
      if (!isDefined(this.labelDetailsSupport)) {
        this.labelDetailsSupport = (_c2 = (_b3 = (_a2 = this.clientCapabilities.textDocument) == null ? void 0 : _a2.completion) == null ? void 0 : _b3.completionItem) == null ? void 0 : _c2.labelDetailsSupport;
      }
    ...
    getSchemaFromProperty(resource, document2) {
      ...
      if (((_a2 = document2.root) == null ? void 0 : _a2.type) === "object") {
        for (const p of document2.root.properties) {
          if (p.keyNode.value === "$schema" && ((_b3 = p.valueNode) == null ? void 0 : _b3.type) === "string") {
