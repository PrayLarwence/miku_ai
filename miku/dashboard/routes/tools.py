...
from miku.core.agent.mcp_client import MCPTool, validate_mcp_stdio_config
from miku.core.core_lifecycle import AstrBotCoreLifecycle
from miku.core.star import star_map
from miku.core.tools.registry import get_builtin_tool_config_statuses
