...
from miku.core import astrbot_config, file_token_service, logger
from miku.core.config.astrbot_config import AstrBotConfig
from miku.core.config.default import (
    CONFIG_METADATA_2,
    CONFIG_METADATA_3,
...
from miku.core.config.i18n_utils import ConfigMetadataI18n
from miku.core.core_lifecycle import AstrBotCoreLifecycle
from miku.core.platform.register import platform_cls_map, platform_registry
from miku.core.provider import Provider
from miku.core.provider.register import provider_registry
from miku.core.star.star import StarMetadata, star_registry
from miku.core.utils.astrbot_path import (
    get_astrbot_plugin_data_path,
)
from miku.core.utils.llm_metadata import LLM_METADATAS
from miku.core.utils.webhook_utils import ensure_platform_webhook_config
...
async def _validate_neo_connectivity(
    ...
    if not access_token:
        # Try auto-discovery
        from miku.core.computer.computer_client import _discover_bay_credentials
...
class ConfigRoute(Route):
    ...
    async def get_embedding_dim(self):
        ...
        try:
            ...
            from miku.core.provider.provider import EmbeddingProvider
            ...
            if provider_type not in provider_cls_map:
                try:
                    self.core_lifecycle.memory_model_manager.dynamic_import_provider(
                        provider_type,
                    )
                except ImportError:
                    logger.error(traceback.format_exc())
