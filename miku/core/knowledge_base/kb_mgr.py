...
from miku.core.utils.astrbot_path import get_astrbot_knowledge_base_path
...
class KnowledgeBaseManager:
    ...
    def __init__(
        ...
        self.memory_model_manager = memory_model_manager
        self.provider_manager = provider_manager  # for URL upload LLM cleaning
    ...
    async def load_kbs(self) -> None:
        ...
        for record in kb_records:
            kb_helper = KBHelper(
                kb_db=self.kb_db,
                kb=record,
                memory_model_manager=self.memory_model_manager,
