...
class _RecordEnricherFilter(logging.Filter):
    ...
    def filter(self, record: logging.LogRecord) -> bool:
        ...
        record.is_trace = record.name == "miku.trace"
        return True
...
class _LoguruInterceptHandler(logging.Handler):
    ...
    def emit(self, record: logging.LogRecord) -> None:
        ...
        payload = {
            ...
            "is_trace": getattr(record, "is_trace", record.name == "miku.trace"),
        }
...
class LogManager:
    ...
    def _default_log_path(cls) -> str:
        return os.path.join(get_astrbot_data_path(), "logs", "miku.log")
    ...
    def configure_trace_logger(cls, config: dict | None) -> None:
        ...
        trace_logger = logging.getLogger("miku.trace")
        ...
        cls._trace_sink_id = cls._add_file_sink(
            file_path=cls._resolve_log_path(path or "logs/miku.trace.log"),
            level=logging.INFO,
            max_mb=max_mb,
            backup_count=3,
            trace=True,
