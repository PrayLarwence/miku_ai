...
from miku.core import db_helper, logger
...
from miku.core.agent.response import AgentStats
from miku.core.astr_main_agent import (
    MainAgentBuildConfig,
    MainAgentBuildResult,
    build_main_agent,
)
from miku.core.message.components import File, Image, Record, Video
from miku.core.message.message_event_result import (
    MessageChain,
    MessageEventResult,
    ResultContentType,
)
from miku.core.pipeline.stage import Stage
from miku.core.platform.astr_message_event import AstrMessageEvent
from miku.core.provider.entities import (
    LLMResponse,
    ProviderRequest,
)
from miku.core.star.star_handler import EventType
from miku.core.utils.metrics import Metric
from miku.core.utils.session_lock import session_lock_manager
...
class InternalAgentSubStage(Stage):
    ...
    async def process(
        ...
        try:
            ...
            error_text = f"Error occurred while processing agent request: {e}"
