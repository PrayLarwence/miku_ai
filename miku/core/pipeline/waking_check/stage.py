...
from miku.core.message.components import At, AtAll, Reply
from miku.core.message.message_event_result import MessageChain, MessageEventResult
...
from miku.core.star.session_plugin_manager import SessionPluginManager
    ...
    async def process(
        ...
        for handler in star_handlers_registry.get_handlers_by_event_type(
            ...
            if (
                ...
                == "miku.builtin_stars.builtin_commands.main"
            ):
                continue
