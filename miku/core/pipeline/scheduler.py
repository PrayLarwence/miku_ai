...
from miku.core.platform.sources.webchat.webchat_event import WebChatMessageEvent

from miku.core.utils.active_event_registry import active_event_registry

# 对话持久化钩子 — 导入失败则静默跳过
try:
    from miku.core.conversation_store import get_store as _get_conv_store
except ImportError:
    _get_conv_store = None
