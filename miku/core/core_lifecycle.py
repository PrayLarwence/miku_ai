...
from miku.core import LogBroker, LogManager
...
from miku.core.cron import CronJobManager
from miku.core.db import BaseDatabase
from miku.core.knowledge_base.kb_mgr import KnowledgeBaseManager
from miku.core.knowledge_base.memory_model import MemoryModelManager
from miku.core.persona_mgr import PersonaManager
from miku.core.pipeline.scheduler import PipelineContext, PipelineScheduler
from miku.core.platform.manager import PlatformManager
...
from miku.core.star.star_handler import EventType, star_handlers_registry, star_map
from miku.core.star.star_manager import PluginManager
from miku.core.umop_config_router import UmopConfigRouter
from miku.core.updator import AstrBotUpdator
from miku.core.utils.llm_metadata import update_llm_metadata
from miku.core.utils.migra_helper import migra
from miku.core.utils.temp_dir_cleaner import TempDirCleaner
...
class AstrBotCoreLifecycle:
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            logger.error(f"Miku AI migration failed: {e!s}")
        ...
        # 初始化知识库管理器
        self.memory_model_manager = MemoryModelManager(self.astrbot_config)
        self.kb_manager = KnowledgeBaseManager(
            self.memory_model_manager,
        ...
        await self.memory_model_manager.initialize()
    ...
    async def stop(self) -> None:
        ...
        await self.memory_model_manager.terminate()
