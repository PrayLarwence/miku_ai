...
async def download_dashboard(
    ...
    if latest or len(str(version)) != 40:
        ...
        # dashboard_release_url = f"https://astrbot-registry.soulter.top/download/astrbot-dashboard/{ver_name}/dist.zip"  # 第三方API，已注释
        ...
        try:
            ...
            # [Disabled] 停用 GitHub 下载 fallback
            # if latest:
        ...
        raise ValueError("Harbour release download is disabled.")
