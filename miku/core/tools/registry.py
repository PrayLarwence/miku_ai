...
_BUILTIN_TOOL_MODULES = (
    "miku.core.tools.computer_tools",
    "miku.core.tools.cron_tools",
    "miku.core.tools.knowledge_base_tools",
    "miku.core.tools.message_tools",
    "miku.core.tools.web_search_tools",
)
