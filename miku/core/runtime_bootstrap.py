"""Runtime bootstrap — 在 miku 主初始化前完成的运行时补丁

主要职责：用系统证书 + certifi 构建一个统一的 SSL 上下文，
patch 进 aiohttp 的全局 verified context，避免在国内环境出现根证书缺失。
"""
...
from miku.utils.http_ssl_common import build_ssl_context_with_certifi
