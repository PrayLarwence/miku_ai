...
from miku.core import (
    DependencyConflictError,
    logger,
    pip_installer,
    sp,
)
from miku.core.agent.handoff import FunctionTool, HandoffTool
from miku.core.config.astrbot_config import AstrBotConfig
from miku.core.config.default import VERSION
from miku.core.platform.register import unregister_platform_adapters_by_module
...
from miku.core.utils.io import remove_dir
from miku.core.utils.metrics import Metric
...
class PluginManager:
    def __init__(self, context: Context, config: AstrBotConfig) -> None:
        ...
        self.reserved_plugin_path = os.path.join(
            get_astrbot_path(), "miku", "builtin_stars"
        )
    ...
    def _get_plugin_related_modules(
        ...
        """
        prefix = "miku.builtin_stars." if is_reserved else "data.plugins."
        return [
            key
    ...
    async def load(
        ...
        for plugin_module in plugin_modules:
            try:
                ...
                path = "data.plugins." if not reserved else "miku.builtin_stars."
    ...
    async def _unbind_plugin(self, plugin_name: str, plugin_module_path: str) -> None:
        ...
        for func_tool in llm_tools.func_list:
            ...
            if (
                ...
                and not mp.endswith(("miku.builtin_stars", "data.plugins"))
            ):
