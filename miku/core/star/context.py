...
from miku.core.agent.hooks import BaseAgentRunHooks
from miku.core.agent.message import Message
from miku.core.agent.runners.tool_loop_agent_runner import ToolLoopAgentRunner
...
from miku.core.conversation_mgr import ConversationManager
from miku.core.db import BaseDatabase
from miku.core.knowledge_base.kb_mgr import KnowledgeBaseManager
from miku.core.message.message_event_result import MessageChain
from miku.core.persona_mgr import PersonaManager
from miku.core.platform import Platform
from miku.core.platform.astr_message_event import AstrMessageEvent, MessageSesion
from miku.core.platform_message_history_mgr import PlatformMessageHistoryManager
from miku.core.provider.entities import LLMResponse, ProviderRequest, ProviderType
from miku.core.provider.func_tool_manager import FunctionTool, FunctionToolManager
from miku.core.provider.manager import ProviderManager
from miku.core.provider.provider import (
    EmbeddingProvider,
    Provider,
    RerankProvider,
)
...
from miku.core.utils.astrbot_path import get_astrbot_system_tmp_path
...
if TYPE_CHECKING:
    from miku.core.cron.manager import CronJobManager
...
class Context:
    ...
    async def tool_loop_agent(
        ...
        **kwargs: Any,
        ...
        from miku.core.astr_agent_context import (
            AgentContextWrapper,
            AstrAgentContext,
        )
    ...
    def get_provider_by_id(
        ...
        """通过 ID 获取对应的 Provider（先查 chat，再查 embedding/rerank）。
        ...
        if not prov and hasattr(self, 'kb_manager') and self.kb_manager:
            prov = self.kb_manager.memory_model_manager.inst_map.get(provider_id)
    ...
    def get_all_embedding_providers(self) -> list:
        ...
        if hasattr(self, 'kb_manager') and self.kb_manager:
            return self.kb_manager.memory_model_manager.get_all_embedding_providers()
        return []
