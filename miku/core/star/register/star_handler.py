...
from miku.core.agent.agent import Agent
from miku.core.agent.handoff import HandoffTool
from miku.core.agent.hooks import BaseAgentRunHooks
from miku.core.agent.tool import FunctionTool
from miku.core.message.message_event_result import MessageEventResult
from miku.core.provider.func_tool_manager import PY_TO_JSON_TYPE, SUPPORTED_TYPES
...
def register_on_llm_request(**kwargs):
    ...
    Examples:
    ```py
    from miku.api.provider import ProviderRequest
...
def register_on_llm_response(**kwargs):
    ...
    Examples:
    ```py
    from miku.api.provider import LLMResponse
