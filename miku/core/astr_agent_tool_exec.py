...
from miku.core.cron.events import CronMessageEvent
from miku.core.message.components import Image
from miku.core.message.message_event_result import (
    CommandResult,
    MessageChain,
    MessageEventResult,
)
from miku.core.platform.message_session import MessageSession
from miku.core.provider.entities import ProviderRequest
from miku.core.tools.message_tools import SendMessageToUserTool
from miku.core.utils.history_saver import persist_agent_history
...
class FunctionToolExecutor(BaseFunctionToolExecutor[AstrAgentContext]):
    ...
    async def _wake_main_agent_for_background_result(
        ...
        *,
        ...
        from miku.core.astr_main_agent import (
