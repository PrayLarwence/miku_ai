...
# 将父目录添加到 sys.path（必须在 import miku.* 之前）
sys.path.append(Path(__file__).parent.as_posix())

from miku.core.runtime_bootstrap import initialize_runtime_bootstrap  # noqa: E402

initialize_runtime_bootstrap()

from miku.core import LogBroker, LogManager, db_helper, logger  # noqa: E402
from miku.core.config.default import VERSION  # noqa: E402
from miku.core.initial_loader import InitialLoader  # noqa: E402
from miku.core.utils.astrbot_path import (  # noqa: E402
...
from miku.core.utils.io import (  # noqa: E402
    download_dashboard,
...
async def check_dashboard_files(webui_dir: str | None = None):
    ...
    logger.info(
        "Downloading WebUI. If it fails, download dist.zip from the project release page and extract dist to data/.",
    )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Miku AI Assistant - Based on AstrBot")
    parser.add_argument(
        "--webui-dir",
        type=str,
